...
'
      ...
      TYPE CREC_INDX               ' -999/-998  Sorted index on structure names
        ...
        m_SEL3(1 to 2) as Long     '        Selection string of third integer value
      END TYPE
...
const TYPE_GENERIC = +3
      ...
      TYPE CREC_DEFI               ' -999/-999:101  additional defines
        m_ID as Long               '        Identification 11/12
        m_NAME(1 to 65) as Long    '        define name
        m_VALUE(1 to 65) as Long   '        define value
      END TYPE
      ...
      TYPE CCTRL_OBJ               ' 0/01:101  involved objects
        ...
        m_IDBIM(1 to 32) as Long   '        256 Bit GUId Identifier of element in the BIM/CAD system (obsol
...
const MAT_TIMB_SIA_D_SOLID_HARD_WOOD = 3732
      ...
      TYPE CMAT_BED                ' 1/NR:7  MaterialBedding
        m_ID as Long               '        Identification
        m_MNR as Long              '        Materialnumber of bedding body
        ...
        m_RFAC as Single           '        shear strength reduction factor
      END TYPE
...
const MAX_MAT_LAY = 99
      TYPE CMAT_LAY                ' 1/NR:8  MaterialLayerStructure
        ...
        m_BETA as Single           ' [   5] Angle of material (difference to local x axis of element)
      END TYPE
...
const MAT_SPE_TYPE_TEMP = 110
      ...
      TYPE CMAT_CRE                ' 1/NR:90/TYPE  ExplicitCreepCurve
        m_ID as Long               '        Identification = 90
        m_TYPE as Long             '        type of material value = 106
        m_TITLE as Long            '        title of the curve
        m_RVAL(1 to 16,1 to 2) as Single '        real material values (time[d],value pairs)
      END TYPE

      TYPE CMAT_SHR                ' 1/NR:90/TYPE  ExplicitShrinkageCurve
        m_ID as Long               '        Identification = 90
        m_TYPE as Long             '        type of material value = 107
        m_TITLE as Long            '        title of the curve
        m_RVAL(1 to 16,1 to 2) as Single ' [1081] real material values (time[d],value pairs),
      END TYPE
      ...
      TYPE CBORE_LAY               ' 2/NR:1  Soillayer
        ...
        m_ES as Single             ' [1088] Stiffness Modulus
        m_DES as Single            ' [1088] Increment of ES within current layer
        m_MUE as Single            '        Poissons ratio
...
const AXIS_SUBTYPE_AUXI = 19
      TYPE CAXIS                   ' 3/ID:0  Geometric Axis
        ...
        m_ID2 as Long              '        AXIS_SUBTYPE_POST: group number of cut-line
        m_ID3 as Long              '        AXIS_SUBTYPE_POST: >0 = explicit material to cut , <=0 = all ma
...
const GAX_GEO_NURBS_CPT = 91
      ...
      TYPE CAXIS_VTB               ' 3/ID:102  Definition of vertical alignment
        m_ID0 as Long              '        ident=102
        m_ID1 as Long              '        specification type
        m_ID2 as Long              '        reserved
        m_S as Single              '        Parameter s along the axis
        m_H as Single              ' [1001] Elevation of vertical tangency point
        m_R as Single              ' [1001] Curvature Radius
        m_X as Single              ' [1001] Calculated arc length along the axis
        m_L1 as Single             ' [1001] Calculated secant length to the left
        m_L2 as Single             ' [1001] Calculated secant length to the right
      END TYPE

      TYPE CAXIS_ITB               ' 3/ID:103  Placement at axis position (obsolete)
      ...
      TYPE CAXIS_ITM               ' 3/ID:10104  Secondary axis parameter mapping
        m_ID0 as Long              '        Ident=10104
        m_IDS as Long              '        Enum of secondary axis (1='A' to 26 ='Z')
        m_MAP(1 to 64,1 to 2) as Single '        Mapping S (Main axis) --> S (secondary axis)
      END TYPE
      ...
      TYPE CGAXD_VTB               ' 3/ID:122  Geometric properties for axis heights (double precision)
        ...
        m_ID1 as Long              '        additional properties
        m_ID2 as Long              '        reserved
        m_ID3 as Long              '        reserved
        m_S as Double              '        Parameter s along the axis
        m_H as Double              ' [1001] Elevation of vertical tangency point
        m_R as Double              ' [1001] Curvature radius of segment
        m_R2 as Double             ' [1001] Optional divergent radius to the right (=R by default)
        m_X as Double              ' [1001] Calculated arc length along the axis
        m_L1 as Double             ' [1001] Calculated secant length to the left
        m_L2 as Double             ' [1001] Calculated secant length to the right
      END TYPE
...
const GAXD_GEO_PROJECT = 182
      TYPE CGAXD_GEO               ' 3/ID:18?  Geometric properties
        m_ILN as Long              '        Code of geometry
        m_ID1 as Long              '        additional segment properties
      ...
      TYPE CSAXD_NKN               ' 39/NR:190  Knots of a Nurb
        m_ILN as Long              '        ID=190
        m_DEG as Long              '        Order of Spline
        m_S(1 to 256) as Double    '        Knot-Vector
      END TYPE
      ...
      TYPE CSAXD_CPT               ' 39/NR:191  Control point of a Nurb
        m_ILN as Long              '        ID=191
        m_ID1 as Long              '        reserved
        m_W as Double              '        Weight
        m_XYZ(1 to 3) as Double    ' [1001] Coordinates
      ...
      TYPE CSAXD_PT                ' 39/NR:192  Data point on curve
        m_ILN as Long              '        ID=192
        m_ID1 as Long              '        specification type
        m_S as Double              '        Parameter along curve
        m_XYZ(1 to 3) as Double    ' [1001] Coordinates
      ...
      TYPE CSAXD_ARC               ' 39/NR:193  Circular Arc
        m_ILN as Long              '        ID=193
        m_IDF as Long              '        Definition selected
        m_R as Double              ' [1001] Radius of arc
        m_XYZ(1 to 3) as Double    ' [1001] Coordinates of center
      ...
      TYPE CTEND_1                 ' 4/ID:1  Tendon of Prestressing Schemes
        ...
        m_ID2 as Long              '        Type of input: 0 SYSP: post-tensioning
      ...
      TYPE CTEND_4                 ' 4/ID:4  Presets for friction calculation
        m_ID0 as Long              '        identifier 4
        m_ID1 as Long              '        reserved
        m_INP as Long              '        Source of values
        m_K1 as Single             '        Max prestress force: factor on (char.) tensile strength (fp)
        m_K2 as Single             '        Max prestress force: factor on (char.) proof-stress / yield str
        m_K3 as Single             '        Mean prestress force: factor on (char.) tensile strength (fp)
        m_K4 as Single             '        Mean prestress force: factor on (char.) proof-stress / yield st
      END TYPE
      ...
      TYPE CSARD_PTS               ' 39/NR:290  AreaPointonSurface
        m_ID as Long               '        Id = 290
        m_IT as Long               '        Type of point
        m_M as Long                '        Rasterlocation of mesh (0 < m < mgri )
        m_N as Long                '        Rasterlocation of mesh (0 < n < ngri )
      ...
      TYPE CSARD_NKU               ' 39/NR:291  Knots of a Nurb
        m_ILN as Long              '        ID
        m_DEG as Long              '        Order of Spline
        m_S(1 to 256) as Double    '        Knot-Vector
      END TYPE

      TYPE CSARD_NKV               ' 39/NR:292  Knots of a Nurb
        m_ILN as Long              '        ID
        m_DEG as Long              '        Order of Spline
        m_S(1 to 256) as Double    '        Knot-Vector
      END TYPE
      ...
      TYPE CSECT_ERR               ' 9/NR:-  Invalid section, visualisation only
        m_ID as Long               '        Identification
        m_MNO as Long              '        Materialnumber of sections
        m_MRF as Long              '        Materialnumber of Reinforcement
        m_A as Single              ' [1012] Area
...
const SECT_ADD_RF_UNUSED = 262144
      TYPE CSECT_ADD               ' 9/NR:4  SectionalValuesShear , Temperature
        ...
        m_AT as Single             ' [ 107] Elongationcoefficient for Temperature
        ...
        m_TMIN as Single           ' [1011] minimum thickness of plates
        m_TMAX as Single           ' [1011] maximum thickness of plates
        m_WT as Single             ' [1018] maximum tau for primary Torsion Mtp=1
        m_WVY as Single            ' [1017] maximum tau for Shear Vy=1
        m_WVZ as Single            ' [1017] maximum tau for Shear Vz=1
        m_WT2 as Single            ' [1018] maximum tau for secondary Torsion Mt2=1
        m_AK as Single             ' [1012] kernel area for Torsion (Bredt)
...
const LAY_INR_TYPE_SEQUENTIAL = 3
      TYPE CSECT_LAY               ' 9/NR:9  SectionalReinforcementLayer  (LAY)
        ...
        m_ALOW as Single           ' [1020] Lower bound for gross area of layer
        m_AHIG as Single           ' [1020] Upper bound for gross area of layer
        m_ASUM as Single           ' [1020] Sum of reference gross areas of layer
        m_AFAK as Single           '        maximum allowable factor of layer
        m_YS as Single             ' [1011] center of layer (gross)
        m_ZS as Single             ' [1011] center of layer (gross)
        ...
        m_IY as Single             ' [1014] 4th order areas (gross inertia)
        m_IZ as Single             ' [1014] 4th order areas (gross inertia)
        m_IYZ as Single            ' [1014] 4th order areas (gross inertia)
        m_EMOD as Single           ' [1090] Elasticity-Modulus
        ...
        m_N as Single              ' [1101] Prestress normal force N
        m_MY as Single             ' [1104] Prestress bending moment My
        m_MZ as Single             ' [1104] Prestress bending moment Mz
        m_TN as Single             ' [1101] Effective Normal force N    from temperature eigenstress
        m_TMY as Single            ' [1104] Effective Bending moment My from temperature eigenstress
        m_TMZ as Single            ' [1104] Effective Bending moment Mz from temperature eigenstress
        m_EA as Single             ' [1101] Effective tangential stiffnes E*A
        m_EAY as Single            ' [1104] Effective tangential stiffnes E*A*y
        m_EAZ as Single            ' [1104] Effective tangential stiffnes E*A*z
        m_EAYY as Single           ' [1105] Effective tangential stiffnes E*A*z*z
        m_EAZZ as Single           ' [1105] Effective tangential stiffnes E*A*y*y
        m_EAYZ as Single           ' [1105] Effective tangential stiffnes E*A*y*z
        m_NPLC as Single           ' [1101] Effective maximum compressive force
        m_NPLT as Single           ' [1101] Effective maximum tensile force
        m_ARED as Single           ' [1020] Reduction area of material
        m_AEFF as Single           ' [1020] Effective area for normal force
        m_AEFFY as Single          ' [1020] Effective area for evaluating ys and Iz
        m_AEFFZ as Single          ' [1020] Effective area for evaluating zs and Iy
        m_AEFFYZ as Single         ' [1020] Effective area for evaluating Iyz
        m_YSEFF as Single          ' [1011] Effective center of bending stress y
        m_ZSEFF as Single          ' [1011] Effective center of bending stress z
        m_IYEFF as Single          ' [1014] Effective 4th order areas Iy
        m_IZEFF as Single          ' [1014] Effective 4th order areas Iz
        m_IYZEFF as Single         ' [1014] Effective 4th order areas Iyz
        m_AREDY as Single          ' [1020] Reduction area y of material
        m_AREDZ as Single          ' [1020] Reduction area z of material
        m_AREDYZ as Single         ' [1020] Reduction area yz of material
      END TYPE
...
const SECT_REC_FIXLAY = 256
      ...
      TYPE CSECT_CAB               ' 9/NR:11  SectiontypeCable (CABL)
        ...
        m_GAMMAR as Single         '        partial factor minimise bending stresses (EN 1993-1-11, table 6
      END TYPE
...
const SECT_PROF_PROP_MULT = 64
      TYPE CSECT_PRO               ' 9/NR:12  SectiontypeShape (PROF)
        ...
        m_IBIT as Long             '        ityp + SECT_PROF_PROP_MULT*(iref+ivtp)
        ...
        m_VYPL as Single           ' [1102] characteristic plastic shear force Vy
        m_VZPL as Single           ' [1102] characteristic plastic shear force Vz
        m_MTPL as Single           ' [1103] characteristic plastic torsional   Mt
        m_MT2PL as Single          ' [1103] characteristic plastic torsional   Mt2
        m_MBPL as Single           ' [1103] characteristic plastic warpmoment  Mb
      END TYPE
...
const TXT_TXT_INTLEN_CDB = 128
      ...
      TYPE CSECT_CW                ' 9/NR:80  Hydrodynamic coefficients (WIND/Wave loading)
        ...
        m_AG as Single             ' [   5] angle of attack in degrees
        m_B2H as Single            '        ratio of B2H needed for WBH and BH with derivativa
      END TYPE
...
const PPT_IDP_GENERATED_POLYGON = 100
      ...
      TYPE CSECT_PTC               ' 9/NR:310  PartialIntegrationPoint of shear cut
        m_ID as Long               '        Identification 100/101
        m_MNO as Long              '        Material number
        m_IDP as Long              '        Number*256 + Bitpattern
        m_TNR as Long              '        Designation
...
const MAX_SECT_NEP_YZ = 511
      ...
      TYPE CSECT_NCP               ' 9/NR:312  Partial non effective polygons for partial cut polygon
        m_ID as Long               '        Identification 191
        m_MNO as Long              '        Materialnumber
        m_IDP as Long              '        Noneffective for (see :190)
        m_TNR as Long              '        Ident from 190 / Cut identifier for :312 elements
...
const PRF_FT_ADDI = -1
      ...
      TYPE CSECT_PCP               ' 9/NR:320  SectionPointReinforcement for partial cut polygon
        m_ID as Long               '        Identification 200
        m_MNO as Long              '        Material number
        m_IR as Long               '        Layer number
        m_TNR as Long              '        Designation
...
const LRP_IR_NUMP = 1000
      ...
      TYPE CSECT_LCP               ' 9/NR:321  SectionLineReinforcement for partial cut polygon
        m_ID as Long               '        Identification 201/211/221 or 321
        m_MNO as Long              '        Material number
        m_IR as Long               '        Layer number
        m_TNR as Long              '        Designation
...
const CUT_IDP_REFRESH_MINIMUM = 4194304
      TYPE CSECT_CUT               ' 9/NR:301  ShearCut (CUT)
        ...
        m_FAKVY as Single          '        assumed total separated part for Vy
        m_FAKVZ as Single          '        assumed total separated part for Vz
      END TYPE
...
const SYST_IACHS_POSITIVE_Z = +3
      ...
      TYPE CSYST_DES               ' 10/1:0  SystemDesignCode
        ...
        m_TXT(1 to 8) as Long      '        specific Text of Design code (32 characters)
      ...
      TYPE CGRP                    ' 11/00  Primary group data
        ...
        m_IBB as Long              '        construction stage no. BIRTH (0 = instant activation)
        m_IBD as Long              '        construction stage no. DEATH (0 = infinite lifetime)
        m_IBG as Long              '        reserved
        m_V1 as Single             '        reserved (formerly: total volume [1008])
        m_V2 as Single             '        reserved (formerly: total mass [1180])
        m_V3 as Single             '        reserved (formerly: total reinforcement weight [1030])
        m_V4 as Single             '        reserved
        m_V5 as Single             '        reserved
        m_V6 as Single             '        reserved
        m_V7 as Single             '        reserved
        m_V8 as Single             '        reserved
        m_V9 as Single             '        reserved
        m_V10 as Single            '        reserved
        m_V11 as Single            '        reserved
        m_TEXT(1 to 17) as Long    '        Designation of Group
      END TYPE

      TYPE CGRP_LC                 ' 11/LC  Load case specific group data (primary & secondary groups)
        m_NG as Long               '        group-number
        m_TYP as Long              '        element code
        m_NUM as Long              '        number of elements of this type
        m_MIN as Long              '        minimum element-number of group
        ...
        m_V2 as Single             '        unused (formerly FAKA: reducing factor of axial bedding for pil
        m_V3 as Single             '        unused (formerly FAKT: reducing factor of transverse bedding
        m_V4 as Single             '        unused
        m_V5 as Single             '        unused
        m_V6 as Single             '        unused
        m_ETOT as Single           ' [1094] total energy
        m_ECOM as Single           ' [1094] compression energy  (unused)
        m_EDEV as Single           ' [1094] shear energy        (unused)
        m_EKIN as Single           ' [1094] kinetic energy      (unused)
        m_EPOT as Single           ' [1094] potential energy    (unused)
        m_EDAM as Single           ' [1094] damping energy      (unused)
        m_H_GW as Single           ' [1001] Groundwater level
        m_V14 as Single            '        reserved
        m_TEXT(1 to 17) as Long    '        Designation of Group
      END TYPE
...
const LC_CTRL_ITYP_COMB_AF = 106
      TYPE CLC_CTRL                ' 12/LC:?  Informations on loadcase LC
        ...
        m_RX as Single             ' [1151] sum of support reactions PX
        m_RY as Single             ' [1151] sum of support reactions PY
        m_RZ as Single             ' [1151] sum of support reactions PZ
      ...
      TYPE CLC_LPO1                ' 12/LC:91  Individual position of Point load
        ...
        m_PVAL(1 to 4) as Single   '        Load values in PV,PVM,PY,PX
      END TYPE
      ...
      TYPE CLC_LPOX                ' 12/LC:99  Spandefinitions from ELLA
        ...
        m_XA as Single             ' [1001] Limits of a span start
        m_XE as Single             ' [1001] Limits of a span end
        m_V as Single              ' [1203] velocity of load train
        m_PHI as Single            '        impact factor
        m_YEX as Single            ' [1001] mean value of eccentricity of primary loadtrain
        m_PZERO(1 to 2) as Single  ' [1001] Position of zero influence values at start and end
        m_PSIGN as Single          '        estimate if unfavourable is on left(-) or right(+) of zero line
      END TYPE
      ...
      TYPE CLC_POIN                ' 12/LC:10?  Free point loads
        ...
        m_TREF(1 to 3) as Long     '        Reference text for eccentricities in sections (12 characters)
        m_TYP as Long              '        type of load
        m_TXT(1 to 3) as Long      '        Identifiying User Text (12 characters)
      ...
      TYPE CLC_AREA                ' 12/LC:12?  Free area loads
        m_KREF as Long             '        Reference type
        m_NREF as Long             '        Reference number
        m_TREF(1 to 3) as Long     '        Reference text (not used) (12 characters)
        m_TYP as Long              '        type of load
      ...
      TYPE CLC_TRAI                ' 12/LC:300  Train loading
        ...
        m_YEX as Single            ' [1001] Range of eccentricity of loading in lane
      ...
      TYPE CLC_TRAL                ' 12/LC:301  Individual loads of Train loading
        ...
        m_YMIN as Single           ' [1001] eccentricity in y direction
        m_YMAX as Single           ' [1001] deprecated: max eccentricity in y direction
        ...
        m_PV as Single             '        Mass value for centrifugal force
        m_ZPV as Single            ' [1001] Height for centrifugal force resultant
        ...
        m_WIDTH as Single          ' [1001] obsoleted: Width of train
        m_DWHEEL as Single         ' [1001] Distance of wheels
      ...
      TYPE CLC_WHIS0               ' 12/LC:430  wind history control values
        m_ID as Long               '        identifier 430
        m_LCW as Long              '        loadcase of basic wind
        m_IPRO as Single           '        number of generated inflow data points
        m_WXMI as Single           ' [1001] size of structure in wind coordinates
        m_WXMA as Single           ' [1001] 
        m_WYMI as Single           ' [1001] 
        m_WYMA as Single           ' [1001] 
      ...
      TYPE CLC_STAT                ' 13/LC:8  Statistics and extended data for time series
        m_ID as Long               '        identifier 8
        m_MEAN as Single           '        mean value
        m_MAX as Single            '        maximum peak value
        m_MIN as Single            '        minimum peak value
        m_SDEV as Single           '        standard deviation
        m_S4 as Single             '        not used
        m_S5 as Single             '        not used
        m_TDEV as Single           '        target standard deviation (see 80/LC:-206)
        m_SCFX as Single           '        Scaling factor for wind spectran (see 80/LC:-207)
      END TYPE

      TYPE CLC_DAMP                ' 13/LC:9  Damping values
        m_ID as Long               '        identifier 9
        m_D(1 to 7) as Single      '        modal damping values for REVA response spectra
      END TYPE
      ...
      TYPE CLC_FTVAL               ' 13/LC:8?  Visualisation functions and spectra
        m_ID as Long               '        identifier
        m_TT as Single             '        Time/frequency/modenumber
        m_F(1 to 7) as Single      '        function values
      END TYPE
      ...
      TYPE CLC_FSTP                ' 13/LC:12  Periodic stepping function additive
        ...
        m_TMIN as Single           ' [  90] starttime
        m_TMAX as Single           ' [  90] stoptime if > starttime
        m_S as Single              '        impactfactor (Sailer/Httner/Bachmann)
      END TYPE
      ...
      TYPE CACT_TASK               ' 14/0  Current superposition task commands
        ...
        m_KWERG as Long            '        Identifier of result record in CDB
      ...
      TYPE CLC_ACT0                ' 14/NR:Z-  Group of Actions for SUPP-task
      ...
      TYPE CLC_CACT1               ' 12/LC:81  current action member
        m_ID as Long               '        ident = 1 / 81
        m_ACTION as Long           '        ID of the action = type of action
        m_TYPE as Long             '        256*subgroup + 16*Group_of_action + superposition
        m_GAMU as Single           '        safety factor unfavourable
      ...
      TYPE CLC_CACT2               ' 12/LC:82  current loadcase of action
        m_ID as Long               '        ident = 2 / 82
        m_LF as Long               '        load case number
        m_TYPE as Long             '        load case action type
        m_FACT as Single           '        factor
      ...
      TYPE CCSM_GRP                ' 15/-1  Construction Stage Group Definitions
        ...
        m_ATIL as Long             '        CS number of last action - after this CS group is taken away
        m_GFIX as Long             '        Hinges fixed at this construction stage
        m_BEDD as Long             '        QUAD bedding activated at this construction stage
        m_SITU as Long             '        In situ concrete load activation
        m_ICSD as Long             '        CS number activation of dead load
        m_ASTI as Long             '        Up to this CS, the stiffness is active, afterwards FACS 1E-10
        m_LINE as Long             '        Bit 1 : LIN : group is linear in a nonlinear analyis
        m_FREE(1 to 2) as Long     '        free integer for later use
        m_T0 as Single             ' [  93] minimum age for loading
        m_FAC1 as Single           '        Stiffness factor for first group activation
        m_PHIF as Single           '        Factor for creep of springs
        m_QUEA as Single           '        Input control see program ASE record GRP2
        m_QEMX as Single           '        Input control see program ASE record GRP2
        m_TS as Single             ' [  93] Starting of shrinkage
        m_FACD as Single           '        factor of dead load
        m_FRER(1 to 2) as Single   '        free for later use
        m_TITLE(1 to 17) as Long   '        designation
      END TYPE
      ...
      TYPE CCSM_LC                 ' 15/-2  Construction Stage Loadcase Definitions
        ...
        m_END as Long              '        CS number of last action. 0: loadcase acts til infinite
        m_EQIT(1 to 3) as Long     '        internal use CSM equation solver
        m_FACT as Single           '        Loadcase factor
        m_REQU(1 to 5) as Single   '        internal use CSM equation solver, default 0.
      END TYPE

      TYPE CCSM_CS                 ' 15/-3  Construction Stage Table
        m_CS as Long               '        Construction Stage
        m_ID as Long               '        Main action type in this CS
        m_NCRE as Long             '        number of creep+shrink step to be produced
        m_ICS1 as Long             '        Prestress stage for partial prestress
        m_BEAM as Long             '        internal use CSM which beams/piles are active, default 0
        m_GPCS as Long             '        internal use CSM on GPCS, default 0
      ...
      TYPE CCSM_CREE               ' 15/-4  creep+shrink values for manual input
        ...
        m_DEFQ as Single           '        Effective member thickness or factor for QUAD+BRIC
        m_T0 as Single             ' [  93] Separate creep value e.g. for an in-situ added concrete
        m_TS as Single             ' [  93] Separate shrinkage value e.g. for an in-situ added concrete
      END TYPE
...
const ANI_SELE_IGRP_DLN = 4
      ...
      TYPE CNODE_EDG               ' 20/001  node edge lists
        m_NR as Long
        m_ID(1 to 9999) as Long    '        node numbers along the edge ID(0:NEDGE)
      END TYPE
      ...
      TYPE CNODE_ACC               ' 23/LC:*  Base acceleration
        ...
        m_AXX as Single            ' [1207] rotational tangential acceleration X-X
        m_AYY as Single            ' [1207] rotational tangential acceleration Y-Y
        m_AZZ as Single            ' [1207] rotational tangential acceleration Z-Z
        ...
        m_EXREF as Single          '        if a value is present (length criteria)
      END TYPE

      TYPE CNODE_ACI               ' 23/LC:*  Base acceleration info
        m_NR as Long               '        node number / influence load case
        m_TYP as Long              '        type of load (=10)
        m_AX as Single             ' [1202] transversal acceleration X
        m_AY as Single             ' [1202] transversal acceleration Y
      ...
      TYPE CNODE_ROT               ' 23/LC:+  Rotation of Body
        ...
        m_TYP as Long              '        type of load
        m_AXX as Single            ' [1207] rotational radial acceleration X-X  (= vxx**2)
        m_AYY as Single            ' [1207] rotational radial acceleration Y-Y  (= vyy**2)
        m_AZZ as Single            ' [1207] rotational radial acceleration Z-Z  (= vzz**2)
        m_EX as Single             ' [1001] reference point for rotation
        m_EY as Single             ' [1001] reference point for rotation
        m_EZ as Single             ' [1001] reference point for rotation
      END TYPE

      TYPE CNODE_ROI               ' 23/LC:+  Rotation of Body information
        m_NR as Long               '        influence reference
        m_TYP as Long              '        type of load
        m_AXX as Single            ' [1207] rotational radial acceleration X-X  (= vxx**2)
        m_AYY as Single            ' [1207] rotational radial acceleration Y-Y  (= vyy**2)
      ...
      TYPE CN_FLOWT                ' 28/LC:0  Flow values in nodes Time Value
        m_ID as Long               '        identifier 0
        m_IDS as Long              '        number of defined nodes
        m_TIME as Single           ' [  90] Time step
        m_DTIME as Single          ' [  90] Time step increment
      END TYPE

      TYPE CN_FLOW                 ' 28/LC:+  Flow values in nodes
        m_NR as Long               '        Node or Elementnumber
        m_TYPE as Long             '        Type of Data
        m_H as Single              ' [1006] Elevation of data point
        m_UX as Single             ' [1212] Fluid velocity u in global X-Direction
        m_UY as Single             ' [1212] Fluid velocity v in global Y-Direction
        m_UZ as Single             ' [1212] Fluid velocity w in global Z-Direction
      END TYPE
...
const SLN_BEAM_SECTION = 7
      ...
      TYPE CSLN_SUPP               ' 39/NR:102  Support of Structural lines
        m_ID as Long               '        identifier 102
        m_IDS as Long              '        referenced structural element type / macro generation command
        ...
        m_GUID(1 to 16) as Long    '        Optional GUID of the support element, if different to
      END TYPE
      ...
      TYPE CSAR                    ' 39/NR:200  Structural area
        ...
        m_IATR as Long             '        Bitpattern for attribute areas (see SBOX_PROP)
      ...
      TYPE CSAR_SUPP               ' 39/NR:221  Support and coupling of structural areas
        ...
        m_CA as Single             ' [1096] axial     bedding
        m_CQ as Single             ' [1096] lateral   bedding
        m_GUID(1 to 16) as Long    '        Optional GUID of the supporting element, if different to
      END TYPE
      ...
      TYPE CSGR2_DEF               ' 39/NR:910  Secondary Group Definition
        m_ID as Long               '        Identifier = 910
        m_IDG as Long              '        Identifier of secondary group
        m_R0 as Long               '        reserved
        m_R1 as Long               '        reserved
        m_IBB as Long              '        Construction stage no. BIRTH (0 = instant activation)
        m_IBD as Long              '        Construction stage no. DEATH (0 = infinite lifetime)
        m_TEXT(1 to 17) as Long    '        Designation of secondary group
      END TYPE

      TYPE CSGR2_SID               ' 39/NR:911  Secondary Group by ID
        m_ID as Long               '        Identifier = 911
        m_TYP as Long              '        Type of referenced member
        m_NO(1 to 255) as Long     '        List of structural element IDs
      END TYPE

      TYPE CSGR2_UID               ' 39/NR:912  Secondary Group by GUID
        m_ID as Long               '        Identifier = 912
        m_R0 as Long               '        reserved
        m_GUID(1 to 36) as Long    '        Unique identifier of the structural element
      END TYPE

      TYPE CSGR2_BOX               ' 39/NR:913  Secondary Group by Bounding-Box
        m_ID as Long               '        Identifier = 913
        m_R0 as Long               '        reserved
        m_XMIN(1 to 3) as Single   ' [1001] Min coordinates of Box
        m_XMAX(1 to 3) as Single   ' [1001] Max coordinates of Box
      END TYPE
      ...
      TYPE CSMB_GUID               ' 39/NR:999  Unique identifier of structural member
        m_ID as Long               '        identifier 999
        m_IDBIM(1 to 36) as Long   '        Unique identifier of the structural element
      END TYPE
...
const GPT_IBC_REF = 32768
      ...
      TYPE CSPT_COH                ' 39/NR:1  Dimension of column head
        m_ID as Long               '        identifier 1/2/3
        m_NS as Long               '        Number of a cross section 9/NR for details
        m_X as Single              ' [1001] Width in local x
        m_Y as Single              ' [1001] Width in local y
      ...
      TYPE CSPT_HAU                ' 39/NR:2  Dimension of voute
        m_ID as Long               '        identifier 1/2/3
        m_NS as Long               '        Number of a cross section 9/NR for details
        m_X as Single              ' [1001] Width in local x
        m_Y as Single              ' [1001] Width in local y
      ...
      TYPE CSPT_PUN                ' 39/NR:3  Dimension of punching perimeter
        m_ID as Long               '        identifier 1/2/3
        m_NS as Long               '        Number of a cross section 9/NR for details
        m_X as Single              ' [1001] Width in local x
        m_Y as Single              ' [1001] Width in local y
      ...
      TYPE CSPT_COL                ' 39/NR:4  Connecting columns
        m_ID as Long               '        identifier 4
        m_NS as Long               '        Number of a cross section 9/NR for column
        m_X as Single              ' [1001] Width in local x
        m_Y as Single              ' [1001] Width in local y
      ...
      TYPE CSPT_FOO                ' 39/NR:5  Footing instance definition
        m_ID as Long               '        identifier 5
        m_POS as Long              '        referenced building position
        m_TYPE as Long             '        Type of foundation
        m_IGP as Long              '        Bitpattern Foundation Properties
      ...
      TYPE CSPT_HPI                ' 39/NR:6  Halfspace pile
        m_ID as Long               '        identifier 6
        m_NQ as Long               '        number cross section   =0 if diameter from 030/NR:0
        m_L as Single              ' [1001] pile length in GDIR direction
        m_MANT as Single           '        percentage of skin friction for linear analysis
      ...
      TYPE CSPT_CON_M              '        connected members
        m_NELT as Long
        m_NREL as Long
        m_NODE as Long
        m_NARB as Long
      ...
      TYPE CSPT_CON                ' 39/NR:8  Steelconnection reference
        m_ID as Long               '        identifier 8
        m_CONID as Long            '        connection identifier
        m_M(1 to 15) as CSPT_CON_M '        connected members
      END TYPE
      ...
      TYPE CGPT_SPR                ' 30/NR:10  Elastic Spring support
        ...
        m_IDR as Long              '        predefined result set identifier
        m_T(1 to 3) as Single      '        explicit direction (dx,dy,dz)
        m_AREF as Single           '        reference / influence area (see also {link}184{-link}170/0{/lin
      ...
      TYPE CSPT_SPR                ' 39/NR:10  Elastic Spring support
        m_ID as Long               '        identifier 10
        m_IRI as Long              '        direction
        m_NR as Long               '        element number
        m_NG as Long               '        group number
      ...
      TYPE CSPT_KIN                ' 39/NR:11  Kinematic Constraint
        m_ID as Long               '        identifier 11
        m_KTL as Long              '        type +  10000*group-number
        m_KR1 as Long              '        reference GPT 1
        m_KR2 as Long              '        reference GPT 2
      ...
      TYPE CSPT_SPC                ' 39/NR:12  Elastic Spring connection (obsoleted)
        m_ID as Long               '        identifier 12
        m_IRI as Long              '        direction + 100*sign(group number,direction)
        m_IPC as Long              '        connecting Spoint
        m_NWL as Long              '        work law number
      ...
      TYPE CGPT_SRES               ' 30/NR:13  Predefined result set
        m_ID as Long               '        identifier 13
        m_TYP as Long              '        predifined type of result set
        m_IDR as Long              '        number / identifier of result set
        m_TXTR(1 to 17) as Long    '        designation of result set
      END TYPE

      TYPE CSPT_SRES               ' 39/NR:13  Predefined result set
        m_ID as Long               '        identifier 13
        m_TYP as Long              '        predifined type of result set
        m_IDR as Long              '        number / identifier of result set
        m_TXTR(1 to 17) as Long    '        designation of result set
...
const GAR_IBC_REF = 32768
      ...
      TYPE CGAR_BOUN               ' 32/NR:1  Outer Boundary of Area
        ...
        m_T as Single              ' [1010] Plate thickness along the edge
        m_DFIX as Single           ' [1001] Distance (offset) of region to edge
        m_CA as Single             ' [1096] axial     bedding
        m_CQ as Single             ' [1096] lateral   bedding
        m_CM as Single             ' [1099] torsional bedding
        m_VAXI as Long             '        ID of axis where a variable along the edge          :V202203
        m_VT(1 to 4) as Long       '        Name of a variable on VAXI describing a variable    :V202203
      END TYPE
      ...
      TYPE CSAR_BOUN               ' 39/NR:201  Outer Boundary of Area
        m_ID as Long               '        identification
        m_NG as Long               '        edgeno     (31/NG)
        m_NA as Long               '        startpoint (30/NA)
        m_NB as Long               '        endpoint   (30/NB)
      ...
      TYPE CSAR_HOLE               ' 39/NR:202  Inner Boundary of Area
        m_ID as Long               '        identification
        m_NG as Long               '        edgeno     (31/NG)
        m_NA as Long               '        startpoint (30/NA)
        m_NB as Long               '        endpoint   (30/NB)
      ...
      TYPE CSAR_CON3               ' 39/NR:203  Prescribed Edges/Points
        m_ID as Long               '        identification
        m_NG as Long               '        edgenumber (31/NG)
        m_NA as Long               '        startpoint (30/NA)
        m_NB as Long               '        endpoint   (30/NB)
      ...
      TYPE CSAR_CON4               ' 39/NR:204  Prescribed Edges/Points
        m_ID as Long               '        identification
        m_NG as Long               '        edgenumber (31/NG)
        m_NA as Long               '        startpoint (30/NA)
        m_NB as Long               '        endpoint   (30/NB)
      ...
      TYPE CGAR_ELNR               ' 32/NR:121  Generated elements from area
        m_ID as Long               '        identifier = 121
      ...
      TYPE CSVO_SURF               ' 39/NR:30?  Involved Surfaces
        m_ITP as Long              '        identification of definition
        m_NG as Long               '        surface    (32/NG)
        m_NR as Long               '        extrusion or rotation geometry identifier
        m_NREF as Long             '        optional number of a reference point
      ...
      TYPE CDSLN_DEF               ' 35/ID:0  Design Element Definition
        ...
        m_NCS as Long              '        ID of cross section
        m_NCS2 as Long             '        ID of secondary cross section for interpolation
        m_NIDS as Long             '        count of geometry identifiers
        m_HDIV as Single           ' [1001] interval of sub-division sections
        m_NAME(1 to 17) as Long    '        designation of design element
        m_GRP as Long              '        secondary group reference
        m_TYPE as Long             '        classification of design element depending on related structura
        m_CTRL as Long             '        DSLN specific general settings, Bits
      END TYPE
...
const DGEO_DEF_TRUSS = 7
      TYPE CDGEO_DEF               ' 35/ID:1  Design Element Geometry
        ...
        m_XYZA(1 to 3) as Single   ' [1001] for TYPE #3, starting point of a straight line
        m_XYZE(1 to 3) as Single   ' [1001] for TYPE #3, end point of a straight line
        m_DZ(1 to 3) as Single     ' [1001] direction z-axis of straight line
        m_SA as Single             '        Start station of a curve along an axis
        m_SE as Single             '        End station of a curve along an axis
        m_IDS(1 to 9999) as Long   '        IDs of structural lines or beams
      END TYPE

      TYPE CDSLC_DEF               ' 35/ID:2  Design Sections
        m_ID as Long               '        identification of data (2)
        m_TYPE as Long             '        type of position reference on the design element axis
        m_ITYP as Long             '        type of section for design, Bits adopted from
        m_POS as Single            ' [1001] position of sections
      END TYPE

      TYPE CDSEL_IDS               ' 35/ID:3  Selection of finite elements
        m_ID as Long               '        identification of data (3)
        m_TYP as Long              '        Type of selection in Bits
        m_IDS(1 to 1024) as Long   '        IDs used in selection with Typ &4 or &8
      END TYPE

      TYPE CDSEL_BOX               ' 35/ID:4  Selection of elements with Box
        m_ID as Long               '        identification of data (4)
        m_BOXY(1 to 2) as Single   ' [1001] y-min and y-max of bounding box
        m_BOXZ(1 to 2) as Single   ' [1001] z-min and z-max of bounding box
      END TYPE

      TYPE CDSLN_GRP               ' 35/ID:5  Secondary groups of design element
        m_ID as Long               '        identification of data (5)
        m_GROUPS(1 to 9999) as Long'        groups assigned to design element
      END TYPE

      TYPE CDSLN_UID               ' 35/ID:999  Unique identifier of design element
        m_ID as Long               '        identifier 999
        m_IDBIM(1 to 36) as Long   '        Unique identifier of the design element
      END TYPE
      ...
      TYPE CTENDAXIS               ' 40/NR:0  Reference axis
        m_ID0 as Long              '        identifier 0
      ...
      TYPE CTENDAX_1               ' 40/NR:1  Reference axis stations
        m_ID0 as Long              '        identifier 1
        m_IGBIT as Long            '        station parameter
        m_NRSTAB as Long           '        internal beam number
        m_EXTID as Long            '        external beam number (Quad: 0)
      ...
      TYPE CTNDAXDEF               ' 40/NR:5  Reference axis definition
        m_ID0 as Long              '        identifier 5
        m_NOH as Long              '        Number of the reference axis
        m_TYP as Long              '        Type of definition: 1 Beam, 2 Node, 3 ..., 4 Auto, 5 Poly, 6 Re
        m_VAL1 as Single           '        Values according to type *)
        m_VAL2 as Single           '        "
        m_VAL3 as Single           '        "
        m_S as Single              '        Station at the begin of the reference axis
        m_SETBIT as Long           '        Bitfield indicating what was set: 1:val1 & 2:val2 & 4:val3 & 8:
        m_REFID as Long            '        In the case of Typ=Refx/Sln: Id of the reference axis
        m_SREFID as Long           '        In the case of Typ=Refx:     Id of the secondary reference axis
        m_ART as Long              '        Intersections with: 1 Beams, 2 Quads, 3 Brics (reserved), 4 ...
        m_TITL(1 to 17) as Long    '        Title of the reference axis
      END TYPE

      TYPE CTENDSPLI               ' 41/NR:0  Duct curves
        m_ID0 as Long              '        identifier 0
        m_NRSPUR as Long           '        Id reference axis
        m_NRSV as Long             '        Id prestressing system
        m_IGSYS as Long            '        prestress for:
      ...
      TYPE CTENDINTS               ' 41/NR:110  Duct curve intersections
        m_ID0 as Long              '        Identifier 110
        m_ELMID as Long            '        Intersected element id
        m_ELMTYP as Long           '        Type of the intersected element: 1 Beam, 2 Quad, (3 Brics - res
        m_PARAM(1 to 2) as Single  '        Entry and exit intersection parameter of the duct curve
        m_NRMDST(1 to 2) as Single ' [1001] Entry and exit normal distance to element's boundary. Inside < 
        m_INPDST(1 to 2) as Single ' [1001] Entry and exit inplane/ distance to element's boundary. Inside 
        m_INTLOC(1 to 2) as Long   '        Entry and exit intersection location. With element parameters b
      END TYPE

      TYPE CDUCTGRPS               ' 41/NR:112  Element groups for duct intersections
        m_ID0 as Long              '        Identifier 112
        m_CMD as Long              '        2 (see remark), [legacy: 0 activated, 1 deactivated]
        m_GRPID(1 to 9999) as Long '        Alternating groupId and command (0:activate, 1:deactivate).
      END TYPE

      TYPE CTGEOGUID               ' 41/NR:999  Unique identifier of TGEO (aka tendon spline or duct curve)
        m_ID0 as Long              '        identifier 999
        m_GUID(1 to 36) as Long    '        1152 Bit GUId Identifier of following element in the BIM/CAD sy
      END TYPE
      ...
      TYPE CTENDTOPP               ' 43/NR  Tendon toppoints
        ...
        m_IGREF as Long            '        reference to      geometry  Rec: 03
        m_S(1 to 1024) as Single   ' [1001] stations on toppoints (max. 1024)
      END TYPE

      TYPE CTENDON                 ' 44/NR:0  Tendons
        m_ID0 as Long              '        identifier 0
        m_NRSPUR as Long           '        Reference axis
        m_NRSPLI as Long           '        Duct curve
        ...
        m_AR as Single             '        area for crack width
        m_DZ as Single             '        effective diameter
        m_UZ as Single             '        perimeter for crack width
        m_VALM(1 to 4) as Single   '        reserved
        m_TEXT(1 to 17) as Long    '        construction stage title
      END TYPE
      ...
      TYPE CTENDJACK               ' 44/NR:1  Tendon jacking data
        ...
        m_TEXT(1 to 17) as Long    '        tendon title
      END TYPE
      ...
      TYPE CTENDDEF1               ' 44/NR:5  Tendon definition for tendon 2.0
        m_ID0 as Long              '        Identifier 5
        m_TENDID as Long           '        (Own) tendon id
        m_REFTND as Long           '        Id reference axis in tendon   record  (record: 40/reftnd)
        m_REFGEO as Long           '        Id reference axis in geometry record  (record:  3/refgeo)
        m_DUCTND as Long           '        Id duct curve     in tendon   record  (record: 41/ductnd)
        m_DUCGEO as Long           '        Id duct curve     in geometry record  (record:  3/ducgeo)
        m_SYSP as Long             '        Id prestressing system                (record:  4/sysp  )
        m_MAT as Long              '        Id material of the prestressing steel (record:  1/mat   )
        m_NTEN as Long             '        Number of individual tendons (Attention: NOT wires inside a ten
        m_TNDTYP as Long           '        Type of reference: 1 node, 2 beam, 3 field, 4 reference axis
        m_FROMTO(1 to 2) as Single '        Starting/ending station (parameters on the reference axis)  FRO
        m_SFROTO(1 to 2) as Single ' [1001] Distances to starting/ending station.                       SFR
        m_EFROTO(1 to 2) as Single ' [1001] Distances for effective prestressing.                       EFR
        m_FROSET as Long           '        Bit field to check, if FROM and/or TO was set: 1 FROM, 2 TO (on
        m_LC as Long               '        Load case id for loads from prestressing                    (re
        m_LC0 as Long              '        Load case id for unconstraint cutting forces (only beams)   (re
        m_TNDTIT(1 to 17) as Long  '        Tendon title
        m_CS(1 to 3) as Long       '        Construction stages (installation/grouting/removal)
        m_CSTITL(1 to 17) as Long  '        Construction stages title
        m_LOADME as Long           '        Loading method:             1 pfac, 2 pdef, 3 psig, 4 paas (use
        m_SIDE as Long             '        Prestressing side:          1 LE, 2 RI, 3 LERI, 4 RILE
        m_JACPRC(1 to 2) as Long   '        Jacking procedure bit:      1 stress, 2 release, 4 restress, 8 
        m_PDEF(1 to 8) as Single   '        Preset forces for pdef:     STL, REL, RSL, SLL, STR, RER, RSR, 
        m_PFAC(1 to 10) as Single  '        Limit factors for pfac:     [0-4] left, [5-9] right: FAC, FACA,
        m_KAPPA as Single          '        Friction safety factor to prevent overstress
        m_KAPLEN as Long           '        Length for kappa reduction: 1 symmetric, 2 optimized
        m_KVALS(1 to 10) as Single '        K-values of Psig:           K1-K10
        m_PDTSET as Long           '        PDAT input was given: 0 no, 1 yes
        m_FTRLEN as Single         '        Force transition length
        m_FTRTYP as Long           '        Force transition type:     1 Line, 2 Para, 3 Llin, 4 Rlin, 5 LP
        m_CONMAT as Long           '        Id material of reductional area
        m_AR as Single             ' [1012] Reference area for crack width       [m2]
        m_UZ as Single             ' [1026] Perimeter for crack width            [mm]
        m_DZ as Single             ' [1026] Effective diameter                   [mm]
        m_NUMWIR as Long           '        (Number of wires           - not yet active!)
        m_REDWIR as Long           '        (Reduced number of wires   - not yet active!)
        m_PARTPR as Single         '        (Partial prestressing in % - not yet active!)
        m_FRCSET as Long           '        FRIC input was given: 0 no, 1 yes
        m_FRCBET(1 to 2) as Single ' [1009] Additional friction wobble factors at start and end   in [1/m]
        m_FRCLIM(1 to 2) as Single '        Additional friction limits: start and end station (parameters o
        m_FRCTYP as Long           '        How is additional friction added: 1 add, 2 vect
      END TYPE

      TYPE CTENDRES1               ' 44/NR:7  Tendon result 1
        m_ID0 as Long              '        identifier 7
        m_TNDGEO as Long           '        Id eccentric/tendon curve geometry            (record:  3/tndge
        m_CRVLIM(1 to 8) as Single '        Curve limits of the eccentric tendon curve    (Teddy-Tend: SFRO
        m_PREORD(1 to 10) as Long  '        Order of the prestressing                     (1)
        m_JCKFAC(1 to 10) as Single'        Acting forces factors at the jack             (1)
        m_ELOLEN(1 to 10) as Single' [1032] Elongation lengths (equivalent to forces)     (1),(3) [mm]
        m_DFLLOG(1 to 10) as Long  '        If a deflection point was found 1, else 0.    (1)
        m_DFLPAR(1 to 10) as Single'        Parameters at the deflection points           (1)
        m_DFLFAC(1 to 10) as Single'        Force factors at the deflection points        (1)
        m_APLKAP as Single         '        Applied friction safety factor for overstress (2)
        m_APLFAC(1 to 10) as Single'        Applied prestressing limit factors            (2)
        m_UNRFAC(1 to 10) as Single'        Unreduced prestressing limit factors          (2)
        m_KAPRED(1 to 2) as Single '        Reduction factors for the left and right jacking forces, if kap
      END TYPE

      TYPE CTENDRES2               ' 44/NR:8  Tendon result 2
        m_ID0 as Long              '        identifier 8
        m_PARAM as Single          '        Parameter on the eccentric/tendon curve
        m_ACTFAC as Single         '        Active factors for prestressing
        m_FACTS(1 to 10) as Single '        Force factors during prestressing]: [0-4] left, [5-9] right: St
      END TYPE

      TYPE CTENDGUID               ' 44/NR:999  Unique identifier of the tendon
        m_ID0 as Long              '        identifier 999
        m_GUID(1 to 36) as Long    '        1152 Bit GUId Identifier of following element in the BIM/CAD sy
      END TYPE

      TYPE CHIST_HED               ' 80/LC:-1??  TimeHistoryTitle
        m_RID as Single            '        Identifier of history type
        m_TITLE(1 to 33) as Long   '        Designation
      END TYPE

      TYPE CHIST_EXT               ' 80/LC:-2??  TimeHistoryExtended
        m_RID as Single            '        Extended Parameters for time histories
        m_VAL as Single            ' [  32] values for the preceding identifications
      END TYPE
      ...
      TYPE CSLVL_DAT               ' 87/0:+  Structural Storey Level Data
        ...
        m_RMASSZ as Single         ' [1182] Rotational mass moment of inertia about Z
        m_VAL17 as Single          '        unused
        m_TEXT(1 to 17) as Long    '        Designation of level
        m_POID as Long             '        POI for drift computation (0=COM, 1=COR, 2=USER)
        m_XYPOID(1 to 2) as Single ' [1001] Coordinates of user-defined POI for drift-calculation
        m_AS_RC(1 to 2) as Single  ' [1012] Shear area of reinforced concrete supporting members [X,Y]-dire
        m_AS_ST(1 to 2) as Single  ' [1012] Shear area of steel               supporting members [X,Y]-dire
        m_AS_BR(1 to 2) as Single  ' [1012] reserved
      END TYPE
      ...
      TYPE CSLVL_RES               ' 87/LC:+  Structural Storey Level Results
        ...
        m_DXMAX as Single          ' [1003] maximum inter-storey drift in X
        m_DYMAX as Single          ' [1003] maximum inter-storey drift in Y
      ...
      TYPE CDSLN                   ' 120/00:+  Design elements
        m_NR as Long               '        beam number
        m_NODE(1 to 2) as Long     '        node number start/end
        m_NP as Long               '        prop number
        m_DL as Single             ' [1001] beamlength
...
const BEAM_SCT_IHINGE_MLP = 65536
      ...
      TYPE CDSLN_SCT               ' 120/00:0  Design element sections
        m_ID as Long               '        identifier for sections 0
        m_NQ as Long               '        number cross section
      ...
      TYPE CBEAM_TND               ' 100/05  tendons of beams
        ...
        m_D as Single              ' [1023] effect. diameter for crack width
        ...
        m_TEMP as Single           ' [1215] Temperature
        m_REDFAK as Single         ' [1299] Reduction factor within transmission length
        m_XSI as Single            ' [1299] Relative parameter [0, 1] on the reference axis (Record: 40/...
      END TYPE

      TYPE CDSLN_TND               ' 120/05  tendons of design elements
        m_NR as Long               '        beamnumber
        m_NRS as Long              '        tendon number
        m_MNR as Long              '        material number of tendon + 1000 * material number of cross-sec
        m_IBA1 as Long             '        construction stage number for placing
      ...
      TYPE CDSLN_SL                ' 121/LC:*  single loads on design element
        m_NR as Long               '        beamnumber
        m_TYP as Long              '        type of load
        m_X as Single              ' [1001] load point
        m_I_2 as Single            ' [1001] reserved 0.
      ...
      TYPE CBEAM_DL                ' 101/LC:*  distributed beam loading on reference
        ...
        m_ORIGID as Long           '        Identifier of the load origin (e.g., tendon id)
      END TYPE
      ...
      TYPE CDSLN_DL                ' 121/LC:*  distributed design element loading on reference axis
        m_NR as Long               '        beamnumber
        m_TYP as Long              '        type of load
        m_X as Single              ' [1001] start point
        m_L as Single              ' [1001] length of load
      ...
      TYPE CDSLN_TL                ' 121/LC:*  distributed design element loading on reference axis
        m_NR as Long               '        beamnumber
        m_TYP as Long              '        type of load
        m_X as Single              ' [1001] start point
        m_L as Single              ' [1001] length of load
      ...
      TYPE CDSLN_FTC               ' 122/LC:0  Maximum of Design element forces without plate components
        m_ID as Long               '        identifier 0
        m_X as Single              ' [1001] max. beam length
        m_N as Single              ' [1101] normal force
        m_VY as Single             ' [1102] y-shear force
      ...
      TYPE CBEAM_FOR               ' 102/LC:+  Total Beam forces and deformations
        ...
        m_ALPH_X as Single         ' [1003] eas displacement local x
        m_BETA_X as Single         ' [1004] eas rotation local x (torsion)
        m_BETA_Y as Single         ' [1004] eas rotation local y
        m_BETA_Z as Single         ' [1004] eas rotation local z
        m_BETA_W as Single         ' [1005] eas twisting
        m_ALPH2_X as Single        ' [1003] eas displacement local x
        m_BETA2_X as Single        ' [1004] eas rotation local x (torsion)
        m_BETA2_Y as Single        ' [1004] eas rotation local y
        m_BETA2_Z as Single        ' [1004] eas rotation local z
        m_BETA2_W as Single        ' [1005] eas twisting
      END TYPE
      ...
      TYPE CDSLN_FTR               ' 122/LC:+  Design element forces without plate components
        m_NR as Long               '        beamnumber
        m_X as Single              ' [1001] distance from start
        m_N as Single              ' [1101] normal force
        m_VY as Single             ' [1102] y-shear force
      ...
      TYPE CBEAM_PLX               ' 219/LC:+  T-beam TBEX - negative quad part
        m_NR as Long               '        beamnumber
        m_X as Single              ' [1001] distance from start
        m_N as Single              ' [1101] normal force
        m_VY as Single             ' [1102] y-shear force
      ...
      TYPE CDSLN_STI               ' 123/LC  Stiffness of design elements
        m_NR as Long               '        beam number
        m_X as Single              ' [1001] distance from start
        m_EA as Single             ' [  62] normal stiffness
        m_GAY as Single            ' [  62] y-shear stiffness
      ...
      TYPE CBSCT_STI               ' 143/LC  Stiffness of external sections
        m_NR as Long               '        beam number
        m_X as Single              ' [1001] distance from start
        m_EA as Single             ' [  62] normal stiffness
        m_GAY as Single            ' [  62] y-shear stiffness
      ...
      TYPE CDSLN_CRC               ' 124/LC:0  Parameter of creep interval for each material
        m_ID as Long               '        identifier 0
        m_MNR as Long              '        materialnumber
        m_EXP as Long              '        exposition class of explicit curve
        m_T as Single              ' [  93] absolute age
      ...
      TYPE CDSLN_CRF               ' 124/LC:+  resulting forces of redistribution
        m_NR as Long               '        beamnumber
        m_ID as Long               '        identifier 0
        m_X as Single              ' [1001] distance from start
        m_SDNI as Single           ' [1101] total normal force
      ...
      TYPE CDSLN_TSN               ' 124/LC:+  thermal eigen stress per material
        m_NR as Long               '        element number
        m_MNRX as Long             '        10000+materialnumber
        m_X as Single              ' [1001] distance from start
        m_TS(1 to 32,1 to 2) as Single ' [1092] Eigenstress table (z,sig)
      ...
      TYPE CBEAM_CRP               ' 104/LC:+  forces on sectional parts per material
        ...
        m_ASF(1 to 10) as Single   '        up to 10 Factors on used reinforcement layers
      END TYPE

      TYPE CDSLN_CRP               ' 124/LC:+  forces on sectional parts per material
        m_NR as Long               '        beamnumber
        m_MNR as Long              '        materialnumber
        m_X as Single              ' [1001] distance from start
        m_DNI as Single            ' [1101] impr. normal force
      ...
      TYPE CBEAM_CRT               ' 104/LC:+  changes of tendon force
        m_NR as Long               '        beamnumber
      ...
      TYPE CDSLN_CRT               ' 124/LC:+  changes of tendon force
        m_NR as Long               '        beamnumber
        m_NRS as Long              '        neg. tendonnumber
        m_X as Single              ' [1001] distance from start
        m_DZZ as Single            ' [1092] change of stress to prestress
      ...
      TYPE CBSCT_CRT               ' 144/LC:+  changes of tendon force
        m_NR as Long               '        beamnumber
        m_NRS as Long              '        neg. tendonnumber
        m_X as Single              ' [1001] distance from start
        m_DZZ as Single            ' [1092] change of stress to prestress
      ...
      TYPE CBEAM_STC               ' 105/LC:0  Maximum stresses in cross-section of beams
        ...
        m_FAK_VV as Single         '        shear reduction factor = elastic/nonlinear lever
        m_N_PART as Single         ' [1101] normal force in that part of the section
        m_SIGCT as Single          ' [1092] decompression stress
      END TYPE

      TYPE CDSLN_STC               ' 125/LC:0  Maximum stresses in cross-section of design elements
        m_NR as Long               '        Ident 0
        m_MNR as Long              '        materialnumber
        m_X as Single              ' [1001] distance to start
        m_SIGC as Single           ' [1092] compressive stress
      ...
      TYPE CBSCT_STC               ' 145/LC:0  Maximum stresses in cross-section of external sections
        m_NR as Long               '        Ident 0
        m_MNR as Long              '        materialnumber
        m_X as Single              ' [1001] distance to start
        m_SIGC as Single           ' [1092] compressive stress
      ...
      TYPE CDSLN_TST               ' 125/LC:+  thermal eigen stress per material
        m_NR as Long               '        element number
        m_MNRX as Long             '        100000 + material number as in BSCT_STC
        m_X as Single              ' [1001] distance from start
        m_TS(1 to 128,1 to 2) as Single ' [1092] Eigenstress table (z,sig)
      ...
      TYPE CBEAM_STT               ' 105/LC:+  stresses in tendons
        m_NR as Long               '        beamnumber
        m_NRS as Long              '        neg. tendonnumber
        m_X as Single              ' [1001] distance from start
        m_SIG as Single            ' [1092] stress in tendon
        m_DSIG as Single           ' [1092] sway stress in tendon
      END TYPE

      TYPE CDSLN_STT               ' 125/LC:+  stresses in tendons
        m_NR as Long               '        beamnumber
        m_NRS as Long              '        neg. tendonnumber
        m_X as Single              ' [1001] distance from start
        m_SIG as Single            ' [1092] stress in tendon
      ...
      TYPE CBSCT_STT               ' 145/LC:+  stresses in tendons
        m_NR as Long               '        beamnumber
        m_NRS as Long              '        neg. tendonnumber
        m_X as Single              ' [1001] distance from start
        m_SIG as Single            ' [1092] stress in tendon
      ...
      TYPE CDSLN_STR               ' 125/LC:+  Stresses in cross-section of design elements
        m_NR as Long               '        beamnumber
        m_MNR as Long              '        materialnumber
        m_X as Single              ' [1001] distance from start
        m_SIGC as Single           ' [1092] compressive stress
      ...
      TYPE CBSCT_STR               ' 145/LC:+  Stresses in cross-section of external sections
        m_NR as Long               '        beamnumber
        m_MNR as Long              '        materialnumber
        m_X as Single              ' [1001] distance from start
        m_SIGC as Single           ' [1092] compressive stress
      ...
      TYPE CDSLN_RF0               ' 126/DC:0  max. values of reinforcement
        m_NR as Long               '        identifier 0
        m_NVERS as Long            '        Version number
        m_ASLMAX as Single         ' [1021] maximum longitudinal reinforcement
        m_ASBMAX as Single         ' [1021] maximum of transverse reinforcement reinforcement
      ...
      TYPE CBEAM_RFI               ' 106/DC:+  info of reinforcement of beams
        m_NR as Long               '        beamnumber
      ...
      TYPE CDSLN_RFI               ' 126/DC:+  info of reinforcement of design elements
        m_NR as Long               '        beamnumber
        m_NQ as Long               '        info id = 0
        m_X as Single              ' [1001] distance from start
        m_ASL(1 to 10,1 to 2) as Long '        infos for longitudinal layers 0:9
      ...
      TYPE CBSCT_RFI               ' 146/DC:+  info of reinforcement of external sections
        m_NR as Long               '        beamnumber
        m_NQ as Long               '        info id = 0
        m_X as Single              ' [1001] distance from start
        m_ASL(1 to 10,1 to 2) as Long '        infos for longitudinal layers 0:9
      ...
      TYPE CBEAM_RFC               ' 106/DC:+  reinforcement of beams
        m_NR as Long               '        beamnumber
        m_NQ as Long               '        section number
        m_X as Single              ' [1001] distance from start
      ...
      TYPE CDSLN_RFC               ' 126/DC:+  reinforcement of design elements
        m_NR as Long               '        beamnumber
        m_NQ as Long               '        section number
        m_X as Single              ' [1001] distance from start
        m_ASUM as Single           ' [1020] Total longitudinal reinforcement
      ...
      TYPE CBSCT_RFC               ' 146/DC:+  reinforcement of external sections
        m_NR as Long               '        beamnumber
        m_NQ as Long               '        section number
        m_X as Single              ' [1001] distance from start
        m_ASUM as Single           ' [1020] Total longitudinal reinforcement
      ...
      TYPE CDSLN_RFS               ' 126/DC:Z+  results of shear wall design
        m_NR as Long               '        beamnumber
        m_ID1 as Long              '        identifier
        m_X as Single              ' [1001] distance from start
        m_ASUM as Single           ' [1020] Total main vertical reinforcement
        m_R2 as Single             ' [1021] Reserved
        m_ASL(1 to 10) as Single   ' [1020] Main vertical reinforcement
        m_R13 as Single            ' [1001] Reserved
        m_ASBMAX as Single         ' [1021] Total shear reinforcement
        m_ASB(1 to 15,1 to 2) as Single ' [1021] transverse shear (A(1,i)) / confinement (A(2,i)) reinforcement
        m_LBA as Single            ' [1001] width of edge zone A (+Z)
        m_LBE as Single            ' [1001] width of edge zone B (+Z)
        m_THK(1 to 3) as Single    ' [1001] thickness of wall in {mid zone, edge zone A, edge zone B}
        m_TEXT(1 to 17) as Long    '        Designation of Designcase
      END TYPE
      ...
      TYPE CBEAM_DE0               ' 107/LC:0  max. values of Ultimate/Plastic Design results
        ...
        m_FCHK as Single           '        Bitpattern of associated design codes
        m_TCF as Single            ' [1299] total utilisation level (all effects)
        m_SCN as Single            ' [1299] utilisation level  (1) N/Npl
        m_SCVY as Single           ' [1299] utilisation level  (2) Vy/Vypl
        m_SCVZ as Single           ' [1299] utilisation level  (3) Vz/Vzpl
        m_SCMT as Single           ' [1299] utilisation level  (4) Mt/Mtpl
        m_SCMY as Single           ' [1299] utilisation level  (5) My/Mypl
        m_SCMZ as Single           ' [1299] utilisation level  (6) Mz/Mzpl
        m_SCMB as Single           ' [1299] utilisation level  (7) Mb/Mbpl
        m_SCT2 as Single           ' [1299] utilisation level  (8) Mt2/Mt2pl
        m_SCCOMB as Single         ' [1299] utilisation level  (9) TOTAL INTERACTION
        m_SCBN as Single           ' [1299] utilisation level (10) buckling / torsional buckling
        m_CSIGC as Single          ' [1299] utilisation level (11) sig-c/fy
        m_CSIGT as Single          ' [1299] utilisation level (12) sig-t/fy
        m_CTAU as Single           ' [1299] utilisation level (13) tau/tauy
        m_CSGV as Single           ' [1299] utilisation level (14) sigv/fy (von Mises)
        m_CSGR as Single           ' [1299] utilisation level (15) sig-s (tendon/reinforc.stress)
        m_CAS as Single            ' [1299] utilisation level (16) As/As-provided (long.Reinforc)
        m_CASL as Single           ' [1299] utilisation level (17) Asv/Asv-provided (transverse reinf)
        m_CCW as Single            ' [1299] utilisation level (18) As/As-provided for crack width
        m_CSGD as Single           ' [1299] utilisation level (19) sig-d (dynamic stress range)
        m_CTAU0 as Single          ' [1299] utilisation level (20) tau0  (Nachweisgrenzen)
        m_C2T as Single            ' [1299] utilisation level (21) plate slenderness (c/t)
        m_CLASS as Single          '        highest criteria for section class
      END TYPE

      TYPE CDSLN_DE0               ' 127/LC:0  max. values of Ultimate/Plastic Design results
        m_NR as Long               '        identifier 0
        m_X as Single              ' [1001] distance from start
        m_NI as Single             ' [1101] Inner normal force
        m_MYI as Single            ' [1104] bending moment My
      ...
      TYPE CBEAM_DES               ' 107/LC:+  Ultimate/Plastic Design results
        ...
        m_EDCMIN as Single         ' [   9] minimum decompression strain (NSTR-Analysis)
        m_EDCMAX as Single         ' [   9] maximum decompression strain (NSTR-Analysis)
        m_FCHK as Single           '        applied design category
        m_TCF as Single            ' [1299] total utilisation level (all effects)
        m_SCN as Single            ' [1299] utilisation level  (1) N/Npl
        m_SCVY as Single           ' [1299] utilisation level  (2) Vy/Vypl
        m_SCVZ as Single           ' [1299] utilisation level  (3) Vz/Vzpl
      ...
      TYPE CDSLN_DES               ' 127/LC:+  Ultimate/Plastic Design results
        m_NR as Long               '        elementnumber
        m_X as Single              ' [1001] distance from start
        m_NI as Single             ' [1101] Inner normal force
        m_MYI as Single            ' [1104] bending moment My
      ...
      TYPE CLINK                   ' 111/00:+  Link elements
        m_NR as Long               '        element number
        m_NODE(1 to 2) as Long     '        node number start/end
        m_MNO as Long              '        optional reference to a material
        m_DOFB as Long             '        bits identifying active local DOFs
        m_NREF as Long             '        structural parent object
        m_IBT6 as Long             '        reserved
        m_DL as Single             ' [1001] element length
        m_T(1 to 3,1 to 3) as Single '        transformation matrix
        m_AREF as Single           '        reference area
        m_S as Single              '        interface location, e.g.
        m_K(1 to 7) as Single      '        local stiffness values (diagonal entries)
      END TYPE
...
const SPRI_WL0_MTYP_PKIN = 4
      TYPE CSPRI_WL0               ' 173/NR:0  (Nonlinear) Material for Link elements, Spring elements and Bea
        m_ID as Long               '        Identification = 0
        ...
        m_IHBIT as Long            '        Bitpattern of defined degrees of freedom (implicit hinge & PMM-
...
const SPRI_WL_NTYP_PLAS = 4
      TYPE CSPRI_WL                ' 173/NR:+  Force-Displacement / Moment-Rotation Worklaw
        m_ID as Long               '        Identification
        m_NTYP as Long             '        Type of law
      ...
      TYPE CHLNK                   ' 179/00  link elements (hydraulic/ thermal)
...
const LEN_CQUAD0 = 27
      ...
      TYPE CQUAD_TEN               ' 200/5  tendons of Quad-elements
        ...
        m_XSI(1 to 2) as Single    ' [1299] Relative entry and exit parameters [0, 1] on the reference axis
      END TYPE
      ...
      TYPE CQUAD_RND               ' 271/0:0  Evaluated Reinforcement Definitions of Nodes
        m_ID as Long               '        identifier (0 = Headder of a definition)
        m_NRG as Long              '        group number
        m_NR as Long               '        selector or element number
        m_BITS as Long             '        Type of grading
      ...
      TYPE CQUAD_RIL               ' 200/7:+  Reinforcement Layers of Quad-elements
        ...
        m_BSMAX as Single          ' [1021] Max reinforcement for nonlinear ASE
      END TYPE
      ...
      TYPE CQUAD_RNL               ' 271/0:+  Evaluated Reinforcement Definitions of Nodes
        m_ID as Long               '        reference for this layer
        m_DIR as Long              '        Type of local x-direction
        m_ROT as Single            ' [   5] Angle with reference to the local x-direction
        m_XDIR as Single           ' [1001] Global reference direction or reference point
      ...
      TYPE CQUAD_INP               ' 216/LC:+  Inplane spring reaktion forces quad-element
        m_NR as Long               '        internal Quad-elementnumber
        m_P24(1 to 24) as Single   ' [1151] reaktion forces of 4 quad nodes
      END TYPE
      ...
      TYPE CQUAD_DST               ' 250/DC:+  design stresses in Quad-elements
        ...
        m_SDOU(1 to 2) as Single   ' [1092] stress range upside/downside \
        m_RIOU(1 to 2) as Single   ' [   3] direction of main stress range upside/downside \
        m_SMIN(1 to 2) as Single   ' [1092] minimum stress in this direction upside/downside \
        m_SMAX(1 to 2) as Single   ' [1092] maximum stress in this direction upside/downside \
        m_SPERM(1 to 2) as Single  ' [1092] permanent stress in this direction upside/downside \
        m_RESERVED(1 to 8) as Single '        reserved for future usage
        m_TEXT(1 to 17) as Long    '        Designation of Designcase \
      END TYPE
      ...
      TYPE CQUAD_NRP               ' 262/DC:+  punching reinforcement in nodes
        ...
        m_ASL as Single            ' [1021] required longitudinal reinforcement
        m_ASV1 as Single           ' [1020] shear reinforcement within 1st perimeter
        m_ASV2 as Single           ' [1020] shear reinforcement within 2nd perimeter
        m_ASV3 as Single           ' [1020] shear reinforcement within 3rd perimeter
        m_ASV4 as Single           ' [1020] shear reinforcement within 4th perimeter
        m_FREE0(1 to 4) as Single  '        not yet used
        m_BETA as Single           '        beta value
        m_TXT1(1 to 16) as Long    '        Halfen Description 1 (n chars require n/2+1 words)
      ...
      TYPE CQUAD_RNM               ' 271/DC:0  maximum reinforcement results in  Nodes
        m_NG as Long               '        ident 0
        m_NR as Long               '        ident 0
        m_ID as Long               '        +1 identifier for reincorcement
        m_ORIG as Long             '        origin of maximum reinforcement, see QUAD_REA for Details
      ...
      TYPE CQUAD_RNA               ' 271/DC:Z+  General Concrete Design Results in Nodes
        m_NG as Long               '        group number (for nodal results)
        m_NR as Long               '        element number
        m_ID as Long               '        ident 0 : concrete results
        m_ORIG as Long             '        origin of maximum reinforcement:
      ...
      TYPE CQUAD_RNR               ' 271/DC:Z+  Reinforcement Layer Design Results in Nodes
        m_NG as Long               '        group number (for nodal results)
        m_NR as Long               '        element number
        m_ID as Long               '        identifier of reincorcement layer
        m_ORIG as Long             '        origin of maximum reinforcement, see QUAD_REA for Details
      ...
      TYPE CQUAD_CFD               ' 290/LC  Fluid flow results in Quad-elements
        ...
        m_LMIX as Single           ' [1001] mixing length
      ...
      TYPE CBRIC_TCM               ' 319/LC  damage in Bric-elements LADE
        m_NR as Long               '        elementnumber
        m_IG as Long               '        gauss point
        m_DAM1 as Single           '        damage value    1. crack direction
        m_DIR1(1 to 3) as Single   '        crack direction 1
        m_DAM2 as Single           '        damage value    2. crack direction
        m_DIR2(1 to 3) as Single   '        crack direction 2
        m_DAM3 as Single           '        damage value    3. crack direction
        m_DIR3(1 to 3) as Single   '        crack direction 3
      END TYPE

      TYPE CBRIC_REC               ' 360/DC:0  maximum reinforcement in Bric-elements
        m_NR as Long               '        ident 0 for maximum (first records)
        m_AS(1 to 3) as Single     ' [1022] reinforcement 1-3
        m_OAL as Single            '        Euler Angle I
        m_OAF as Single            '        Euler Angle II
        m_SD(1 to 3) as Single     ' [1092] stress range 1-3  (BEMESS design)
        ...
        m_SIGNON(1 to 3) as Single ' [1092] steel stress reinforcement 1-3 (nonlinear ASE)
        m_SIGBMA as Single         ' [1092] maximum concrete tensile stress (nonlinear ASE)
        m_SIGBMI as Single         ' [1092] maximum concrete compression stress (nonlinear ASE)
        m_EPSS(1 to 3) as Single   ' [1081] average reinforcement strain 1-3 (nonlinear ASE)
        m_CRAC(1 to 3) as Single   ' [1081] crack strain (uncracked: 0) in crack direction 1-3
        m_CD1(1 to 3) as Single    '        crack direction 1 normalvector
        m_CD2(1 to 3) as Single    '        crack direction 2 normalvector
        m_CD3(1 to 3) as Single    '        crack direction 3 normalvector
      END TYPE
      ...
      TYPE CBRIC_NRC               ' 361/DC:0  maximum reinforcement in Bric-nodes
        m_NG as Long               '        ident 0 for maximum (first records)
        m_NR as Long               '        ident 0 for maximum (first records)
        m_AS(1 to 3) as Single     ' [1022] reinforcement 1-3
        m_OAL as Single            '        Euler Angle I
      ...
      TYPE CIL_CTRL1               ' -1/NS:1  Headder of a bending result
        m_IDI as Long              '        Type of result (to select the impact factor)
      ...
      TYPE CIL_CTRL2               ' -1/NS:2  Headder of a shear result
        m_IDI as Long              '        Type of result (to select the impact factor)
        m_IERG as Long             '        index of this item + 1000*IMUNIT
        m_LFMAX as Long            '        Offset for load case number of results for maximum
        m_LFMIN as Long            '        Offset for load case number of results for minimum
      ...
      TYPE CIL_CTRLX               ' -1/NS:?  Headder of transverse evaluation data
        m_IDI as Long              '        number of data points from LSEL INT (3
        m_IERG as Long             '        index of this item + 1000*IMUNIT
        m_LFMAX as Long            '        Offset for load case number of results for maximum
        m_LFMIN as Long            '        Offset for load case number of results for minimum
        m_BWIDTH(1 to 60) as Single' [1001] linked list of wheels whith variable length
      END TYPE

      TYPE CIL_DATA1               ' -1/NS:1????  Influence values for INT 0,1,2
        m_IDI as Long              '        Type of derivatives defined
        m_X as Single              ' [1001] abszissae along lane
        m_PV(1 to 2) as Single     '        value for vertical loading (z) + Derivative (if IDI&1000)
        m_MT(1 to 2) as Single     '        value for torsional loading (x-x) + Derivative of MT/dx (if IDI
        m_PT(1 to 2) as Single     '        value for transverse loading (y) + Derivative of PT/dx (if IDI&
        m_PL(1 to 2) as Single     '        value for longitudinal loading (x) + Derivative of PL/dx (if ID
      END TYPE

      TYPE CIL_DATA2               ' -1/NS:1??????  Influence values for INT > 2
        m_IDI as Long              '        Type of derivatives defined
        m_X as Single              ' [1001] abszissae along lane
        m_PV(1 to 2) as Single     '        value for vertical loading (z) + Derivative (if IDI&1000)
        m_MT(1 to 2) as Single     '        value for torsional loading (x-x) + Derivative of MT/dx (if IDI
        m_PT(1 to 2) as Single     '        value for transverse loading (y) + Derivative of PT/dx (if IDI&
        m_PL(1 to 2) as Single     '        value for longitudinal loading (x) + Derivative of PL/dx (if ID
        m_PPOS(1 to 2) as Single   '        value for vertical distributed loading + Derivative
        m_PNEG(1 to 2) as Single   '        value for vertical distributed loading + Derivative
        m_PZERO as Single          '        position of zero value of the transverse influence line
        m_YEX as Single            '        excentric transverse position of primary load train
        m_RRES(1 to 2) as Single   '        values for right and left residual loading
        m_FAX(1 to 8,1 to 2) as Single '        correction factors for different axle types
      END TYPE
