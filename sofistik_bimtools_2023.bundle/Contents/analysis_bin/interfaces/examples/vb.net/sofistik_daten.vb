...
'   SOFiSTiK AG
'     sofistik_daten.vb
'     This file was created automatically! Do not modify!
'     Simply copy any needed structs from here.
'
      ...
      Structure CREC_INDX          ' -999/-998  Sorted index on structure names
       ...
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_SEL3() as Integer '        Selection string of third integer value
      END Structure
...
const TYPE_GENERIC = +3
      ...
      Structure CREC_DEFI          ' -999/-999:101  additional defines
       Dim m_ID as Integer         '        Identification 11/12
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=65)> Dim m_NAME() as Integer '        define name
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=65)> Dim m_VALUE() as Integer '        define value
      END Structure
      ...
      Structure CCTRL_OBJ          ' 0/01:101  involved objects
       ...
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=32)> Dim m_IDBIM() as Integer '        256 Bit GUId Identifier of element in the BIM/CAD system (obsol
...
const CTRL_ACCESS_2022 = 256
const CTRL_ACCESS_2023 = 512
...
const CODE_TYPE_CONCRETE = 4
const CODE_TYPE_STEEL = 8
const CODE_TYPE_COMPOSITE = 16
const CODE_TYPE_TIMBER = 32
const CODE_TYPE_BRICKWORK = 64
const CODE_TYPE_SOIL = 128
const CODE_TYPE_SEISMIC = 256
const CODE_TYPE_ALUMINIUM = 512
const CODE_TYPE_ALLMAT = 764
const MAT_TYPE_GENERIC = 1
const MAT_TYPE_LAYER = 2
const MAT_TYPE_REINFORCEMENT = 1024
const MAT_TYPE_PRESTRESSING = 2048
...
const MAT_CONS_MCLMB = 19
const MAT_CONS_IFCLMB = 20
...
const MAT_CONC_EN_STANDARD = 1000
const MAT_CONC_EN_LIGHT = 1001
const MAT_CONC_EN_HIGH_STRENGTH = 1002
const MAT_CONC_EN_FIBRE = 1003
const MAT_CONC_EN_ELASTIC = 1004
const MAT_CONC_EN_DEFORMATION_A = 1005
const MAT_CONC_EN_DEFORMATION_B = 1006
const MAT_CONC_DIN_STANDARD = 1010
const MAT_CONC_DIN_LIGHT = 1011
const MAT_CONC_DIN_PRESTRESS = 1012
const MAT_CONC_DIN_ELASTIC = 1014
const MAT_CONC_DIN_NEW_STANDARD = 1015
const MAT_CONC_DIN_NEW_LIGHT = 1016
const MAT_CONC_OEN_STANDARD = 1020
const MAT_CONC_OEN_LIGHT = 1021
const MAT_CONC_OEN_PRESTRESS = 1022
const MAT_CONC_SIA_STANDARD = 1030
const MAT_CONC_SIA_LIGHT = 1031
const MAT_CONC_SIA_HIGH_STRENGTH = 1032
const MAT_CONC_BS_STANDARD = 1040
const MAT_CONC_BS_LIGHT = 1041
const MAT_CONC_BS_HIGH_STRENGTH = 1042
const MAT_CONC_ACI_STANDARD = 1050
const MAT_CONC_ACI_LIGHT = 1051
const MAT_CONC_ACI_HIGH_STRENGTH = 1052
const MAT_CONC_JIS_STANDARD = 1060
const MAT_CONC_JIS_LIGHT = 1061
const MAT_CONC_JRA_CONCRETE = 1062
const MAT_CONC_GBJ_STANDARD = 1070
const MAT_CONC_GBJ_LIGHT = 1071
const MAT_CONC_GBJ_HIGH_STRENGTH = 1072
const MAT_CONC_IS_STANDARD = 1080
const MAT_CONC_IS_LIGHT = 1081
const MAT_CONC_IRC_CONCRETE = 1082
const MAT_CONC_SP_STANDARD = 1090
const MAT_CONC_SP_LIGHT = 1091
const MAT_CONC_BAEL_STANDARD = 1130
const MAT_CONC_BPEL_PRESTRESS = 1132
const MAT_CONC_DUCTAL_FIBRE = 1133
const MAT_CONC_EHE_STANDARD = 1140
const MAT_CONC_EHE_PRESTRESS = 1142
const MAT_CONC_DS_STANDARD = 1150
const MAT_CONC_BBK_STANDARD = 1160
const MAT_CONC_BBK_LIGHT = 1161
const MAT_CONC_NS_STANDARD = 1170
const MAT_CONC_NS_LIGHT = 1171
const MAT_CONC_CAN_STANDARD = 1190
const MAT_CONC_CAL_LIGHT = 1191
const MAT_CONC_CAP_PRESTRESS = 1192
const MAT_CONC_MSZ_STANDARD = 1330
const MAT_CONC_MSZ_LIGHT = 1331
const MAT_CONC_NBR_STANDARD = 1550
const MAT_CONC_NBR_LIGHT = 1551
const MAT_CONC_NBR_PRESTRESS = 1552
const MAT_CONC_AS_STANDARD = 1610
const MAT_CONC_AS_LIGHT = 1611
const MAT_CONC_AS_PRESTRESS = 1612
const MAT_CONC_NZS_STANDARD = 1640
const MAT_CONC_NZS_LIGHT = 1641
const MAT_CONC_NZS_PRESTRESS = 1642
...
const MAT_STEE_EN_RF = 2000
const MAT_STEE_EN_PRESTRESS = 2001
const MAT_STEE_EN_STRUCTURAL = 2002
const MAT_STEE_EN_AL_PLATE = 2003
const MAT_STEE_EN_AL_GENERAL = 2004
const MAT_STEE_EN_AL_CAST = 2005
const MAT_STEE_EN_CABLE = 2009
const MAT_STEE_DIN_RF = 2010
const MAT_STEE_DIN_PRESTRESS = 2011
const MAT_STEE_DIN_STRUCTURAL = 2012
const MAT_STEE_DIN_CAST_IRON = 2013
const MAT_STEE_DIN_AL_GENERAL = 2014
const MAT_STEE_DIN_NEW_STRUC = 2015
const MAT_STEE_DIN_NEW_IRON = 2016
const MAT_STEE_OEN_RF = 2020
const MAT_STEE_OEN_PRESTRESS = 2021
const MAT_STEE_OEN_STRUCTURAL = 2022
const MAT_STEE_OEN_CAST_IRON = 2023
const MAT_STEE_OEN_NEW_IRON = 2026
const MAT_STEE_SIA_RF = 2030
const MAT_STEE_SIA_PRESTRESS = 2031
const MAT_STEE_SIA_STRUCTURAL = 2032
const MAT_STEE_BS_RF = 2040
const MAT_STEE_BS_PRESTRESS = 2041
const MAT_STEE_BS_STRUCTURAL = 2042
const MAT_STEE_ACI_RF = 2050
const MAT_STEE_ACI_PRESTRESS = 2051
const MAT_STEE_AISC_STRUCTURAL = 2052
const MAT_STEE_JIS_RF = 2060
const MAT_STEE_JIS_PRESTRESS = 2061
const MAT_STEE_JIS_STRUCTURAL = 2062
const MAT_STEE_GBJ_RF = 2070
const MAT_STEE_GBJ_PRESTRESS = 2071
const MAT_STEE_GBJ_STRUCTURAL = 2072
const MAT_STEE_IS_RF = 2080
const MAT_STEE_IS_PRESTRESS = 2081
const MAT_STEE_IS_STRUCTURAL = 2082
const MAT_STEE_SP_RF = 2090
const MAT_STEE_SP_PRESTRESS = 2091
const MAT_STEE_SP_STRUCTURAL = 2092
const MAT_STEE_BAEL_RF = 2130
const MAT_STEE_BPEL_PRESTRESS = 2131
const MAT_STEE_EHE_RF = 2140
const MAT_STEE_EHE_PRESTRESS = 2141
const MAT_STEE_EA_STRUCTURAL = 2142
const MAT_STEE_DS_RF = 2150
const MAT_STEE_DS_PRESTRESS = 2151
const MAT_STEE_BBK_RF = 2160
const MAT_STEE_BBK_PRESTRESS = 2161
const MAT_STEE_BSK_STRUCTURAL = 2162
const MAT_STEE_BRO_STRUCTURAL = 2164
const MAT_STEE_NS_RF = 2170
const MAT_STEE_NS_PRESTRESS = 2171
const MAT_STEE_NS_STRUCTURAL = 2172
const MAT_STEE_FEB_RF = 2190
const MAT_STEE_FEP_PRESTRESS = 2191
const MAT_STEE_FEI_STRUCTURAL = 2192
const MAT_STEE_FEG_CAST_IRON = 2193
const MAT_STEE_MSZ_RF = 2330
const MAT_STEE_MSZ_PRESTRESS = 2331
const MAT_STEE_MSZ_STRUCTURAL = 2332
const MAT_STEE_NBR_RF = 2550
const MAT_STEE_NBR_PRESTRESS = 2551
const MAT_STEE_NBR_STRUCTURAL = 2552
const MAT_STEE_AS_RF = 2610
const MAT_STEE_AS_PRESTRESS = 2611
const MAT_STEE_AS_STRUCTURAL = 2612
const MAT_STEE_NZS_RF = 2640
const MAT_STEE_NZS_PRESTRESS = 2641
const MAT_STEE_NZS_STRUCTURAL = 2642
...
const MAT_TIMB_DIN_NA_SOLID_SOFT_WOOD = 3010
const MAT_TIMB_DIN_BS_GLUED_LAMINATED_TIMBER = 3011
const MAT_TIMB_DIN_LA_SOLID_HARD_WOOD_A = 3012
const MAT_TIMB_DIN_LB_SOLID_HARD_WOOD_B = 3013
const MAT_TIMB_DIN_LC_SOLID_HARD_WOOD_C = 3014
const MAT_TIMB_DIN_S_SOLID_WOOD_STANDARD_SORTED = 3015
const MAT_TIMB_DIN_MS_SOLID_WOOD_MASCHINE_SORTED = 3016
const MAT_TIMB_GFK_FIBERGLASS_PLASTICS = 3017
const MAT_TIMB_CFK_CARBON_FIBER_PLASTICS = 3018
const MAT_TIMB_SFK_SYNTHETIC_FIBER_PLASTICS = 3019
const MAT_TIMB_OEN_FTK_SPRUCE_FIR_JAW = 3020
const MAT_TIMB_OEN_L_LARCH = 3021
const MAT_TIMB_OEN_BE_BEECH_OAK = 3022
const MAT_TIMB_EC5_C_SOLID_SOFT_WOOD = 3700
const MAT_TIMB_EC5_GL_GLUED_LAMINATED_TIMBER = 3701
const MAT_TIMB_EC5_D_SOLID_HARD_WOOD = 3702
const MAT_TIMB_EC5_PLY_PLYWOOD = 3703
const MAT_TIMB_EC5_OSB_BOARDS = 3304
const MAT_TIMB_EC5_PART_PARTICLEBOARD = 3705
const MAT_TIMB_EC5_FIB_FIBRE_BOARD = 3306
const MAT_TIMB_DIN_C_SOLID_SOFT_WOOD = 3710
const MAT_TIMB_DIN_GL_GLUED_LAMINATED_TIMBER = 3711
const MAT_TIMB_DIN_D_SOLID_HARD_WOOD = 3712
const MAT_TIMB_DIN_PLY_PLYWOOD = 3713
const MAT_TIMB_DIN_OSB_OSB_BOARDS = 3314
const MAT_TIMB_DIN_PART_PARTICLEBOARD_12 = 3315
const MAT_TIMB_DIN_PART_PARTICLEBOARD_123 = 3715
const MAT_TIMB_DIN_FIB_FIBRE_BOARD = 3316
const MAT_TIMB_SIA_C_SOLID_SOFT_WOOD = 3730
const MAT_TIMB_SIA_GL_GLUED_LAMINATED_TIMBER = 3731
const MAT_TIMB_SIA_D_SOLID_HARD_WOOD = 3732
      ...
      Structure CMAT_BED           ' 1/NR:7  MaterialBedding
       Dim m_ID as Integer         '        Identification
       Dim m_MNR as Integer        '        Materialnumber of bedding body
       ...
       Dim m_RFAC as Single        '        shear strength reduction factor
      END Structure

const MAX_MAT_LAY = 99
      Structure CMAT_LAY           ' 1/NR:8  MaterialLayerStructure
       ...
       Dim m_BETA as Single        ' [   5] Angle of material (difference to local x axis of element)
      END Structure
...
const MAT_SPE_TYPE_MATERIAL = 100
const MAT_SPE_TYPE_KR = 101
const MAT_SPE_TYPE_AIR = 102
const MAT_SPE_TYPE_CNOM = 103
const MAT_SPE_TYPE_CRW = 104
const MAT_SPE_TYPE_EIGE = 105
const MAT_SPE_TYPE_EIGC_EXP_CREEP_CURVE = 106
const MAT_SPE_TYPE_EIGS_EXP_SHRINK_CURVE = 107
const MAT_SPE_TYPE_DMAX = 109
const MAT_SPE_TYPE_TEMP = 110
      ...
      Structure CMAT_CRE           ' 1/NR:90/TYPE  ExplicitCreepCurve
       Dim m_ID as Integer         '        Identification = 90
       Dim m_TYPE as Integer       '        type of material value = 106
       Dim m_TITLE as Integer      '        title of the curve
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=32)> Dim m_RVAL() as Single '        real material values (time[d],value pairs)
      END Structure

      Structure CMAT_SHR           ' 1/NR:90/TYPE  ExplicitShrinkageCurve
       Dim m_ID as Integer         '        Identification = 90
       Dim m_TYPE as Integer       '        type of material value = 107
       Dim m_TITLE as Integer      '        title of the curve
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=32)> Dim m_RVAL() as Single ' [1081] real material values (time[d],value pairs),
      END Structure
      ...
      Structure CBORE_LAY          ' 2/NR:1  Soillayer
       ...
       Dim m_ES as Single          ' [1088] Stiffness Modulus
       Dim m_DES as Single         ' [1088] Increment of ES within current layer
       Dim m_MUE as Single         '        Poissons ratio
...
const AXIS_SUBTYPE_AUXI = 19
      Structure CAXIS              ' 3/ID:0  Geometric Axis
       ...
       Dim m_ID2 as Integer        '        AXIS_SUBTYPE_POST: group number of cut-line
       Dim m_ID3 as Integer        '        AXIS_SUBTYPE_POST: >0 = explicit material to cut , <=0 = all ma
...
const GAX_GEO_NURBS_CPT = 91
      ...
      Structure CAXIS_VTB          ' 3/ID:102  Definition of vertical alignment
       Dim m_ID0 as Integer        '        ident=102
       Dim m_ID1 as Integer        '        specification type
       Dim m_ID2 as Integer        '        reserved
       Dim m_S as Single           '        Parameter s along the axis
       Dim m_H as Single           ' [1001] Elevation of vertical tangency point
       Dim m_R as Single           ' [1001] Curvature Radius
       Dim m_X as Single           ' [1001] Calculated arc length along the axis
       Dim m_L1 as Single          ' [1001] Calculated secant length to the left
       Dim m_L2 as Single          ' [1001] Calculated secant length to the right
      END Structure

      Structure CAXIS_ITB          ' 3/ID:103  Placement at axis position (obsolete)
      ...
      Structure CAXIS_ITM          ' 3/ID:10104  Secondary axis parameter mapping
       Dim m_ID0 as Integer        '        Ident=10104
       Dim m_IDS as Integer        '        Enum of secondary axis (1='A' to 26 ='Z')
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=128)> Dim m_MAP() as Single '        Mapping S (Main axis) --> S (secondary axis)
      END Structure
      ...
      Structure CGAXD_VTB          ' 3/ID:122  Geometric properties for axis heights (double precision)
       ...
       Dim m_ID1 as Integer        '        additional properties
       Dim m_ID2 as Integer        '        reserved
       Dim m_ID3 as Integer        '        reserved
       Dim m_S as Double           '        Parameter s along the axis
       Dim m_H as Double           ' [1001] Elevation of vertical tangency point
       Dim m_R as Double           ' [1001] Curvature radius of segment
       Dim m_R2 as Double          ' [1001] Optional divergent radius to the right (=R by default)
       Dim m_X as Double           ' [1001] Calculated arc length along the axis
       Dim m_L1 as Double          ' [1001] Calculated secant length to the left
       Dim m_L2 as Double          ' [1001] Calculated secant length to the right
      END Structure
...
const GAXD_GEO_PROJECT = 182
      Structure CGAXD_GEO          ' 3/ID:18?  Geometric properties
       Dim m_ILN as Integer        '        Code of geometry
       Dim m_ID1 as Integer        '        additional segment properties
      ...
      Structure CSAXD_NKN          ' 39/NR:190  Knots of a Nurb
       Dim m_ILN as Integer        '        ID=190
       Dim m_DEG as Integer        '        Order of Spline
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=256)> Dim m_S() as Double '        Knot-Vector
      END Structure
      ...
      Structure CSAXD_CPT          ' 39/NR:191  Control point of a Nurb
       Dim m_ILN as Integer        '        ID=191
       Dim m_ID1 as Integer        '        reserved
       Dim m_W as Double           '        Weight
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_XYZ() as Double ' [1001] Coordinates
      ...
      Structure CSAXD_PT           ' 39/NR:192  Data point on curve
       Dim m_ILN as Integer        '        ID=192
       Dim m_ID1 as Integer        '        specification type
       Dim m_S as Double           '        Parameter along curve
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_XYZ() as Double ' [1001] Coordinates
      ...
      Structure CSAXD_ARC          ' 39/NR:193  Circular Arc
       Dim m_ILN as Integer        '        ID=193
       Dim m_IDF as Integer        '        Definition selected
       Dim m_R as Double           ' [1001] Radius of arc
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_XYZ() as Double ' [1001] Coordinates of center
      ...
      Structure CTEND_1            ' 4/ID:1  Tendon of Prestressing Schemes
       ...
       Dim m_ID2 as Integer        '        Type of input: 0 SYSP: post-tensioning
      ...
      Structure CTEND_3            ' 4/ID:3  Jack of Prestressing Schemes
       Dim m_ID0 as Integer        '        identifier 3
       Dim m_ID1 as Integer        '        reserved
      ...
      Structure CTEND_4            ' 4/ID:4  Presets for friction calculation
       Dim m_ID0 as Integer        '        identifier 4
       Dim m_ID1 as Integer        '        reserved
       Dim m_INP as Integer        '        Source of values
       Dim m_K1 as Single          '        Max prestress force: factor on (char.) tensile strength (fp)
       Dim m_K2 as Single          '        Max prestress force: factor on (char.) proof-stress / yield str
       Dim m_K3 as Single          '        Mean prestress force: factor on (char.) tensile strength (fp)
       Dim m_K4 as Single          '        Mean prestress force: factor on (char.) proof-stress / yield st
      END Structure
      ...
      Structure CSARD_PTS          ' 39/NR:290  AreaPointonSurface
       Dim m_ID as Integer         '        Id = 290
       Dim m_IT as Integer         '        Type of point
       Dim m_M as Integer          '        Rasterlocation of mesh (0 < m < mgri )
       Dim m_N as Integer          '        Rasterlocation of mesh (0 < n < ngri )
      ...
      Structure CSARD_NKU          ' 39/NR:291  Knots of a Nurb
       Dim m_ILN as Integer        '        ID
       Dim m_DEG as Integer        '        Order of Spline
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=256)> Dim m_S() as Double '        Knot-Vector
      END Structure

      Structure CSARD_NKV          ' 39/NR:292  Knots of a Nurb
       Dim m_ILN as Integer        '        ID
       Dim m_DEG as Integer        '        Order of Spline
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=256)> Dim m_S() as Double '        Knot-Vector
      END Structure
      ...
      Structure CSECT_ERR          ' 9/NR:-  Invalid section, visualisation only
       Dim m_ID as Integer         '        Identification
       Dim m_MNO as Integer        '        Materialnumber of sections
       Dim m_MRF as Integer        '        Materialnumber of Reinforcement
       Dim m_A as Single           ' [1012] Area
...
const SECT_ADD_MODONLY = -1
const SECT_ADD_MODIFIED = 0
const SECT_ADD_VALUES = 1
const SECT_ADD_STANDARD = 2
const SECT_ADD_PANEL = 3
const SECT_ADD_SOLID = 4
const SECT_ADD_EFF = 5
const SECT_ADD_FEM = 6
const SECT_ADD_HYDRAULIC = 9
const SECT_ADD_FIBRE = 128
const SECT_ADD_ELEMENTS = 256
const SECT_ADD_NEFF = 512
const SECT_ADD_INTE = 1024
const SECT_ADD_TEMPLATE = 2048
const SECT_ADD_VARIABLE = 4096
const SECT_ADD_REFP = 8192
const SECT_ADD_HOT = 16384
const SECT_ADD_RF_GROSS = 32768
const SECT_ADD_RF_GAM = 65536
const SECT_ADD_RF_Eff = 131072
const SECT_ADD_RF_UNUSED = 262144
      Structure CSECT_ADD          ' 9/NR:4  SectionalValuesShear , Temperature
       ...
       Dim m_AT as Single          ' [ 107] Elongationcoefficient for Temperature
       ...
       Dim m_TMIN as Single        ' [1011] minimum thickness of plates
       Dim m_TMAX as Single        ' [1011] maximum thickness of plates
       Dim m_WT as Single          ' [1018] maximum tau for primary Torsion Mtp=1
       Dim m_WVY as Single         ' [1017] maximum tau for Shear Vy=1
       Dim m_WVZ as Single         ' [1017] maximum tau for Shear Vz=1
       Dim m_WT2 as Single         ' [1018] maximum tau for secondary Torsion Mt2=1
       Dim m_AK as Single          ' [1012] kernel area for Torsion (Bredt)
...
const SECT_IBC_UNCHANGED = -1
const SECT_IBC_NONE = 0
const SECT_IBC_A = 1
const SECT_IBC_B = 2
const SECT_IBC_C = 3
const SECT_IBC_D = 4
const SECT_IBC_E = 5
const SECT_IBC_A0 = 8
const SECT_IBC_OFF = 30
const SECT_IBC_DEFAULT = 31
const SECT_IBC_MULT = 32
const SECT_PLA_KIND_ELASTIC = 0
const SECT_PLA_KIND_PLASTIC = 1
const SECT_PLA_KIND_COMBINATION = 2
const SECT_PLA_KIND_COMB_NONSYMM = 3
const SECT_PLA_VAL_DESIGN = 0
const SECT_PLA_VAL_CHARACTERISTIC = 1
const SECT_PLA_VAL_MULT = 100
const SECT_PLA_INFO_SYMMETRIC = 1
const SECT_PLA_INFO_BUCKLING = 2
const SECT_PLA_INFO_GAMMA_M0 = 4
const SECT_PLA_INFO_GAMMA_SCM = 8
const SECT_PLA_INFO_COMPOSITE = 16
const SECT_PLA_INFO_HOLLOW = 32
const SECT_PLA_INFO_MULT = 10000
...
const LAY_MNR_REF = 1000
const LAY_INR_TYPE = 100
const LAY_INR_TYPE_MINIMUM = 1
const LAY_INR_TYPE_ADDITIONAL = 2
const LAY_INR_TYPE_SEQUENTIAL = 3
      Structure CSECT_LAY          ' 9/NR:9  SectionalReinforcementLayer  (LAY)
       ...
       Dim m_ALOW as Single        ' [1020] Lower bound for gross area of layer
       Dim m_AHIG as Single        ' [1020] Upper bound for gross area of layer
       Dim m_ASUM as Single        ' [1020] Sum of reference gross areas of layer
       Dim m_AFAK as Single        '        maximum allowable factor of layer
       Dim m_YS as Single          ' [1011] center of layer (gross)
       Dim m_ZS as Single          ' [1011] center of layer (gross)
       ...
       Dim m_IY as Single          ' [1014] 4th order areas (gross inertia)
       Dim m_IZ as Single          ' [1014] 4th order areas (gross inertia)
       Dim m_IYZ as Single         ' [1014] 4th order areas (gross inertia)
       Dim m_EMOD as Single        ' [1090] Elasticity-Modulus
       ...
       Dim m_N as Single           ' [1101] Prestress normal force N
       Dim m_MY as Single          ' [1104] Prestress bending moment My
       Dim m_MZ as Single          ' [1104] Prestress bending moment Mz
       Dim m_TN as Single          ' [1101] Effective Normal force N    from temperature eigenstress
       Dim m_TMY as Single         ' [1104] Effective Bending moment My from temperature eigenstress
       Dim m_TMZ as Single         ' [1104] Effective Bending moment Mz from temperature eigenstress
       Dim m_EA as Single          ' [1101] Effective tangential stiffnes E*A
       Dim m_EAY as Single         ' [1104] Effective tangential stiffnes E*A*y
       Dim m_EAZ as Single         ' [1104] Effective tangential stiffnes E*A*z
       Dim m_EAYY as Single        ' [1105] Effective tangential stiffnes E*A*z*z
       Dim m_EAZZ as Single        ' [1105] Effective tangential stiffnes E*A*y*y
       Dim m_EAYZ as Single        ' [1105] Effective tangential stiffnes E*A*y*z
       Dim m_NPLC as Single        ' [1101] Effective maximum compressive force
       Dim m_NPLT as Single        ' [1101] Effective maximum tensile force
       Dim m_ARED as Single        ' [1020] Reduction area of material
       Dim m_AEFF as Single        ' [1020] Effective area for normal force
       Dim m_AEFFY as Single       ' [1020] Effective area for evaluating ys and Iz
       Dim m_AEFFZ as Single       ' [1020] Effective area for evaluating zs and Iy
       Dim m_AEFFYZ as Single      ' [1020] Effective area for evaluating Iyz
       Dim m_YSEFF as Single       ' [1011] Effective center of bending stress y
       Dim m_ZSEFF as Single       ' [1011] Effective center of bending stress z
       Dim m_IYEFF as Single       ' [1014] Effective 4th order areas Iy
       Dim m_IZEFF as Single       ' [1014] Effective 4th order areas Iz
       Dim m_IYZEFF as Single      ' [1014] Effective 4th order areas Iyz
       Dim m_AREDY as Single       ' [1020] Reduction area y of material
       Dim m_AREDZ as Single       ' [1020] Reduction area z of material
       Dim m_AREDYZ as Single      ' [1020] Reduction area yz of material
      END Structure
...
const SECT_REC_FIXLAY = 256
      ...
      Structure CSECT_CAB          ' 9/NR:11  SectiontypeCable (CABL)
       ...
       Dim m_GAMMAR as Single      '        partial factor minimise bending stresses (EN 1993-1-11, table 6
      END Structure

const PROF_MNO_IMBEDDED_MAT = 1000
const PROF_PARALLEL_DOUBLE_T = 0
const PROF_INCLINED_DOUBLE_T = 1
const PROF_PARALLEL_U_C = 2
const PROF_INCLINED_U_C = 3
const PROF_PARALLEL_T = 4
const PROF_INCLINED_T = 5
const PROF_HOT_FORMED_L = 6
const PROF_COLD_FORMED_L = 7
const PROF_RECTANGULAR_HOLLOW_SHAPE = 8
const PROF_Z_SHAPE = 9
const PROF_SHEET_PILE_U_TYPE = 10
const PROF_SHEET_PILE_Z_TYPE = 11
const PROF_COLD_FORMED_U_C_Z = 12
const PROF_RECTANGULAR_BAR = 15
const PROF_BAR_TUBE_PIPE = 16
const PROF_REF_STD = 0
const PROF_REF_S = 1
const PROF_REF_SM = 2
const PROF_REF_OR = 3
const PROF_REF_OL = 4
...
const PROF_REF_M = 8
const PROF_REF_UR = 9
const PROF_REF_UL = 10
const PROF_REF_UM = 11
const PROF_PROP_SOLID = 16
const PROF_PROP_HALF = 32
const PROF_PROP_MIRROR_ORIGIN = 64
const PROF_PROP_MIRROR_Y_AXIS = 128
const PROF_PROP_MIRROR_Z_AXIS = 256
const PROF_PROP_FLIP_TO_Y_AXIS = 192
const PROF_PROP_FLIP_TO_Z_AXIS = 320
const PROF_PROP_MIRROR_4_ITEMS = 448
const PROF_PROP_CUSTOM_SHAPE = 512
const PROF_PROP_CALCULATION = 1024
const PROF_PROP_SIMPLIFIED_WIND = 2048
const PROF_PROP_IMPERIAL_UNITS = 4096
const PROF_PROP_SELECTOR_METRIC = 8192
const PROF_PROP_R_AS_K_FOR_HAUNCH = 16384
const PROF_PROP_RECORD_PROF = 32768
const PROF_PROP_ERRORFLAG = 65536
const SECT_PROF_PROP_MULT = 64
      Structure CSECT_PRO          ' 9/NR:12  SectiontypeShape (PROF)
       ...
       Dim m_IBIT as Integer       '        ityp + SECT_PROF_PROP_MULT*(iref+ivtp)
       ...
       Dim m_VYPL as Single        ' [1102] characteristic plastic shear force Vy
       Dim m_VZPL as Single        ' [1102] characteristic plastic shear force Vz
       Dim m_MTPL as Single        ' [1103] characteristic plastic torsional   Mt
       Dim m_MT2PL as Single       ' [1103] characteristic plastic torsional   Mt2
       Dim m_MBPL as Single        ' [1103] characteristic plastic warpmoment  Mb
      END Structure

const MAX_SECT_CS = 32
...
const TXT_IDS_GENERATED_TEXT = 0
const TXT_IDS_USER_TEXT = 1
const TXT_IDS_INTERNAL_CDB = 90
const TXT_IDS_EXTERNAL_CDB = 91
const TXT_IDS_CS_BIRTH = 99
const TXT_IDS_TEMPLATE = 100
const TXT_TXT_INTLEN_TEXT = 17
const TXT_TXT_INTLEN_CDB = 128
      ...
      Structure CSECT_CW           ' 9/NR:80  Hydrodynamic coefficients (WIND/Wave loading)
       ...
       Dim m_AG as Single          ' [   5] angle of attack in degrees
       Dim m_B2H as Single         '        ratio of B2H needed for WBH and BH with derivativa
      END Structure
...
const USR_PROG_AQUA = 1096110401
const USR_PROG_CSE = 1414087749
const USR_PROG_FEAX = 1480672582
const USR_RVAL_PROG_ABS_COOR = 0
const USR_RVAL_PROG_REF_COOR = 1
const USR_ITP_UNIT_OUT = 0
const USR_ITP_MNR = 1
const USR_ITP_MBW = 2
const USR_ITP_MBR = 3
const USR_ITP_BEAM_TYPE = 4
const USR_IVAL_IBTYP_CENTRIC_BEAM = 0
const USR_IVAL_IBTYP_ECCENTRIC_BEAM = 1
const USR_IVAL_IBTYP_TRUSS = 2
const USR_IVAL_IBTYP_CABLE = 3
const USR_IVAL_IBTYP_CENTRIC_COLUMN = 4
const USR_IVAL_IBTYP_ECCENTRIC_COLUMN = 5
const USR_IVAL_IBTYP_PIPE = 9
const USR_ITP_NRQMASTER = 6
const USR_ITP_FACE = 7
const USR_IVAL_FACE_HORIZONTAL_DEFAULT = 1
const USR_IVAL_FACE_DOWN = 2
const USR_IVAL_FACE_HORIZONTAL_INVERSE = 3
const USR_IVAL_FACE_UPPER = 4
const USR_ITP_UNIT_IN = 8
const USR_ITP_BUCKLING = 10
const USR_IVAL_BUCK_DEFAULT = 999
const USR_RVAL_BUCK_I = -1
const USR_RVAL_BUCK_SH = -2
const USR_ITP_SYMMETRY = 11
const USR_IVAL_SYMM_REFERENCE_1M = -1
const USR_IVAL_SYMM_DEPEND_ON_VALUES = 0
const USR_IVAL_SYMM_YES = 1
const USR_IVAL_SYMM_NO = 2
const USR_ITP_TRANS = 13
const USR_IVAL_TRANS_USER = 0
const USR_IVAL_TRANS_IYZ = 1
const USR_IVAL_TRANS_YS = 2
const USR_IVAL_TRANS_ZS = 4
const USR_IVAL_TRANS_APPLY = 8
const USR_ITP_SCL = 14
const USR_IVAL_SCL_NO_C2T = 0
const USR_IVAL_SCL_CLASS_1 = 1
const USR_IVAL_SCL_CLASS_2 = 2
const USR_IVAL_SCL_CLASS_3 = 3
const USR_IVAL_SCL_CLASS_4 = 4
const USR_ITP_LTAU = 80
const USR_ITP_LSIG = 81
const USR_ITP_POIS = 82
const USR_IVAL_POIS_NO = 0
const USR_IVAL_POIS_YES = 1
const USR_IVAL_POIS_FULL = 2
const USR_IVAL_POIS_ALL = 3
const USR_ITP_CODE_TYPE = 83
const USR_ITP_BEAM_X = 100
const USR_ITP_AK = 101
const USR_IVAL_SECTVAL_SPECIAL = -2
const USR_IVAL_SECTVAL_UNDFEFINED = -1
const USR_IVAL_SECTVAL_CALCULATED = 0
const USR_IVAL_SECTVAL_USER = 1
const USR_IVAL_SECTVAL_USER_SPECIAL = 2
const USR_ITP_AY = 102
const USR_ITP_AZ = 103
const USR_ITP_IT = 104
const USR_ITP_CM = 105
const USR_ITP_CMS = 106
const USR_ITP_AYZ = 107
const USR_ITP_YSC = 108
const USR_IVAL_SC_VALUE = 1
const USR_IVAL_SC_CENTER = 2
const USR_ITP_ZSC = 109
const USR_ITP_HYMIN = 110
const USR_ITP_HZMIN = 111
const USR_ITP_AKTZ = 112
const USR_ITP_DEFF = 113
const USR_ITP_B2TF = 114
const USR_ITP_B2TW = 115
const USR_ITP_AGAM = 116
const USR_ITP_NPLT = 120
const USR_ITP_NPLC = 121
const USR_ITP_VYPL = 122
const USR_ITP_VZPL = 123
const USR_ITP_MTPL = 124
const USR_ITP_MYPL = 125
const USR_ITP_MZPL = 126
const USR_ITP_MBPL = 127
const USR_ITP_MT2PL = 128
const USR_ITP_FIRST_CONTROL = 201
const USR_ITP_MIN_RF = 211
const USR_IVAL_RFCS_NO = 0
const USR_IVAL_RFCS_DEFAULT = 1
const USR_IVAL_RFCS_YES = 2
const USR_IVAL_RFCS_WEIGHT = 3
const USR_IVAL_RFCS_ALL = 3
const USR_IVAL_RFCS_EFECTIVE = 4
const USR_IVAL_RFCS_UNUSED_RF_MAT = 8
const USR_IVAL_RFCS_NO_SHEAR_STIFF = 16
const USR_ITP_FIXL = 212
const USR_ITP_FACE_CTRL = 213
const USR_ITP_STYP = 216
const USR_IVAL_STYP_FORC = 0
const USR_IVAL_STYP_IT_ONLY = 1
const USR_IVAL_STYP_TORSION = 2
const USR_IVAL_STYP_FULL = 3
const USR_IVAL_STYP_BEM = 4
const USR_IVAL_STYP_BEM_1 = 5
const USR_IVAL_STYP_BEM_2 = 6
const USR_IVAL_STYP_BEM_3 = 7
const USR_IVAL_STYP_FEM = 11
const USR_IVAL_STYP_FEMX = 15
const USR_ITP_SDIV = 217
const USR_IVAL_SDIV_NO = 0
const USR_IVAL_SDIV_2 = 1
const USR_IVAL_SDIV_4 = 2
const USR_IVAL_SDIV_8 = 3
const USR_IVAL_SDIV_16 = 4
const USR_IVAL_SDIV_32 = 5
const USR_ITP_SINT = 218
const USR_IVAL_SINT_FEM_ELEM = 1
const USR_IVAL_SINT_FEM_NODE = 2
const USR_IVAL_SINT_FEM_LOBATTO = 3
const USR_IVAL_SINT_FEM_GAUSS = 4
const USR_IVAL_SINT_BEM_SHORT = 1
const USR_IVAL_SINT_BEM_DOUBLE = 2
const USR_IVAL_SINT_BEM_EQUATION = 4
const USR_IVAL_SINT_BEM_SYMMETRY = 8
const USR_IVAL_SINT_BEM_LOGPIT = 256
const USR_ITP_SHEAR_CUT = 219
const USR_IVAL_SCUT_NO = 0
const USR_IVAL_SCUT_MAIN = 1
const USR_IVAL_SCUT_BOTH = 2
const USR_IVAL_SCUT_FORC = 8
const USR_IVAL_SCUT_CORNER = 16
const USR_IVAL_SCUT_AXIS = 32
const USR_ITP_HMIN = 220
const USR_ITP_HDIV = 221
const USR_ITP_HTOL = 222
const USR_ITP_PLAS = 226
const USR_IVAL_PLAS_TABLE = 0
const USR_IVAL_PLAS_LINE = 1
const USR_IVAL_PLAS_NONL = 2
const USR_IVAL_PLAS_AREA = 16
const USR_ITP_GDIV = 227
const USR_ITP_FORCES = 229
const USR_IVAL_SAFETY_FORCES = -999
const USR_IVAL_SAFETY_VALUES = -998
const USR_IVAL_FORC_DEFAULT = 0
const USR_IVAL_FORC_TENSION = 1
const USR_IVAL_FORC_COMPRESSION = 2
const USR_IVAL_FORC_BUCKLING = 8
const USR_IVAL_FORC_GAMMA_M0 = 32
const USR_IVAL_FORC_GAMMA_SCM = 64
const USR_ITP_MAX_COOR = 230
const USR_ITP_MIN_COOR = 231
const USR_ITP_LCTEMP = 233
const USR_ITP_FIRST_CS = 293
const USR_ITP_LAST_CS = 356
const USR_ITP_FIRST_MAT = 357
const USR_ITP_LAST_MAT = 420
...
const STEEL_SHAPE_BLOCK_BEGIN = 100
const REF_STRUCT_FIRST_COORD = 101
const REF_STRUCT_SECOND_COORD = 102
const REF_STRUCT_THIRD_COORD = 103
const REF_STRUCT_ANGLE = 104
const REF_STRUCT_THREE_SCALAR = 105
const REFERENCE_BLOCK_END = 199
const REF_IRTS_ABSOLUTE_COORD = 0
const REF_IRTS_RELATIVE_NOSCALE = 1
const REF_IRTS_RELATIVE_SCALEDIST = 2
const REF_IRTS_RELATIVE_SCALEALL = 3
const REF_IRTS_POLAR = 4
const REF_IRTS_ABSOLUTE_Y = 5
const REF_IRTS_ABSOLUTE_Z = 6
const REF_IRTS_ABSOLUTE_P = 7
const REF_IRTS_ALL = 7
const REF_IRTS_ABSOLUTE_DIR = 16
const REF_IRTS_DIR_REF2 = 32
const REF_IRTS_AXIS_REF = 64
const REF_IRTS_AXIS_REF_1 = 128
const REF_IRTS_AXIS_REF_2 = 256
const REF_IRTS_AXIS_REF_3 = 512
const REF_IRTS_REFPOINT_1 = 1024
const REF_IRTS_REFPOINT_2 = 131072
const REF_IRTS_REFPOINT_3 = 16777216
...
const SPT_IDP_IN = 1
const SPT_IDP_C2T = 2
const SPT_IDP_NEFF_Y = 4
const SPT_IDP_NEFF_Z = 8
const SPT_IDP_NEFF_N = 16
const SPT_IDP_FEM = 32
const SPT_IDP_GENERATED = 64
const SPT_IDP_FIBRE = 128
const SPT_IDP_NUMBER = 256
const PPT_IDP_IN = 1
const PPT_IDP_NEFF_EXPL = 2
const PPT_IDP_NEFF_Y = 4
const PPT_IDP_NEFF_Z = 8
const PPT_IDP_NEFF_N = 16
const PPT_IDP_TP = 32
const PPT_IDP_GENERATED = 64
const PPT_IDP_LAST = 128
const PPT_IDP_POLYGON = 256
const PPT_IDP_GENERATED_POLYGON = 100
      Structure CSECT_SPT          ' 9/NR:100  SectionStressPoint (SPT/QSP)
       ...
       Dim m_EXP as Single         '        property set
      ...
      Structure CSECT_PTC          ' 9/NR:310  PartialIntegrationPoint of shear cut
       Dim m_ID as Integer         '        Identification 100/101
       Dim m_MNO as Integer        '        Material number
       Dim m_IDP as Integer        '        Number*256 + Bitpattern
       Dim m_TNR as Integer        '        Designation
      ...
      Structure CSECT_CIR          ' 9/NR:102  SectionCircle (CIRC/KREI)
       ...
       Dim m_UC as Single          '        property set
      END Structure

const PAN_IDP_FIXA = 8
const PAN_IDP_FIXE = 16
const PAN_IDP_NEFF_EXPL = 32
const PAN_IDP_GENERATED = 64
const PAN_IDP_NOCHECK = 128
const PAN_IDP_SPLIT_NEFFA = 256
const PAN_IDP_SPLIT_NEFFE = 512
const PAN_IDP_NEFF_Y = 1024
const PAN_IDP_NEFF_Z = 2048
const PAN_IDP_NEFF_N = 4096
const PAN_IDP_SECTION = 8192
...
const NER_IDP_STRESS = 0
const NER_IDP_NEFF_Y = 1
const NER_IDP_NEFF_Z = 2
const NER_IDP_NEFF_N = 4
const NER_IDP_NOINVERT = 8
const NER_IDP_NEFF_R = 16
const NER_IDP_NEFF_R_USE = 32
const NER_IDP_GENERATED = 64
const NER_IDP_YMIN = 2048
const NER_IDP_ZMIN = 4096
const NER_IDP_YMAX = 8192
const NER_IDP_ZMAX = 16384
...
const MAX_SECT_NEP_YZ = 511
      ...
      Structure CSECT_NCP          ' 9/NR:312  Partial non effective polygons for partial cut polygon
       Dim m_ID as Integer         '        Identification 191
       Dim m_MNO as Integer        '        Materialnumber
       Dim m_IDP as Integer        '        Noneffective for (see :190)
       Dim m_TNR as Integer        '        Ident from 190 / Cut identifier for :312 elements
...
const PRF_IR_BITS = 10
const PRF_IR_NEFF_Y = 1
const PRF_IR_NEFF_Z = 2
const PRF_IR_NEFF_N = 4
const PRF_IR_NEFF_R = 16
const PRF_IR_OUTSIDE = 128
const PRF_FT_NONE = 0
const PRF_FT_AKTI = 1
const PRF_FT_ADDI = -1
      ...
      Structure CSECT_PCP          ' 9/NR:320  SectionPointReinforcement for partial cut polygon
       Dim m_ID as Integer         '        Identification 200
       Dim m_MNO as Integer        '        Material number
       Dim m_IR as Integer         '        Layer number
       Dim m_TNR as Integer        '        Designation
...
const LRP_IR_MEAS = 10
const LRP_IR_MEAS_LENGTH = 0
const LRP_IR_MEAS_TOTAL = 1
const LRP_IR_MEAS_ELEMENT = 2
const LRP_IR_DIST = 100
const LRP_IR_DIST_INS = 0
const LRP_IR_DIST_ADJA = 1
const LRP_IR_DIST_ADJE = 2
const LRP_IR_DIST_FULL = 3
const LRP_IR_DIST_EVEN = 4
const LRP_IR_DIST_INSC = 5
const LRP_IR_NUMP = 1000
      ...
      Structure CSECT_LCP          ' 9/NR:321  SectionLineReinforcement for partial cut polygon
       Dim m_ID as Integer         '        Identification 201/211/221 or 321
       Dim m_MNO as Integer        '        Material number
       Dim m_IR as Integer         '        Layer number
       Dim m_TNR as Integer        '        Designation
...
const CPT_MNO_MATERIAL = 1000
const CPT_BIT_PRINTABLE = 1
const CPT_BIT_EQUIVALENT_HOLLOW = 2
const CPT_BIT_SPLIT_INDEX = 4
const CPT_BIT_NO_Y_STRESS = 8
const CPT_BIT_TORSION_UNFAVOURABLE = 16
const CPT_BIT_SHEAR_UNFAVOURABLE = 32
const CPT_BIT_ABSOLUT = 64
const CPT_BIT_CUT_INDEX = 128
...
const CUT_MNO_MATERIAL = 1000
const CUT_IDP_EXPLICIT = 1
const CUT_IDP_SPLIT = 2
const CUT_IDP_NO_Y_STRESS = 8
const CUT_IDP_TORSION_UNFAVOURABLE = 16
const CUT_IDP_SHEAR_UNFAVOURABLE = 32
const CUT_IDP_ABSOLUT = 64
const CUT_IDP_FLANGE = 128
const CUT_IDP_REDUCED = 256
const CUT_IDP_CRACK_DESIGN = 512
const CUT_IDP_WORKING_JOINT = 1024
const CUT_IDP_EXPLICIT_VYFK = 2048
const CUT_IDP_EXPLICIT_VZFK = 4096
const CUT_IDP_EXPLICIT_WTM = 8192
const CUT_IDP_EXPLICIT_WTD = 16384
const CUT_IDP_Y_CENTER_OF_GRAVITY = 32768
const CUT_IDP_Z_CENTER_OF_GRAVITY = 65536
const CUT_IDP_NO_LIMIT = 131072
const CUT_IDP_WIDTH_OF_DIN = 262144
const CUT_IDP_WIDTH_OF_EC = 524288
const CUT_IDP_WIDTH_OF_SIA = 786432
const CUT_IDP_WIDTH_OF_LEON = 1048576
const CUT_IDP_WIDTH_EXPLICIT = 1835008
const CUT_IDP_DIN_1045_ASB = 2097152
const CUT_IDP_REFRESH_MINIMUM = 4194304
      Structure CSECT_CUT          ' 9/NR:301  ShearCut (CUT)
       ...
       Dim m_FAKVY as Single       '        assumed total separated part for Vy
       Dim m_FAKVZ as Single       '        assumed total separated part for Vz
      END Structure

const MAX_SECT_CPL_YZ = 511
...
const SYST_IACHS_UNDEFINED = 0
const SYST_IACHS_NEGATIVE_X = -1
const SYST_IACHS_NEGATIVE_Y = -2
const SYST_IACHS_NEGATIVE_Z = -3
const SYST_IACHS_POSITIVE_X = +1
const SYST_IACHS_POSITIVE_Y = +2
const SYST_IACHS_POSITIVE_Z = +3
      ...
      Structure CSYST_DES          ' 10/1:0  SystemDesignCode
       ...
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=8)> Dim m_TXT() as Integer '        specific Text of Design code (32 characters)
      ...
      Structure CGRP               ' 11/00  Primary group data
       ...
       Dim m_IBB as Integer        '        construction stage no. BIRTH (0 = instant activation)
       Dim m_IBD as Integer        '        construction stage no. DEATH (0 = infinite lifetime)
       Dim m_IBG as Integer        '        reserved
       Dim m_V1 as Single          '        reserved (formerly: total volume [1008])
       Dim m_V2 as Single          '        reserved (formerly: total mass [1180])
       Dim m_V3 as Single          '        reserved (formerly: total reinforcement weight [1030])
       Dim m_V4 as Single          '        reserved
       Dim m_V5 as Single          '        reserved
       Dim m_V6 as Single          '        reserved
       Dim m_V7 as Single          '        reserved
       Dim m_V8 as Single          '        reserved
       Dim m_V9 as Single          '        reserved
       Dim m_V10 as Single         '        reserved
       Dim m_V11 as Single         '        reserved
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=17)> Dim m_TEXT() as Integer '        Designation of Group
      END Structure

      Structure CGRP_LC            ' 11/LC  Load case specific group data (primary & secondary groups)
       Dim m_NG as Integer         '        group-number
       Dim m_TYP as Integer        '        element code
       Dim m_NUM as Integer        '        number of elements of this type
       Dim m_MIN as Integer        '        minimum element-number of group
       ...
       Dim m_V2 as Single          '        unused (formerly FAKA: reducing factor of axial bedding for pil
       Dim m_V3 as Single          '        unused (formerly FAKT: reducing factor of transverse bedding
       Dim m_V4 as Single          '        unused
       Dim m_V5 as Single          '        unused
       Dim m_V6 as Single          '        unused
       Dim m_ETOT as Single        ' [1094] total energy
       Dim m_ECOM as Single        ' [1094] compression energy  (unused)
       Dim m_EDEV as Single        ' [1094] shear energy        (unused)
       Dim m_EKIN as Single        ' [1094] kinetic energy      (unused)
       Dim m_EPOT as Single        ' [1094] potential energy    (unused)
       Dim m_EDAM as Single        ' [1094] damping energy      (unused)
       Dim m_H_GW as Single        ' [1001] Groundwater level
       Dim m_V14 as Single         '        reserved
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=17)> Dim m_TEXT() as Integer '        Designation of Group
      END Structure

const LC_CTRL_KIND_LINEAR = 0
const LC_CTRL_KIND_NONLINEAR = 1
const LC_CTRL_KIND_SUPERPOS = 2
const LC_CTRL_KIND_INFLUENCE = 3
const LC_CTRL_KIND_EIGENMODE = 4
const LC_CTRL_KIND_BUCKMODE = 5
const LC_CTRL_KIND_DESIGN = 6
const LC_CTRL_KIND_TRAINLOAD = 7
const LC_CTRL_KIND_TRANSIENT = 8
const LC_CTRL_ITYP_X = 1
const LC_CTRL_ITYP_G = 2
const LC_CTRL_ITYP_G1 = 3
const LC_CTRL_ITYP_G2 = 4
const LC_CTRL_ITYP_P = 5
const LC_CTRL_ITYP_C = 6
const LC_CTRL_ITYP_Q = 7
const LC_CTRL_ITYP_L = 8
const LC_CTRL_ITYP_W = 9
const LC_CTRL_ITYP_S = 10
const LC_CTRL_ITYP_R = 11
const LC_CTRL_ITYP_F = 12
const LC_CTRL_ITYP_T = 13
const LC_CTRL_ITYP_A = 14
const LC_CTRL_ITYP_B = 15
const LC_CTRL_ITYP_E = 16
const LC_CTRL_ITYP_ZX = 17
const LC_CTRL_ITYP_ZG = 18
const LC_CTRL_ITYP_Z1 = 19
const LC_CTRL_ITYP_Z2 = 20
const LC_CTRL_ITYP_ZP = 21
const LC_CTRL_ITYP_ZC = 22
const LC_CTRL_ITYP_ZQ = 23
const LC_CTRL_ITYP_ZL = 24
const LC_CTRL_ITYP_ZW = 25
const LC_CTRL_ITYP_ZS = 26
const LC_CTRL_ITYP_ZR = 27
const LC_CTRL_ITYP_ZF = 28
const LC_CTRL_ITYP_ZT = 29
const LC_CTRL_ITYP_ZA = 30
const LC_CTRL_ITYP_ZB = 31
const LC_CTRL_ITYP_ZE = 32
const LC_CTRL_ITYP_SX = 33
const LC_CTRL_ITYP_SG = 34
const LC_CTRL_ITYP_S1 = 35
const LC_CTRL_ITYP_S2 = 36
const LC_CTRL_ITYP_SP = 37
const LC_CTRL_ITYP_SC = 38
const LC_CTRL_ITYP_SQ = 39
const LC_CTRL_ITYP_SL = 40
const LC_CTRL_ITYP_SW = 41
const LC_CTRL_ITYP_SS = 42
const LC_CTRL_ITYP_SR = 43
const LC_CTRL_ITYP_SF = 44
const LC_CTRL_ITYP_ST = 45
const LC_CTRL_ITYP_SA = 46
const LC_CTRL_ITYP_SB = 47
const LC_CTRL_ITYP_SE = 48
const LC_CTRL_ITYP_GA = 49
const LC_CTRL_ITYP_Q_A = 50
const LC_CTRL_ITYP_Q_B = 51
const LC_CTRL_ITYP_Q_C = 52
const LC_CTRL_ITYP_Q_D = 53
const LC_CTRL_ITYP_Q_E = 54
const LC_CTRL_ITYP_Q_F = 55
const LC_CTRL_ITYP_Q_G = 56
const LC_CTRL_ITYP_Q_H = 57
const LC_CTRL_ITYP_S_L = 58
const LC_CTRL_ITYP_S_H = 59
const LC_CTRL_ITYP_L_A = 60
const LC_CTRL_ITYP_L_B = 61
const LC_CTRL_ITYP_L_C = 62
const LC_CTRL_ITYP_L_D = 63
const LC_CTRL_ITYP_L_E = 64
const LC_CTRL_ITYP_Q_J = 65
const LC_CTRL_ITYP_Q_K = 66
const LC_CTRL_ITYP_Q_T = 67
const LC_CTRL_ITYP_Q_Z = 68
const LC_CTRL_ITYP_IMP = 70
const LC_CTRL_ITYP_V = 71
const LC_CTRL_ITYP_K = 72
const LC_CTRL_ITYP_L_T = 73
const LC_CTRL_ITYP_L_U = 74
const LC_CTRL_ITYP_COMB_UNSPEC = 90
const LC_CTRL_ITYP_COMB_D = 91
const LC_CTRL_ITYP_COMB_A = 92
const LC_CTRL_ITYP_COMB_E = 93
const LC_CTRL_ITYP_COMB_P = 94
const LC_CTRL_ITYP_COMB_R = 95
const LC_CTRL_ITYP_COMB_F = 96
const LC_CTRL_ITYP_COMB_N = 97
const LC_CTRL_ITYP_COMB_H = 98
const LC_CTRL_ITYP_COMB_HZ = 99
const LC_CTRL_ITYP_COMB_PT = 100
const LC_CTRL_ITYP_COMB_LT = 101
const LC_CTRL_ITYP_COMB_MT = 102
const LC_CTRL_ITYP_COMB_ST = 103
const LC_CTRL_ITYP_COMB_VT = 104
const LC_CTRL_ITYP_COMB_EX = 105
const LC_CTRL_ITYP_COMB_AF = 106
      Structure CLC_CTRL           ' 12/LC:?  Informations on loadcase LC
       ...
       Dim m_RX as Single          ' [1151] sum of support reactions PX
       Dim m_RY as Single          ' [1151] sum of support reactions PY
       Dim m_RZ as Single          ' [1151] sum of support reactions PZ
      ...
      Structure CLC_LPO1           ' 12/LC:91  Individual position of Point load
       ...
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=4)> Dim m_PVAL() as Single '        Load values in PV,PVM,PY,PX
      END Structure
      ...
      Structure CLC_LPOX           ' 12/LC:99  Spandefinitions from ELLA
       ...
       Dim m_XA as Single          ' [1001] Limits of a span start
       Dim m_XE as Single          ' [1001] Limits of a span end
       Dim m_V as Single           ' [1203] velocity of load train
       Dim m_PHI as Single         '        impact factor
       Dim m_YEX as Single         ' [1001] mean value of eccentricity of primary loadtrain
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_PZERO() as Single ' [1001] Position of zero influence values at start and end
       Dim m_PSIGN as Single       '        estimate if unfavourable is on left(-) or right(+) of zero line
      END Structure
      ...
      Structure CLC_POIN           ' 12/LC:10?  Free point loads
       ...
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_TREF() as Integer '        Reference text for eccentricities in sections (12 characters)
       Dim m_TYP as Integer        '        type of load
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_TXT() as Integer '        Identifiying User Text (12 characters)
      ...
      Structure CLC_AREA           ' 12/LC:12?  Free area loads
       Dim m_KREF as Integer       '        Reference type
       Dim m_NREF as Integer       '        Reference number
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_TREF() as Integer '        Reference text (not used) (12 characters)
       Dim m_TYP as Integer        '        type of load
      ...
      Structure CLC_TRAI           ' 12/LC:300  Train loading
       ...
       Dim m_YEX as Single         ' [1001] Range of eccentricity of loading in lane
      ...
      Structure CLC_TRAL           ' 12/LC:301  Individual loads of Train loading
       ...
       Dim m_YMIN as Single        ' [1001] eccentricity in y direction
       Dim m_YMAX as Single        ' [1001] deprecated: max eccentricity in y direction
       ...
       Dim m_PV as Single          '        Mass value for centrifugal force
       Dim m_ZPV as Single         ' [1001] Height for centrifugal force resultant
       ...
       Dim m_WIDTH as Single       ' [1001] obsoleted: Width of train
       Dim m_DWHEEL as Single      ' [1001] Distance of wheels
      ...
      Structure CLC_WHIS0          ' 12/LC:430  wind history control values
       Dim m_ID as Integer         '        identifier 430
       Dim m_LCW as Integer        '        loadcase of basic wind
       Dim m_IPRO as Single        '        number of generated inflow data points
       Dim m_WXMI as Single        ' [1001] size of structure in wind coordinates
       Dim m_WXMA as Single        ' [1001] 
       Dim m_WYMI as Single        ' [1001] 
       Dim m_WYMA as Single        ' [1001] 
      ...
      Structure CLC_STAT           ' 13/LC:8  Statistics and extended data for time series
       Dim m_ID as Integer         '        identifier 8
       Dim m_MEAN as Single        '        mean value
       Dim m_MAX as Single         '        maximum peak value
       Dim m_MIN as Single         '        minimum peak value
       Dim m_SDEV as Single        '        standard deviation
       Dim m_S4 as Single          '        not used
       Dim m_S5 as Single          '        not used
       Dim m_TDEV as Single        '        target standard deviation (see 80/LC:-206)
       Dim m_SCFX as Single        '        Scaling factor for wind spectran (see 80/LC:-207)
      END Structure

      Structure CLC_DAMP           ' 13/LC:9  Damping values
       Dim m_ID as Integer         '        identifier 9
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=7)> Dim m_D() as Single '        modal damping values for REVA response spectra
      END Structure
      ...
      Structure CLC_FTVAL          ' 13/LC:8?  Visualisation functions and spectra
       Dim m_ID as Integer         '        identifier
       Dim m_TT as Single          '        Time/frequency/modenumber
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=7)> Dim m_F() as Single '        function values
      END Structure
      ...
      Structure CACT_TASK          ' 14/0  Current superposition task commands
       ...
       Dim m_KWERG as Integer      '        Identifier of result record in CDB
      ...
      Structure CLC_ACT0           ' 14/NR:Z-  Group of Actions for SUPP-task
      ...
      Structure CLC_CACT1          ' 12/LC:81  current action member
       Dim m_ID as Integer         '        ident = 1 / 81
       Dim m_ACTION as Integer     '        ID of the action = type of action
       Dim m_TYPE as Integer       '        256*subgroup + 16*Group_of_action + superposition
       Dim m_GAMU as Single        '        safety factor unfavourable
      ...
      Structure CLC_CACT2          ' 12/LC:82  current loadcase of action
       Dim m_ID as Integer         '        ident = 2 / 82
       Dim m_LF as Integer         '        load case number
       Dim m_TYPE as Integer       '        load case action type
       Dim m_FACT as Single        '        factor
      ...
      Structure CCSM_GRP           ' 15/-1  Construction Stage Group Definitions
       ...
       Dim m_ATIL as Integer       '        CS number of last action - after this CS group is taken away
       Dim m_GFIX as Integer       '        Hinges fixed at this construction stage
       Dim m_BEDD as Integer       '        QUAD bedding activated at this construction stage
       Dim m_SITU as Integer       '        In situ concrete load activation
       Dim m_ICSD as Integer       '        CS number activation of dead load
       Dim m_ASTI as Integer       '        Up to this CS, the stiffness is active, afterwards FACS 1E-10
       Dim m_LINE as Integer       '        Bit 1 : LIN : group is linear in a nonlinear analyis
       ...
       Dim m_FAC1 as Single        '        Stiffness factor for first group activation
       Dim m_PHIF as Single        '        Factor for creep of springs
       Dim m_QUEA as Single        '        Input control see program ASE record GRP2
       Dim m_QEMX as Single        '        Input control see program ASE record GRP2
       Dim m_TS as Single          ' [  93] Starting of shrinkage
       Dim m_FACD as Single        '        factor of dead load
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_FRER() as Single '        free for later use
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=17)> Dim m_TITLE() as Integer '        designation
      END Structure
      ...
      Structure CCSM_LC            ' 15/-2  Construction Stage Loadcase Definitions
       ...
       Dim m_END as Integer        '        CS number of last action. 0: loadcase acts til infinite
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_EQIT() as Integer '        internal use CSM equation solver
       Dim m_FACT as Single        '        Loadcase factor
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=5)> Dim m_REQU() as Single '        internal use CSM equation solver, default 0.
      END Structure
      ...
      Structure CCSM_CS            ' 15/-3  Construction Stage Table
       ...
       Dim m_NCRE as Integer       '        number of creep+shrink step to be produced
       Dim m_ICS1 as Integer       '        Prestress stage for partial prestress
       Dim m_BEAM as Integer       '        internal use CSM which beams/piles are active, default 0
       Dim m_GPCS as Integer       '        internal use CSM on GPCS, default 0
      ...
      Structure CCSM_CREE          ' 15/-4  creep+shrink values for manual input
       ...
       Dim m_DEFQ as Single        '        Effective member thickness or factor for QUAD+BRIC
       Dim m_T0 as Single          ' [  93] Separate creep value e.g. for an in-situ added concrete
       Dim m_TS as Single          ' [  93] Separate shrinkage value e.g. for an in-situ added concrete
      END Structure
...
const ANI_SELE_IGRP_DLN = 4
      ...
      Structure CNODE_EDG          ' 20/001  node edge lists
       Dim m_NR as Integer
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=9999)> Dim m_ID() as Integer '        node numbers along the edge ID(0:NEDGE)
      END Structure
      ...
      Structure CNODE_ACC          ' 23/LC:*  Base acceleration
       ...
       Dim m_AXX as Single         ' [1207] rotational tangential acceleration X-X
       Dim m_AYY as Single         ' [1207] rotational tangential acceleration Y-Y
       Dim m_AZZ as Single         ' [1207] rotational tangential acceleration Z-Z
       ...
       Dim m_EXREF as Single       '        if a value is present (length criteria)
      END Structure

      Structure CNODE_ACI          ' 23/LC:*  Base acceleration info
       Dim m_NR as Integer         '        node number / influence load case
       Dim m_TYP as Integer        '        type of load (=10)
       Dim m_AX as Single          ' [1202] transversal acceleration X
       Dim m_AY as Single          ' [1202] transversal acceleration Y
      ...
      Structure CNODE_ROT          ' 23/LC:+  Rotation of Body
       ...
       Dim m_TYP as Integer        '        type of load
       Dim m_AXX as Single         ' [1207] rotational radial acceleration X-X  (= vxx**2)
       Dim m_AYY as Single         ' [1207] rotational radial acceleration Y-Y  (= vyy**2)
       Dim m_AZZ as Single         ' [1207] rotational radial acceleration Z-Z  (= vzz**2)
       Dim m_EX as Single          ' [1001] reference point for rotation
       Dim m_EY as Single          ' [1001] reference point for rotation
       Dim m_EZ as Single          ' [1001] reference point for rotation
      END Structure

      Structure CNODE_ROI          ' 23/LC:+  Rotation of Body information
       Dim m_NR as Integer         '        influence reference
       Dim m_TYP as Integer        '        type of load
       Dim m_AXX as Single         ' [1207] rotational radial acceleration X-X  (= vxx**2)
       Dim m_AYY as Single         ' [1207] rotational radial acceleration Y-Y  (= vyy**2)
      ...
      Structure CN_FLOWT           ' 28/LC:0  Flow values in nodes Time Value
       Dim m_ID as Integer         '        identifier 0
       Dim m_IDS as Integer        '        number of defined nodes
       Dim m_TIME as Single        ' [  90] Time step
       Dim m_DTIME as Single       ' [  90] Time step increment
      END Structure

      Structure CN_FLOW            ' 28/LC:+  Flow values in nodes
       Dim m_NR as Integer         '        Node or Elementnumber
       Dim m_TYPE as Integer       '        Type of Data
       Dim m_H as Single           ' [1006] Elevation of data point
       Dim m_UX as Single          ' [1212] Fluid velocity u in global X-Direction
       Dim m_UY as Single          ' [1212] Fluid velocity v in global Y-Direction
       Dim m_UZ as Single          ' [1212] Fluid velocity w in global Z-Direction
      END Structure
...
const SLN_BEAM_SECTION = 7
      ...
      Structure CSLN_SUPP          ' 39/NR:102  Support of Structural lines
       Dim m_ID as Integer         '        identifier 102
       Dim m_IDS as Integer        '        referenced structural element type / macro generation command
       ...
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=16)> Dim m_GUID() as Integer '        Optional GUID of the support element, if different to
      END Structure
      ...
      Structure CSAR               ' 39/NR:200  Structural area
       ...
       Dim m_IATR as Integer       '        Bitpattern for attribute areas (see SBOX_PROP)
      ...
      Structure CSAR_SUPP          ' 39/NR:221  Support and coupling of structural areas
       ...
       Dim m_CA as Single          ' [1096] axial     bedding
       Dim m_CQ as Single          ' [1096] lateral   bedding
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=16)> Dim m_GUID() as Integer '        Optional GUID of the supporting element, if different to
      END Structure
      ...
      Structure CSGR2_DEF          ' 39/NR:910  Secondary Group Definition
       Dim m_ID as Integer         '        Identifier = 910
       Dim m_IDG as Integer        '        Identifier of secondary group
       Dim m_R0 as Integer         '        reserved
       Dim m_R1 as Integer         '        reserved
       Dim m_IBB as Integer        '        Construction stage no. BIRTH (0 = instant activation)
       Dim m_IBD as Integer        '        Construction stage no. DEATH (0 = infinite lifetime)
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=17)> Dim m_TEXT() as Integer '        Designation of secondary group
      END Structure

      Structure CSGR2_SID          ' 39/NR:911  Secondary Group by ID
       Dim m_ID as Integer         '        Identifier = 911
       Dim m_TYP as Integer        '        Type of referenced member
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=255)> Dim m_NO() as Integer '        List of structural element IDs
      END Structure

      Structure CSGR2_UID          ' 39/NR:912  Secondary Group by GUID
       Dim m_ID as Integer         '        Identifier = 912
       Dim m_R0 as Integer         '        reserved
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=36)> Dim m_GUID() as Integer '        Unique identifier of the structural element
      END Structure

      Structure CSGR2_BOX          ' 39/NR:913  Secondary Group by Bounding-Box
       Dim m_ID as Integer         '        Identifier = 913
       Dim m_R0 as Integer         '        reserved
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_XMIN() as Single ' [1001] Min coordinates of Box
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_XMAX() as Single ' [1001] Max coordinates of Box
      END Structure
      ...
      Structure CSMB_GUID          ' 39/NR:999  Unique identifier of structural member
       Dim m_ID as Integer         '        identifier 999
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=36)> Dim m_IDBIM() as Integer '        Unique identifier of the structural element
      END Structure
...
const GPT_IBC_REF = 32768
      ...
      Structure CSPT_COH           ' 39/NR:1  Dimension of column head
       Dim m_ID as Integer         '        identifier 1/2/3
       Dim m_NS as Integer         '        Number of a cross section 9/NR for details
       Dim m_X as Single           ' [1001] Width in local x
       Dim m_Y as Single           ' [1001] Width in local y
      ...
      Structure CSPT_HAU           ' 39/NR:2  Dimension of voute
       Dim m_ID as Integer         '        identifier 1/2/3
       Dim m_NS as Integer         '        Number of a cross section 9/NR for details
       Dim m_X as Single           ' [1001] Width in local x
       Dim m_Y as Single           ' [1001] Width in local y
      ...
      Structure CSPT_PUN           ' 39/NR:3  Dimension of punching perimeter
       Dim m_ID as Integer         '        identifier 1/2/3
       Dim m_NS as Integer         '        Number of a cross section 9/NR for details
       Dim m_X as Single           ' [1001] Width in local x
       Dim m_Y as Single           ' [1001] Width in local y
      ...
      Structure CSPT_COL           ' 39/NR:4  Connecting columns
       Dim m_ID as Integer         '        identifier 4
       Dim m_NS as Integer         '        Number of a cross section 9/NR for column
       Dim m_X as Single           ' [1001] Width in local x
       Dim m_Y as Single           ' [1001] Width in local y
      ...
      Structure CSPT_FOO           ' 39/NR:5  Footing instance definition
       Dim m_ID as Integer         '        identifier 5
       Dim m_POS as Integer        '        referenced building position
       Dim m_TYPE as Integer       '        Type of foundation
       Dim m_IGP as Integer        '        Bitpattern Foundation Properties
      ...
      Structure CSPT_HPI           ' 39/NR:6  Halfspace pile
       Dim m_ID as Integer         '        identifier 6
       Dim m_NQ as Integer         '        number cross section   =0 if diameter from 030/NR:0
       Dim m_L as Single           ' [1001] pile length in GDIR direction
       Dim m_MANT as Single        '        percentage of skin friction for linear analysis
      ...
      Structure CSPT_CON_M         '        connected members
       Dim m_NELT as Integer
       Dim m_NREL as Integer
       Dim m_NODE as Integer
       Dim m_NARB as Integer
      ...
      Structure CSPT_CON           ' 39/NR:8  Steelconnection reference
       Dim m_ID as Integer         '        identifier 8
       Dim m_CONID as Integer      '        connection identifier
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=15)> Dim m_M() as CSPT_CON_M '        connected members
      END Structure
      ...
      Structure CGPT_SPR           ' 30/NR:10  Elastic Spring support
       ...
       Dim m_IDR as Integer        '        predefined result set identifier
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_T() as Single '        explicit direction (dx,dy,dz)
       Dim m_AREF as Single        '        reference / influence area (see also {link}184{-link}170/0{/lin
      ...
      Structure CSPT_SPR           ' 39/NR:10  Elastic Spring support
       Dim m_ID as Integer         '        identifier 10
       Dim m_IRI as Integer        '        direction
       Dim m_NR as Integer         '        element number
       Dim m_NG as Integer         '        group number
      ...
      Structure CSPT_KIN           ' 39/NR:11  Kinematic Constraint
       Dim m_ID as Integer         '        identifier 11
       Dim m_KTL as Integer        '        type +  10000*group-number
       Dim m_KR1 as Integer        '        reference GPT 1
       Dim m_KR2 as Integer        '        reference GPT 2
      ...
      Structure CSPT_SPC           ' 39/NR:12  Elastic Spring connection (obsoleted)
       Dim m_ID as Integer         '        identifier 12
       Dim m_IRI as Integer        '        direction + 100*sign(group number,direction)
       Dim m_IPC as Integer        '        connecting Spoint
       Dim m_NWL as Integer        '        work law number
      ...
      Structure CGPT_SRES          ' 30/NR:13  Predefined result set
       Dim m_ID as Integer         '        identifier 13
       Dim m_TYP as Integer        '        predifined type of result set
       Dim m_IDR as Integer        '        number / identifier of result set
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=17)> Dim m_TXTR() as Integer '        designation of result set
      END Structure

      Structure CSPT_SRES          ' 39/NR:13  Predefined result set
       Dim m_ID as Integer         '        identifier 13
       Dim m_TYP as Integer        '        predifined type of result set
       Dim m_IDR as Integer        '        number / identifier of result set
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=17)> Dim m_TXTR() as Integer '        designation of result set
...
const GAR_IBC_REF = 32768
      ...
      Structure CGAR_BOUN          ' 32/NR:1  Outer Boundary of Area
       ...
       Dim m_T as Single           ' [1010] Plate thickness along the edge
       Dim m_DFIX as Single        ' [1001] Distance (offset) of region to edge
       Dim m_CA as Single          ' [1096] axial     bedding
       Dim m_CQ as Single          ' [1096] lateral   bedding
       Dim m_CM as Single          ' [1099] torsional bedding
       Dim m_VAXI as Integer       '        ID of axis where a variable along the edge          :V202203
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=4)> Dim m_VT() as Integer '        Name of a variable on VAXI describing a variable    :V202203
      END Structure
      ...
      Structure CSAR_BOUN          ' 39/NR:201  Outer Boundary of Area
       Dim m_ID as Integer         '        identification
       Dim m_NG as Integer         '        edgeno     (31/NG)
       Dim m_NA as Integer         '        startpoint (30/NA)
       Dim m_NB as Integer         '        endpoint   (30/NB)
      ...
      Structure CSAR_HOLE          ' 39/NR:202  Inner Boundary of Area
       Dim m_ID as Integer         '        identification
       Dim m_NG as Integer         '        edgeno     (31/NG)
       Dim m_NA as Integer         '        startpoint (30/NA)
       Dim m_NB as Integer         '        endpoint   (30/NB)
      ...
      Structure CSAR_CON3          ' 39/NR:203  Prescribed Edges/Points
       Dim m_ID as Integer         '        identification
       Dim m_NG as Integer         '        edgenumber (31/NG)
       Dim m_NA as Integer         '        startpoint (30/NA)
       Dim m_NB as Integer         '        endpoint   (30/NB)
      ...
      Structure CSAR_CON4          ' 39/NR:204  Prescribed Edges/Points
       Dim m_ID as Integer         '        identification
       Dim m_NG as Integer         '        edgenumber (31/NG)
       Dim m_NA as Integer         '        startpoint (30/NA)
       Dim m_NB as Integer         '        endpoint   (30/NB)
      ...
      Structure CGAR_ELNR          ' 32/NR:121  Generated elements from area
       Dim m_ID as Integer         '        identifier = 121
      ...
      Structure CSVO_SURF          ' 39/NR:30?  Involved Surfaces
       Dim m_ITP as Integer        '        identification of definition
       Dim m_NG as Integer         '        surface    (32/NG)
       Dim m_NR as Integer         '        extrusion or rotation geometry identifier
       Dim m_NREF as Integer       '        optional number of a reference point
      ...
      Structure CDSLN_DEF          ' 35/ID:0  Design Element Definition
       ...
       Dim m_NCS as Integer        '        ID of cross section
       Dim m_NCS2 as Integer       '        ID of secondary cross section for interpolation
       Dim m_NIDS as Integer       '        count of geometry identifiers
       Dim m_HDIV as Single        ' [1001] interval of sub-division sections
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=17)> Dim m_NAME() as Integer '        designation of design element
       Dim m_GRP as Integer        '        secondary group reference
       Dim m_TYPE as Integer       '        classification of design element depending on related structura
       Dim m_CTRL as Integer       '        DSLN specific general settings, Bits
      END Structure

const DGEO_DEF_DSLN = 0
const DGEO_DEF_DSLNS = 1
const DGEO_DEF_BEAM = 2
const DGEO_DEF_LINE = 3
const DGEO_DEF_GUID = 4
const DGEO_DEF_PRIM_AXIS = 5
const DGEO_DEF_SEC_AXIS = 6
const DGEO_DEF_TRUSS = 7
      Structure CDGEO_DEF          ' 35/ID:1  Design Element Geometry
       ...
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_XYZA() as Single ' [1001] for TYPE #3, starting point of a straight line
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_XYZE() as Single ' [1001] for TYPE #3, end point of a straight line
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_DZ() as Single ' [1001] direction z-axis of straight line
       Dim m_SA as Single          '        Start station of a curve along an axis
       Dim m_SE as Single          '        End station of a curve along an axis
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=9999)> Dim m_IDS() as Integer '        IDs of structural lines or beams
      END Structure

      Structure CDSLC_DEF          ' 35/ID:2  Design Sections
       Dim m_ID as Integer         '        identification of data (2)
       Dim m_TYPE as Integer       '        type of position reference on the design element axis
       Dim m_ITYP as Integer       '        type of section for design, Bits adopted from
       Dim m_POS as Single         ' [1001] position of sections
      END Structure

      Structure CDSEL_IDS          ' 35/ID:3  Selection of finite elements
       Dim m_ID as Integer         '        identification of data (3)
       Dim m_TYP as Integer        '        Type of selection in Bits
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=1024)> Dim m_IDS() as Integer '        IDs used in selection with Typ &4 or &8
      END Structure

      Structure CDSEL_BOX          ' 35/ID:4  Selection of elements with Box
       Dim m_ID as Integer         '        identification of data (4)
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_BOXY() as Single ' [1001] y-min and y-max of bounding box
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_BOXZ() as Single ' [1001] z-min and z-max of bounding box
      END Structure

      Structure CDSLN_GRP          ' 35/ID:5  Secondary groups of design element
       Dim m_ID as Integer         '        identification of data (5)
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=9999)> Dim m_GROUPS() as Integer '        groups assigned to design element
      END Structure

      Structure CDSLN_UID          ' 35/ID:999  Unique identifier of design element
       Dim m_ID as Integer         '        identifier 999
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=36)> Dim m_IDBIM() as Integer '        Unique identifier of the design element
      END Structure
      ...
      Structure CTENDAXIS          ' 40/NR:0  Reference axis
       Dim m_ID0 as Integer        '        identifier 0
      ...
      Structure CTENDAX_1          ' 40/NR:1  Reference axis stations
       Dim m_ID0 as Integer        '        identifier 1
       Dim m_IGBIT as Integer      '        station parameter
       Dim m_NRSTAB as Integer     '        internal beam number
       Dim m_EXTID as Integer      '        external beam number (Quad: 0)
      ...
      Structure CTNDAXDEF          ' 40/NR:5  Reference axis definition
       Dim m_ID0 as Integer        '        identifier 5
       Dim m_NOH as Integer        '        Number of the reference axis
       Dim m_TYP as Integer        '        Type of definition: 1 Beam, 2 Node, 3 ..., 4 Auto, 5 Poly, 6 Re
       Dim m_VAL1 as Single        '        Values according to type *)
       Dim m_VAL2 as Single        '        "
       Dim m_VAL3 as Single        '        "
       Dim m_S as Single           '        Station at the begin of the reference axis
       Dim m_SETBIT as Integer     '        Bitfield indicating what was set: 1:val1 & 2:val2 & 4:val3 & 8:
       Dim m_REFID as Integer      '        In the case of Typ=Refx/Sln: Id of the reference axis
       Dim m_SREFID as Integer     '        In the case of Typ=Refx:     Id of the secondary reference axis
       Dim m_ART as Integer        '        Intersections with: 1 Beams, 2 Quads, 3 Brics (reserved), 4 ...
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=17)> Dim m_TITL() as Integer '        Title of the reference axis
      END Structure

      Structure CTENDSPLI          ' 41/NR:0  Duct curves
       Dim m_ID0 as Integer        '        identifier 0
       Dim m_NRSPUR as Integer     '        Id reference axis
       Dim m_NRSV as Integer       '        Id prestressing system
       Dim m_IGSYS as Integer      '        prestress for:
      ...
      Structure CTENDINTS          ' 41/NR:110  Duct curve intersections
       Dim m_ID0 as Integer        '        Identifier 110
       Dim m_ELMID as Integer      '        Intersected element id
       Dim m_ELMTYP as Integer     '        Type of the intersected element: 1 Beam, 2 Quad, (3 Brics - res
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_PARAM() as Single '        Entry and exit intersection parameter of the duct curve
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_NRMDST() as Single ' [1001] Entry and exit normal distance to element's boundary. Inside < 
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_INPDST() as Single ' [1001] Entry and exit inplane/ distance to element's boundary. Inside 
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_INTLOC() as Integer '        Entry and exit intersection location. With element parameters b
      END Structure

      Structure CDUCTGRPS          ' 41/NR:112  Element groups for duct intersections
       Dim m_ID0 as Integer        '        Identifier 112
       Dim m_CMD as Integer        '        2 (see remark), [legacy: 0 activated, 1 deactivated]
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=9999)> Dim m_GRPID() as Integer '        Alternating groupId and command (0:activate, 1:deactivate).
      END Structure

      Structure CTGEOGUID          ' 41/NR:999  Unique identifier of TGEO (aka tendon spline or duct curve)
       Dim m_ID0 as Integer        '        identifier 999
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=36)> Dim m_GUID() as Integer '        1152 Bit GUId Identifier of following element in the BIM/CAD sy
      END Structure
      ...
      Structure CTENDTOPP          ' 43/NR  Tendon toppoints
       ...
       Dim m_IGREF as Integer      '        reference to      geometry  Rec: 03
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=1024)> Dim m_S() as Single ' [1001] stations on toppoints (max. 1024)
      END Structure

      Structure CTENDON            ' 44/NR:0  Tendons
       Dim m_ID0 as Integer        '        identifier 0
       Dim m_NRSPUR as Integer     '        Reference axis
       Dim m_NRSPLI as Integer     '        Duct curve
       ...
       Dim m_AR as Single          '        area for crack width
       Dim m_DZ as Single          '        effective diameter
       Dim m_UZ as Single          '        perimeter for crack width
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=4)> Dim m_VALM() as Single '        reserved
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=17)> Dim m_TEXT() as Integer '        construction stage title
      END Structure
      ...
      Structure CTENDJACK          ' 44/NR:1  Tendon jacking data
       ...
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=17)> Dim m_TEXT() as Integer '        tendon title
      END Structure
      ...
      Structure CTENDDEF1          ' 44/NR:5  Tendon definition for tendon 2.0
       Dim m_ID0 as Integer        '        Identifier 5
       Dim m_TENDID as Integer     '        (Own) tendon id
       Dim m_REFTND as Integer     '        Id reference axis in tendon   record  (record: 40/reftnd)
       Dim m_REFGEO as Integer     '        Id reference axis in geometry record  (record:  3/refgeo)
       Dim m_DUCTND as Integer     '        Id duct curve     in tendon   record  (record: 41/ductnd)
       Dim m_DUCGEO as Integer     '        Id duct curve     in geometry record  (record:  3/ducgeo)
       Dim m_SYSP as Integer       '        Id prestressing system                (record:  4/sysp  )
       Dim m_MAT as Integer        '        Id material of the prestressing steel (record:  1/mat   )
       Dim m_NTEN as Integer       '        Number of individual tendons (Attention: NOT wires inside a ten
       Dim m_TNDTYP as Integer     '        Type of reference: 1 node, 2 beam, 3 field, 4 reference axis
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_FROMTO() as Single '        Starting/ending station (parameters on the reference axis)  FRO
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_SFROTO() as Single ' [1001] Distances to starting/ending station.                       SFR
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_EFROTO() as Single ' [1001] Distances for effective prestressing.                       EFR
       Dim m_FROSET as Integer     '        Bit field to check, if FROM and/or TO was set: 1 FROM, 2 TO (on
       Dim m_LC as Integer         '        Load case id for loads from prestressing                    (re
       Dim m_LC0 as Integer        '        Load case id for unconstraint cutting forces (only beams)   (re
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=17)> Dim m_TNDTIT() as Integer '        Tendon title
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_CS() as Integer '        Construction stages (installation/grouting/removal)
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=17)> Dim m_CSTITL() as Integer '        Construction stages title
       Dim m_LOADME as Integer     '        Loading method:             1 pfac, 2 pdef, 3 psig, 4 paas (use
       Dim m_SIDE as Integer       '        Prestressing side:          1 LE, 2 RI, 3 LERI, 4 RILE
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_JACPRC() as Integer '        Jacking procedure bit:      1 stress, 2 release, 4 restress, 8 
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=8)> Dim m_PDEF() as Single '        Preset forces for pdef:     STL, REL, RSL, SLL, STR, RER, RSR, 
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=10)> Dim m_PFAC() as Single '        Limit factors for pfac:     [0-4] left, [5-9] right: FAC, FACA,
       Dim m_KAPPA as Single       '        Friction safety factor to prevent overstress
       Dim m_KAPLEN as Integer     '        Length for kappa reduction: 1 symmetric, 2 optimized
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=10)> Dim m_KVALS() as Single '        K-values of Psig:           K1-K10
       Dim m_PDTSET as Integer     '        PDAT input was given: 0 no, 1 yes
       Dim m_FTRLEN as Single      '        Force transition length
       Dim m_FTRTYP as Integer     '        Force transition type:     1 Line, 2 Para, 3 Llin, 4 Rlin, 5 LP
       Dim m_CONMAT as Integer     '        Id material of reductional area
       Dim m_AR as Single          ' [1012] Reference area for crack width       [m2]
       Dim m_UZ as Single          ' [1026] Perimeter for crack width            [mm]
       Dim m_DZ as Single          ' [1026] Effective diameter                   [mm]
       Dim m_NUMWIR as Integer     '        (Number of wires           - not yet active!)
       Dim m_REDWIR as Integer     '        (Reduced number of wires   - not yet active!)
       Dim m_PARTPR as Single      '        (Partial prestressing in % - not yet active!)
       Dim m_FRCSET as Integer     '        FRIC input was given: 0 no, 1 yes
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_FRCBET() as Single ' [1009] Additional friction wobble factors at start and end   in [1/m]
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_FRCLIM() as Single '        Additional friction limits: start and end station (parameters o
       Dim m_FRCTYP as Integer     '        How is additional friction added: 1 add, 2 vect
      END Structure

      Structure CTENDRES1          ' 44/NR:7  Tendon result 1
       Dim m_ID0 as Integer        '        identifier 7
       Dim m_TNDGEO as Integer     '        Id eccentric/tendon curve geometry            (record:  3/tndge
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=8)> Dim m_CRVLIM() as Single '        Curve limits of the eccentric tendon curve    (Teddy-Tend: SFRO
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=10)> Dim m_PREORD() as Integer '        Order of the prestressing                     (1)
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=10)> Dim m_JCKFAC() as Single '        Acting forces factors at the jack             (1)
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=10)> Dim m_ELOLEN() as Single ' [1032] Elongation lengths (equivalent to forces)     (1),(3) [mm]
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=10)> Dim m_DFLLOG() as Integer '        If a deflection point was found 1, else 0.    (1)
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=10)> Dim m_DFLPAR() as Single '        Parameters at the deflection points           (1)
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=10)> Dim m_DFLFAC() as Single '        Force factors at the deflection points        (1)
       Dim m_APLKAP as Single      '        Applied friction safety factor for overstress (2)
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=10)> Dim m_APLFAC() as Single '        Applied prestressing limit factors            (2)
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=10)> Dim m_UNRFAC() as Single '        Unreduced prestressing limit factors          (2)
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_KAPRED() as Single '        Reduction factors for the left and right jacking forces, if kap
      END Structure

      Structure CTENDRES2          ' 44/NR:8  Tendon result 2
       Dim m_ID0 as Integer        '        identifier 8
       Dim m_PARAM as Single       '        Parameter on the eccentric/tendon curve
       Dim m_ACTFAC as Single      '        Active factors for prestressing
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=10)> Dim m_FACTS() as Single '        Force factors during prestressing]: [0-4] left, [5-9] right: St
      END Structure

      Structure CTENDGUID          ' 44/NR:999  Unique identifier of the tendon
       Dim m_ID0 as Integer        '        identifier 999
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=36)> Dim m_GUID() as Integer '        1152 Bit GUId Identifier of following element in the BIM/CAD sy
      END Structure

      Structure CHIST_HED          ' 80/LC:-1??  TimeHistoryTitle
      ...
      Structure CHIST_EXT          ' 80/LC:-2??  TimeHistoryExtended
       Dim m_RID as Single         '        Extended Parameters for time histories
       Dim m_VAL as Single         ' [  32] values for the preceding identifications
      END Structure
      ...
      Structure CSLVL_DAT          ' 87/0:+  Structural Storey Level Data
       ...
       Dim m_RMASSZ as Single      ' [1182] Rotational mass moment of inertia about Z
       Dim m_VAL17 as Single       '        unused
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=17)> Dim m_TEXT() as Integer '        Designation of level
       Dim m_POID as Integer       '        POI for drift computation (0=COM, 1=COR, 2=USER)
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_XYPOID() as Single ' [1001] Coordinates of user-defined POI for drift-calculation
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_AS_RC() as Single ' [1012] Shear area of reinforced concrete supporting members [X,Y]-dire
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_AS_ST() as Single ' [1012] Shear area of steel               supporting members [X,Y]-dire
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_AS_BR() as Single ' [1012] reserved
      END Structure
      ...
      Structure CSLVL_RES          ' 87/LC:+  Structural Storey Level Results
       ...
       Dim m_DXMAX as Single       ' [1003] maximum inter-storey drift in X
       Dim m_DYMAX as Single       ' [1003] maximum inter-storey drift in Y
      ...
      Structure CDSLN              ' 120/00:+  Design elements
       Dim m_NR as Integer         '        beam number
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_NODE() as Integer '        node number start/end
       Dim m_NP as Integer         '        prop number
       Dim m_DL as Single          ' [1001] beamlength
...
const BEAM_SCT_IHINGE_MLP = 65536
      ...
      Structure CDSLN_SCT          ' 120/00:0  Design element sections
       Dim m_ID as Integer         '        identifier for sections 0
       Dim m_NQ as Integer         '        number cross section
      ...
      Structure CBEAM_TND          ' 100/05  tendons of beams
       ...
       Dim m_D as Single           ' [1023] effect. diameter for crack width
       ...
       Dim m_TEMP as Single        ' [1215] Temperature
       Dim m_REDFAK as Single      ' [1299] Reduction factor within transmission length
       Dim m_XSI as Single         ' [1299] Relative parameter [0, 1] on the reference axis (Record: 40/...
      END Structure

      Structure CDSLN_TND          ' 120/05  tendons of design elements
       Dim m_NR as Integer         '        beamnumber
       Dim m_NRS as Integer        '        tendon number
       Dim m_MNR as Integer        '        material number of tendon + 1000 * material number of cross-sec
       Dim m_IBA1 as Integer       '        construction stage number for placing
      ...
      Structure CDSLN_SL           ' 121/LC:*  single loads on design element
       Dim m_NR as Integer         '        beamnumber
       Dim m_TYP as Integer        '        type of load
       Dim m_X as Single           ' [1001] load point
       Dim m_I_2 as Single         ' [1001] reserved 0.
      ...
      Structure CBEAM_DL           ' 101/LC:*  distributed beam loading on reference
       ...
       Dim m_ORIGID as Integer     '        Identifier of the load origin (e.g., tendon id)
      END Structure
      ...
      Structure CDSLN_DL           ' 121/LC:*  distributed design element loading on reference axis
       Dim m_NR as Integer         '        beamnumber
       Dim m_TYP as Integer        '        type of load
       Dim m_X as Single           ' [1001] start point
       Dim m_L as Single           ' [1001] length of load
      ...
      Structure CDSLN_TL           ' 121/LC:*  distributed design element loading on reference axis
       Dim m_NR as Integer         '        beamnumber
       Dim m_TYP as Integer        '        type of load
       Dim m_X as Single           ' [1001] start point
       Dim m_L as Single           ' [1001] length of load
      ...
      Structure CDSLN_FTC          ' 122/LC:0  Maximum of Design element forces without plate components
       Dim m_ID as Integer         '        identifier 0
       Dim m_X as Single           ' [1001] max. beam length
       Dim m_N as Single           ' [1101] normal force
       Dim m_VY as Single          ' [1102] y-shear force
      ...
      Structure CBEAM_FOR          ' 102/LC:+  Total Beam forces and deformations
       ...
       Dim m_ALPH_X as Single      ' [1003] eas displacement local x
       Dim m_BETA_X as Single      ' [1004] eas rotation local x (torsion)
       Dim m_BETA_Y as Single      ' [1004] eas rotation local y
       Dim m_BETA_Z as Single      ' [1004] eas rotation local z
       Dim m_BETA_W as Single      ' [1005] eas twisting
       Dim m_ALPH2_X as Single     ' [1003] eas displacement local x
       Dim m_BETA2_X as Single     ' [1004] eas rotation local x (torsion)
       Dim m_BETA2_Y as Single     ' [1004] eas rotation local y
       Dim m_BETA2_Z as Single     ' [1004] eas rotation local z
       Dim m_BETA2_W as Single     ' [1005] eas twisting
      END Structure
      ...
      Structure CDSLN_FTR          ' 122/LC:+  Design element forces without plate components
       Dim m_NR as Integer         '        beamnumber
       Dim m_X as Single           ' [1001] distance from start
       Dim m_N as Single           ' [1101] normal force
       Dim m_VY as Single          ' [1102] y-shear force
      ...
      Structure CBEAM_PLX          ' 219/LC:+  T-beam TBEX - negative quad part
       Dim m_NR as Integer         '        beamnumber
       Dim m_X as Single           ' [1001] distance from start
       Dim m_N as Single           ' [1101] normal force
       Dim m_VY as Single          ' [1102] y-shear force
      ...
      Structure CDSLN_STI          ' 123/LC  Stiffness of design elements
       Dim m_NR as Integer         '        beam number
       Dim m_X as Single           ' [1001] distance from start
       Dim m_EA as Single          ' [  62] normal stiffness
       Dim m_GAY as Single         ' [  62] y-shear stiffness
      ...
      Structure CBSCT_STI          ' 143/LC  Stiffness of external sections
       Dim m_NR as Integer         '        beam number
       Dim m_X as Single           ' [1001] distance from start
       Dim m_EA as Single          ' [  62] normal stiffness
       Dim m_GAY as Single         ' [  62] y-shear stiffness
      ...
      Structure CDSLN_CRC          ' 124/LC:0  Parameter of creep interval for each material
       Dim m_ID as Integer         '        identifier 0
       Dim m_MNR as Integer        '        materialnumber
       Dim m_EXP as Integer        '        exposition class of explicit curve
       Dim m_T as Single           ' [  93] absolute age
      ...
      Structure CDSLN_CRF          ' 124/LC:+  resulting forces of redistribution
       Dim m_NR as Integer         '        beamnumber
       Dim m_ID as Integer         '        identifier 0
       Dim m_X as Single           ' [1001] distance from start
       Dim m_SDNI as Single        ' [1101] total normal force
      ...
      Structure CDSLN_TSN          ' 124/LC:+  thermal eigen stress per material
       Dim m_NR as Integer         '        element number
       Dim m_MNRX as Integer       '        10000+materialnumber
       Dim m_X as Single           ' [1001] distance from start
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=64)> Dim m_TS() as Single ' [1092] Eigenstress table (z,sig)
      ...
      Structure CBEAM_CRP          ' 104/LC:+  forces on sectional parts per material
       ...
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=10)> Dim m_ASF() as Single '        up to 10 Factors on used reinforcement layers
      END Structure

      Structure CDSLN_CRP          ' 124/LC:+  forces on sectional parts per material
       Dim m_NR as Integer         '        beamnumber
       Dim m_MNR as Integer        '        materialnumber
       Dim m_X as Single           ' [1001] distance from start
       Dim m_DNI as Single         ' [1101] impr. normal force
      ...
      Structure CBEAM_CRT          ' 104/LC:+  changes of tendon force
       Dim m_NR as Integer         '        beamnumber
      ...
      Structure CDSLN_CRT          ' 124/LC:+  changes of tendon force
       Dim m_NR as Integer         '        beamnumber
       Dim m_NRS as Integer        '        neg. tendonnumber
       Dim m_X as Single           ' [1001] distance from start
       Dim m_DZZ as Single         ' [1092] change of stress to prestress
      ...
      Structure CBSCT_CRT          ' 144/LC:+  changes of tendon force
       Dim m_NR as Integer         '        beamnumber
       Dim m_NRS as Integer        '        neg. tendonnumber
       Dim m_X as Single           ' [1001] distance from start
       Dim m_DZZ as Single         ' [1092] change of stress to prestress
      ...
      Structure CBEAM_STC          ' 105/LC:0  Maximum stresses in cross-section of beams
       ...
       Dim m_FAK_VV as Single      '        shear reduction factor = elastic/nonlinear lever
       Dim m_N_PART as Single      ' [1101] normal force in that part of the section
       Dim m_SIGCT as Single       ' [1092] decompression stress
      END Structure

      Structure CDSLN_STC          ' 125/LC:0  Maximum stresses in cross-section of design elements
       Dim m_NR as Integer         '        Ident 0
       Dim m_MNR as Integer        '        materialnumber
       Dim m_X as Single           ' [1001] distance to start
       Dim m_SIGC as Single        ' [1092] compressive stress
      ...
      Structure CBSCT_STC          ' 145/LC:0  Maximum stresses in cross-section of external sections
       Dim m_NR as Integer         '        Ident 0
       Dim m_MNR as Integer        '        materialnumber
       Dim m_X as Single           ' [1001] distance to start
       Dim m_SIGC as Single        ' [1092] compressive stress
      ...
      Structure CDSLN_TST          ' 125/LC:+  thermal eigen stress per material
       Dim m_NR as Integer         '        element number
       Dim m_MNRX as Integer       '        100000 + material number as in BSCT_STC
       Dim m_X as Single           ' [1001] distance from start
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=256)> Dim m_TS() as Single ' [1092] Eigenstress table (z,sig)
      ...
      Structure CBEAM_STT          ' 105/LC:+  stresses in tendons
       Dim m_NR as Integer         '        beamnumber
       Dim m_NRS as Integer        '        neg. tendonnumber
       Dim m_X as Single           ' [1001] distance from start
       Dim m_SIG as Single         ' [1092] stress in tendon
       Dim m_DSIG as Single        ' [1092] sway stress in tendon
      END Structure

      Structure CDSLN_STT          ' 125/LC:+  stresses in tendons
       Dim m_NR as Integer         '        beamnumber
       Dim m_NRS as Integer        '        neg. tendonnumber
       Dim m_X as Single           ' [1001] distance from start
       Dim m_SIG as Single         ' [1092] stress in tendon
      ...
      Structure CBSCT_STT          ' 145/LC:+  stresses in tendons
       Dim m_NR as Integer         '        beamnumber
       Dim m_NRS as Integer        '        neg. tendonnumber
       Dim m_X as Single           ' [1001] distance from start
       Dim m_SIG as Single         ' [1092] stress in tendon
      ...
      Structure CDSLN_STR          ' 125/LC:+  Stresses in cross-section of design elements
       Dim m_NR as Integer         '        beamnumber
       Dim m_MNR as Integer        '        materialnumber
       Dim m_X as Single           ' [1001] distance from start
       Dim m_SIGC as Single        ' [1092] compressive stress
      ...
      Structure CBSCT_STR          ' 145/LC:+  Stresses in cross-section of external sections
       Dim m_NR as Integer         '        beamnumber
       Dim m_MNR as Integer        '        materialnumber
       Dim m_X as Single           ' [1001] distance from start
       Dim m_SIGC as Single        ' [1092] compressive stress
      ...
      Structure CDSLN_RF0          ' 126/DC:0  max. values of reinforcement
       Dim m_NR as Integer         '        identifier 0
       Dim m_NVERS as Integer      '        Version number
       Dim m_ASLMAX as Single      ' [1021] maximum longitudinal reinforcement
       Dim m_ASBMAX as Single      ' [1021] maximum of transverse reinforcement reinforcement
      ...
      Structure CBEAM_RFI          ' 106/DC:+  info of reinforcement of beams
       Dim m_NR as Integer         '        beamnumber
      ...
      Structure CDSLN_RFI          ' 126/DC:+  info of reinforcement of design elements
       Dim m_NR as Integer         '        beamnumber
       Dim m_NQ as Integer         '        info id = 0
       Dim m_X as Single           ' [1001] distance from start
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=20)> Dim m_ASL() as Integer '        infos for longitudinal layers 0:9
      ...
      Structure CBSCT_RFI          ' 146/DC:+  info of reinforcement of external sections
       Dim m_NR as Integer         '        beamnumber
       Dim m_NQ as Integer         '        info id = 0
       Dim m_X as Single           ' [1001] distance from start
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=20)> Dim m_ASL() as Integer '        infos for longitudinal layers 0:9
      ...
      Structure CBEAM_RFC          ' 106/DC:+  reinforcement of beams
       Dim m_NR as Integer         '        beamnumber
       Dim m_NQ as Integer         '        section number
       Dim m_X as Single           ' [1001] distance from start
      ...
      Structure CDSLN_RFC          ' 126/DC:+  reinforcement of design elements
       Dim m_NR as Integer         '        beamnumber
       Dim m_NQ as Integer         '        section number
       Dim m_X as Single           ' [1001] distance from start
       Dim m_ASUM as Single        ' [1020] Total longitudinal reinforcement
      ...
      Structure CBSCT_RFC          ' 146/DC:+  reinforcement of external sections
       Dim m_NR as Integer         '        beamnumber
       Dim m_NQ as Integer         '        section number
       Dim m_X as Single           ' [1001] distance from start
       Dim m_ASUM as Single        ' [1020] Total longitudinal reinforcement
      ...
      Structure CDSLN_RFS          ' 126/DC:Z+  results of shear wall design
       Dim m_NR as Integer         '        beamnumber
       Dim m_ID1 as Integer        '        identifier
       Dim m_X as Single           ' [1001] distance from start
       Dim m_ASUM as Single        ' [1020] Total main vertical reinforcement
       Dim m_R2 as Single          ' [1021] Reserved
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=10)> Dim m_ASL() as Single ' [1020] Main vertical reinforcement
       Dim m_R13 as Single         ' [1001] Reserved
       Dim m_ASBMAX as Single      ' [1021] Total shear reinforcement
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=30)> Dim m_ASB() as Single ' [1021] transverse shear (A(1,i)) / confinement (A(2,i)) reinforcement
       Dim m_LBA as Single         ' [1001] width of edge zone A (+Z)
       Dim m_LBE as Single         ' [1001] width of edge zone B (+Z)
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_THK() as Single ' [1001] thickness of wall in {mid zone, edge zone A, edge zone B}
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=17)> Dim m_TEXT() as Integer '        Designation of Designcase
      END Structure
      ...
      Structure CBEAM_DE0          ' 107/LC:0  max. values of Ultimate/Plastic Design results
       ...
       Dim m_FCHK as Single        '        Bitpattern of associated design codes
       Dim m_TCF as Single         ' [1299] total utilisation level (all effects)
       Dim m_SCN as Single         ' [1299] utilisation level  (1) N/Npl
       Dim m_SCVY as Single        ' [1299] utilisation level  (2) Vy/Vypl
       Dim m_SCVZ as Single        ' [1299] utilisation level  (3) Vz/Vzpl
       Dim m_SCMT as Single        ' [1299] utilisation level  (4) Mt/Mtpl
       Dim m_SCMY as Single        ' [1299] utilisation level  (5) My/Mypl
       Dim m_SCMZ as Single        ' [1299] utilisation level  (6) Mz/Mzpl
       Dim m_SCMB as Single        ' [1299] utilisation level  (7) Mb/Mbpl
       Dim m_SCT2 as Single        ' [1299] utilisation level  (8) Mt2/Mt2pl
       Dim m_SCCOMB as Single      ' [1299] utilisation level  (9) TOTAL INTERACTION
       Dim m_SCBN as Single        ' [1299] utilisation level (10) buckling / torsional buckling
       Dim m_CSIGC as Single       ' [1299] utilisation level (11) sig-c/fy
       Dim m_CSIGT as Single       ' [1299] utilisation level (12) sig-t/fy
       Dim m_CTAU as Single        ' [1299] utilisation level (13) tau/tauy
       Dim m_CSGV as Single        ' [1299] utilisation level (14) sigv/fy (von Mises)
       Dim m_CSGR as Single        ' [1299] utilisation level (15) sig-s (tendon/reinforc.stress)
       Dim m_CAS as Single         ' [1299] utilisation level (16) As/As-provided (long.Reinforc)
       Dim m_CASL as Single        ' [1299] utilisation level (17) Asv/Asv-provided (transverse reinf)
       Dim m_CCW as Single         ' [1299] utilisation level (18) As/As-provided for crack width
       Dim m_CSGD as Single        ' [1299] utilisation level (19) sig-d (dynamic stress range)
       Dim m_CTAU0 as Single       ' [1299] utilisation level (20) tau0  (Nachweisgrenzen)
       Dim m_C2T as Single         ' [1299] utilisation level (21) plate slenderness (c/t)
       Dim m_CLASS as Single       '        highest criteria for section class
      END Structure

      Structure CDSLN_DE0          ' 127/LC:0  max. values of Ultimate/Plastic Design results
       Dim m_NR as Integer         '        identifier 0
       Dim m_X as Single           ' [1001] distance from start
       Dim m_NI as Single          ' [1101] Inner normal force
       Dim m_MYI as Single         ' [1104] bending moment My
      ...
      Structure CBEAM_DES          ' 107/LC:+  Ultimate/Plastic Design results
       ...
       Dim m_EDCMIN as Single      ' [   9] minimum decompression strain (NSTR-Analysis)
       Dim m_EDCMAX as Single      ' [   9] maximum decompression strain (NSTR-Analysis)
       Dim m_FCHK as Single        '        applied design category
       Dim m_TCF as Single         ' [1299] total utilisation level (all effects)
       Dim m_SCN as Single         ' [1299] utilisation level  (1) N/Npl
       Dim m_SCVY as Single        ' [1299] utilisation level  (2) Vy/Vypl
       Dim m_SCVZ as Single        ' [1299] utilisation level  (3) Vz/Vzpl
      ...
      Structure CDSLN_DES          ' 127/LC:+  Ultimate/Plastic Design results
       Dim m_NR as Integer         '        elementnumber
       Dim m_X as Single           ' [1001] distance from start
       Dim m_NI as Single          ' [1101] Inner normal force
       Dim m_MYI as Single         ' [1104] bending moment My
      ...
      Structure CLINK              ' 111/00:+  Link elements
       Dim m_NR as Integer         '        element number
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_NODE() as Integer '        node number start/end
       Dim m_MNO as Integer        '        optional reference to a material
       Dim m_DOFB as Integer       '        bits identifying active local DOFs
       Dim m_NREF as Integer       '        structural parent object
       Dim m_IBT6 as Integer       '        reserved
       Dim m_DL as Single          ' [1001] element length
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=9)> Dim m_T() as Single '        transformation matrix
       Dim m_AREF as Single        '        reference area
       Dim m_S as Single           '        interface location, e.g.
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=7)> Dim m_K() as Single '        local stiffness values (diagonal entries)
      END Structure
...
const SPRI_WL0_MTYP_PKIN = 4
      Structure CSPRI_WL0          ' 173/NR:0  (Nonlinear) Material for Link elements, Spring elements and Bea
       Dim m_ID as Integer         '        Identification = 0
       ...
       Dim m_IHBIT as Integer      '        Bitpattern of defined degrees of freedom (implicit hinge & PMM-
...
const SPRI_WL_NTYP_PLAS = 4
      Structure CSPRI_WL           ' 173/NR:+  Force-Displacement / Moment-Rotation Worklaw
       Dim m_ID as Integer         '        Identification
       Dim m_NTYP as Integer       '        Type of law
      ...
      Structure CHLNK              ' 179/00  link elements (hydraulic/ thermal)
...
const LEN_CQUAD0 = 27
      ...
      Structure CQUAD_TEN          ' 200/5  tendons of Quad-elements
       ...
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_XSI() as Single ' [1299] Relative entry and exit parameters [0, 1] on the reference axis
      END Structure
      ...
      Structure CQUAD_RND          ' 271/0:0  Evaluated Reinforcement Definitions of Nodes
       Dim m_ID as Integer         '        identifier (0 = Headder of a definition)
       Dim m_NRG as Integer        '        group number
       Dim m_NR as Integer         '        selector or element number
       Dim m_BITS as Integer       '        Type of grading
      ...
      Structure CQUAD_RIL          ' 200/7:+  Reinforcement Layers of Quad-elements
       ...
       Dim m_BSMAX as Single       ' [1021] Max reinforcement for nonlinear ASE
      END Structure
      ...
      Structure CQUAD_RNL          ' 271/0:+  Evaluated Reinforcement Definitions of Nodes
       Dim m_ID as Integer         '        reference for this layer
       Dim m_DIR as Integer        '        Type of local x-direction
       Dim m_ROT as Single         ' [   5] Angle with reference to the local x-direction
       Dim m_XDIR as Single        ' [1001] Global reference direction or reference point
      ...
      Structure CQUAD_INP          ' 216/LC:+  Inplane spring reaktion forces quad-element
       Dim m_NR as Integer         '        internal Quad-elementnumber
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=24)> Dim m_P24() as Single ' [1151] reaktion forces of 4 quad nodes
      END Structure
      ...
      Structure CQUAD_DST          ' 250/DC:+  design stresses in Quad-elements
       ...
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_SDOU() as Single ' [1092] stress range upside/downside \
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_RIOU() as Single ' [   3] direction of main stress range upside/downside \
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_SMIN() as Single ' [1092] minimum stress in this direction upside/downside \
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_SMAX() as Single ' [1092] maximum stress in this direction upside/downside \
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_SPERM() as Single ' [1092] permanent stress in this direction upside/downside \
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=8)> Dim m_RESERVED() as Single '        reserved for future usage
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=17)> Dim m_TEXT() as Integer '        Designation of Designcase \
      END Structure
      ...
      Structure CQUAD_NRP          ' 262/DC:+  punching reinforcement in nodes
       ...
       Dim m_ASL as Single         ' [1021] required longitudinal reinforcement
       Dim m_ASV1 as Single        ' [1020] shear reinforcement within 1st perimeter
       Dim m_ASV2 as Single        ' [1020] shear reinforcement within 2nd perimeter
       Dim m_ASV3 as Single        ' [1020] shear reinforcement within 3rd perimeter
       Dim m_ASV4 as Single        ' [1020] shear reinforcement within 4th perimeter
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=4)> Dim m_FREE0() as Single '        not yet used
       Dim m_BETA as Single        '        beta value
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=16)> Dim m_TXT1() as Integer '        Halfen Description 1 (n chars require n/2+1 words)
      ...
      Structure CQUAD_RNM          ' 271/DC:0  maximum reinforcement results in  Nodes
       Dim m_NG as Integer         '        ident 0
       Dim m_NR as Integer         '        ident 0
       Dim m_ID as Integer         '        +1 identifier for reincorcement
       Dim m_ORIG as Integer       '        origin of maximum reinforcement, see QUAD_REA for Details
      ...
      Structure CQUAD_RNA          ' 271/DC:Z+  General Concrete Design Results in Nodes
       Dim m_NG as Integer         '        group number (for nodal results)
       Dim m_NR as Integer         '        element number
       Dim m_ID as Integer         '        ident 0 : concrete results
       Dim m_ORIG as Integer       '        origin of maximum reinforcement:
      ...
      Structure CQUAD_RNR          ' 271/DC:Z+  Reinforcement Layer Design Results in Nodes
       Dim m_NG as Integer         '        group number (for nodal results)
       Dim m_NR as Integer         '        element number
       Dim m_ID as Integer         '        identifier of reincorcement layer
       Dim m_ORIG as Integer       '        origin of maximum reinforcement, see QUAD_REA for Details
      ...
      Structure CQUAD_CFD          ' 290/LC  Fluid flow results in Quad-elements
       ...
       Dim m_LMIX as Single        ' [1001] mixing length
      ...
      Structure CBRIC_SU           ' 300/02:0  Surfaces and Neighbours of Bric-elements
       Dim m_ID as Integer
       Dim m_I_1 as Integer
       Dim m_NBRIC as Integer
       Dim m_MBRIC as Integer
      ...
      Structure CBRIC_TCM          ' 319/LC  damage in Bric-elements LADE
       Dim m_NR as Integer         '        elementnumber
       Dim m_IG as Integer         '        gauss point
       Dim m_DAM1 as Single        '        damage value    1. crack direction
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_DIR1() as Single '        crack direction 1
       Dim m_DAM2 as Single        '        damage value    2. crack direction
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_DIR2() as Single '        crack direction 2
       Dim m_DAM3 as Single        '        damage value    3. crack direction
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_DIR3() as Single '        crack direction 3
      END Structure

      Structure CBRIC_REC          ' 360/DC:0  maximum reinforcement in Bric-elements
       Dim m_NR as Integer         '        ident 0 for maximum (first records)
       ...
       Dim m_OAF as Single         '        Euler Angle II
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_SD() as Single ' [1092] stress range 1-3  (BEMESS design)
       ...
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_SIGNON() as Single ' [1092] steel stress reinforcement 1-3 (nonlinear ASE)
       Dim m_SIGBMA as Single      ' [1092] maximum concrete tensile stress (nonlinear ASE)
       Dim m_SIGBMI as Single      ' [1092] maximum concrete compression stress (nonlinear ASE)
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_EPSS() as Single ' [1081] average reinforcement strain 1-3 (nonlinear ASE)
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_CRAC() as Single ' [1081] crack strain (uncracked: 0) in crack direction 1-3
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_CD1() as Single '        crack direction 1 normalvector
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_CD2() as Single '        crack direction 2 normalvector
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_CD3() as Single '        crack direction 3 normalvector
      END Structure
      ...
      Structure CBRIC_NRC          ' 361/DC:0  maximum reinforcement in Bric-nodes
       Dim m_NG as Integer         '        ident 0 for maximum (first records)
       Dim m_NR as Integer         '        ident 0 for maximum (first records)
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=3)> Dim m_AS() as Single ' [1022] reinforcement 1-3
       Dim m_OAL as Single         '        Euler Angle I
      ...
      Structure CIL_CTRL1          ' -1/NS:1  Headder of a bending result
       Dim m_IDI as Integer        '        Type of result (to select the impact factor)
      ...
      Structure CIL_CTRL2          ' -1/NS:2  Headder of a shear result
       Dim m_IDI as Integer        '        Type of result (to select the impact factor)
       Dim m_IERG as Integer       '        index of this item + 1000*IMUNIT
       Dim m_LFMAX as Integer      '        Offset for load case number of results for maximum
       Dim m_LFMIN as Integer      '        Offset for load case number of results for minimum
      ...
      Structure CIL_CTRLX          ' -1/NS:?  Headder of transverse evaluation data
       Dim m_IDI as Integer        '        number of data points from LSEL INT (3
       Dim m_IERG as Integer       '        index of this item + 1000*IMUNIT
       Dim m_LFMAX as Integer      '        Offset for load case number of results for maximum
       Dim m_LFMIN as Integer      '        Offset for load case number of results for minimum
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=60)> Dim m_BWIDTH() as Single ' [1001] linked list of wheels whith variable length
      END Structure

      Structure CIL_DATA1          ' -1/NS:1????  Influence values for INT 0,1,2
       Dim m_IDI as Integer        '        Type of derivatives defined
       Dim m_X as Single           ' [1001] abszissae along lane
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_PV() as Single '        value for vertical loading (z) + Derivative (if IDI&1000)
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_MT() as Single '        value for torsional loading (x-x) + Derivative of MT/dx (if IDI
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_PT() as Single '        value for transverse loading (y) + Derivative of PT/dx (if IDI&
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_PL() as Single '        value for longitudinal loading (x) + Derivative of PL/dx (if ID
      END Structure

      Structure CIL_DATA2          ' -1/NS:1??????  Influence values for INT > 2
       Dim m_IDI as Integer        '        Type of derivatives defined
       Dim m_X as Single           ' [1001] abszissae along lane
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_PV() as Single '        value for vertical loading (z) + Derivative (if IDI&1000)
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_MT() as Single '        value for torsional loading (x-x) + Derivative of MT/dx (if IDI
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_PT() as Single '        value for transverse loading (y) + Derivative of PT/dx (if IDI&
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_PL() as Single '        value for longitudinal loading (x) + Derivative of PL/dx (if ID
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_PPOS() as Single '        value for vertical distributed loading + Derivative
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_PNEG() as Single '        value for vertical distributed loading + Derivative
       Dim m_PZERO as Single       '        position of zero value of the transverse influence line
       Dim m_YEX as Single         '        excentric transverse position of primary load train
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=2)> Dim m_RRES() as Single '        values for right and left residual loading
       <MarshalAs(UnmanagedType.ByValArray, SizeConst:=16)> Dim m_FAX() as Single '        correction factors for different axle types
      END Structure
