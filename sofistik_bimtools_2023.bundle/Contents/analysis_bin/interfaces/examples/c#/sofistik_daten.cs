...
namespace SofistikDataTypes
{
      public unsafe struct cs_rec_indx                  //        -999/-998  Sorted index on structure names
      {
            ...
            public fixed int  m_sel3[2];                //        Selection string of third integer value
      ...
      enum CTRL_ACCESS_2023 { CTRL_ACCESS_2023 = 512 }
      ...
      enum MAT_CONC_EN_STANDARD { MAT_CONC_EN_STANDARD = 1000 }
      enum MAT_CONC_EN_LIGHT { MAT_CONC_EN_LIGHT = 1001 }
      enum MAT_CONC_EN_HIGH_STRENGTH { MAT_CONC_EN_HIGH_STRENGTH = 1002 }
      enum MAT_CONC_EN_FIBRE { MAT_CONC_EN_FIBRE = 1003 }
      enum MAT_CONC_EN_ELASTIC { MAT_CONC_EN_ELASTIC = 1004 }
      enum MAT_CONC_EN_DEFORMATION_A { MAT_CONC_EN_DEFORMATION_A = 1005 }
      enum MAT_CONC_EN_DEFORMATION_B { MAT_CONC_EN_DEFORMATION_B = 1006 }
      enum MAT_CONC_DIN_STANDARD { MAT_CONC_DIN_STANDARD = 1010 }
      enum MAT_CONC_DIN_LIGHT { MAT_CONC_DIN_LIGHT = 1011 }
      enum MAT_CONC_DIN_PRESTRESS { MAT_CONC_DIN_PRESTRESS = 1012 }
      enum MAT_CONC_DIN_ELASTIC { MAT_CONC_DIN_ELASTIC = 1014 }
      enum MAT_CONC_DIN_NEW_STANDARD { MAT_CONC_DIN_NEW_STANDARD = 1015 }
      enum MAT_CONC_DIN_NEW_LIGHT { MAT_CONC_DIN_NEW_LIGHT = 1016 }
      enum MAT_CONC_OEN_STANDARD { MAT_CONC_OEN_STANDARD = 1020 }
      enum MAT_CONC_OEN_LIGHT { MAT_CONC_OEN_LIGHT = 1021 }
      enum MAT_CONC_OEN_PRESTRESS { MAT_CONC_OEN_PRESTRESS = 1022 }
      enum MAT_CONC_SIA_STANDARD { MAT_CONC_SIA_STANDARD = 1030 }
      enum MAT_CONC_SIA_LIGHT { MAT_CONC_SIA_LIGHT = 1031 }
      enum MAT_CONC_SIA_HIGH_STRENGTH { MAT_CONC_SIA_HIGH_STRENGTH = 1032 }
      enum MAT_CONC_BS_STANDARD { MAT_CONC_BS_STANDARD = 1040 }
      enum MAT_CONC_BS_LIGHT { MAT_CONC_BS_LIGHT = 1041 }
      enum MAT_CONC_BS_HIGH_STRENGTH { MAT_CONC_BS_HIGH_STRENGTH = 1042 }
      enum MAT_CONC_ACI_STANDARD { MAT_CONC_ACI_STANDARD = 1050 }
      enum MAT_CONC_ACI_LIGHT { MAT_CONC_ACI_LIGHT = 1051 }
      enum MAT_CONC_ACI_HIGH_STRENGTH { MAT_CONC_ACI_HIGH_STRENGTH = 1052 }
      enum MAT_CONC_JIS_STANDARD { MAT_CONC_JIS_STANDARD = 1060 }
      enum MAT_CONC_JIS_LIGHT { MAT_CONC_JIS_LIGHT = 1061 }
      enum MAT_CONC_JRA_CONCRETE { MAT_CONC_JRA_CONCRETE = 1062 }
      enum MAT_CONC_GBJ_STANDARD { MAT_CONC_GBJ_STANDARD = 1070 }
      enum MAT_CONC_GBJ_LIGHT { MAT_CONC_GBJ_LIGHT = 1071 }
      enum MAT_CONC_GBJ_HIGH_STRENGTH { MAT_CONC_GBJ_HIGH_STRENGTH = 1072 }
      enum MAT_CONC_IS_STANDARD { MAT_CONC_IS_STANDARD = 1080 }
      enum MAT_CONC_IS_LIGHT { MAT_CONC_IS_LIGHT = 1081 }
      enum MAT_CONC_IRC_CONCRETE { MAT_CONC_IRC_CONCRETE = 1082 }
      enum MAT_CONC_SP_STANDARD { MAT_CONC_SP_STANDARD = 1090 }
      enum MAT_CONC_SP_LIGHT { MAT_CONC_SP_LIGHT = 1091 }
      enum MAT_CONC_BAEL_STANDARD { MAT_CONC_BAEL_STANDARD = 1130 }
      enum MAT_CONC_BPEL_PRESTRESS { MAT_CONC_BPEL_PRESTRESS = 1132 }
      enum MAT_CONC_DUCTAL_FIBRE { MAT_CONC_DUCTAL_FIBRE = 1133 }
      enum MAT_CONC_EHE_STANDARD { MAT_CONC_EHE_STANDARD = 1140 }
      enum MAT_CONC_EHE_PRESTRESS { MAT_CONC_EHE_PRESTRESS = 1142 }
      enum MAT_CONC_DS_STANDARD { MAT_CONC_DS_STANDARD = 1150 }
      enum MAT_CONC_BBK_STANDARD { MAT_CONC_BBK_STANDARD = 1160 }
      enum MAT_CONC_BBK_LIGHT { MAT_CONC_BBK_LIGHT = 1161 }
      enum MAT_CONC_NS_STANDARD { MAT_CONC_NS_STANDARD = 1170 }
      enum MAT_CONC_NS_LIGHT { MAT_CONC_NS_LIGHT = 1171 }
      enum MAT_CONC_CAN_STANDARD { MAT_CONC_CAN_STANDARD = 1190 }
      enum MAT_CONC_CAL_LIGHT { MAT_CONC_CAL_LIGHT = 1191 }
      enum MAT_CONC_CAP_PRESTRESS { MAT_CONC_CAP_PRESTRESS = 1192 }
      enum MAT_CONC_MSZ_STANDARD { MAT_CONC_MSZ_STANDARD = 1330 }
      enum MAT_CONC_MSZ_LIGHT { MAT_CONC_MSZ_LIGHT = 1331 }
      enum MAT_CONC_NBR_STANDARD { MAT_CONC_NBR_STANDARD = 1550 }
      enum MAT_CONC_NBR_LIGHT { MAT_CONC_NBR_LIGHT = 1551 }
      enum MAT_CONC_NBR_PRESTRESS { MAT_CONC_NBR_PRESTRESS = 1552 }
      enum MAT_CONC_AS_STANDARD { MAT_CONC_AS_STANDARD = 1610 }
      enum MAT_CONC_AS_LIGHT { MAT_CONC_AS_LIGHT = 1611 }
      enum MAT_CONC_AS_PRESTRESS { MAT_CONC_AS_PRESTRESS = 1612 }
      enum MAT_CONC_NZS_STANDARD { MAT_CONC_NZS_STANDARD = 1640 }
      enum MAT_CONC_NZS_LIGHT { MAT_CONC_NZS_LIGHT = 1641 }
      enum MAT_CONC_NZS_PRESTRESS { MAT_CONC_NZS_PRESTRESS = 1642 }
      ...
      enum MAT_STEE_EN_RF { MAT_STEE_EN_RF = 2000 }
      enum MAT_STEE_EN_PRESTRESS { MAT_STEE_EN_PRESTRESS = 2001 }
      enum MAT_STEE_EN_STRUCTURAL { MAT_STEE_EN_STRUCTURAL = 2002 }
      enum MAT_STEE_EN_AL_PLATE { MAT_STEE_EN_AL_PLATE = 2003 }
      enum MAT_STEE_EN_AL_GENERAL { MAT_STEE_EN_AL_GENERAL = 2004 }
      enum MAT_STEE_EN_AL_CAST { MAT_STEE_EN_AL_CAST = 2005 }
      enum MAT_STEE_EN_CABLE { MAT_STEE_EN_CABLE = 2009 }
      enum MAT_STEE_DIN_RF { MAT_STEE_DIN_RF = 2010 }
      enum MAT_STEE_DIN_PRESTRESS { MAT_STEE_DIN_PRESTRESS = 2011 }
      enum MAT_STEE_DIN_STRUCTURAL { MAT_STEE_DIN_STRUCTURAL = 2012 }
      enum MAT_STEE_DIN_CAST_IRON { MAT_STEE_DIN_CAST_IRON = 2013 }
      enum MAT_STEE_DIN_AL_GENERAL { MAT_STEE_DIN_AL_GENERAL = 2014 }
      enum MAT_STEE_DIN_NEW_STRUC { MAT_STEE_DIN_NEW_STRUC = 2015 }
      enum MAT_STEE_DIN_NEW_IRON { MAT_STEE_DIN_NEW_IRON = 2016 }
      enum MAT_STEE_OEN_RF { MAT_STEE_OEN_RF = 2020 }
      enum MAT_STEE_OEN_PRESTRESS { MAT_STEE_OEN_PRESTRESS = 2021 }
      enum MAT_STEE_OEN_STRUCTURAL { MAT_STEE_OEN_STRUCTURAL = 2022 }
      enum MAT_STEE_OEN_CAST_IRON { MAT_STEE_OEN_CAST_IRON = 2023 }
      enum MAT_STEE_OEN_NEW_IRON { MAT_STEE_OEN_NEW_IRON = 2026 }
      enum MAT_STEE_SIA_RF { MAT_STEE_SIA_RF = 2030 }
      enum MAT_STEE_SIA_PRESTRESS { MAT_STEE_SIA_PRESTRESS = 2031 }
      enum MAT_STEE_SIA_STRUCTURAL { MAT_STEE_SIA_STRUCTURAL = 2032 }
      enum MAT_STEE_BS_RF { MAT_STEE_BS_RF = 2040 }
      enum MAT_STEE_BS_PRESTRESS { MAT_STEE_BS_PRESTRESS = 2041 }
      enum MAT_STEE_BS_STRUCTURAL { MAT_STEE_BS_STRUCTURAL = 2042 }
      enum MAT_STEE_ACI_RF { MAT_STEE_ACI_RF = 2050 }
      enum MAT_STEE_ACI_PRESTRESS { MAT_STEE_ACI_PRESTRESS = 2051 }
      enum MAT_STEE_AISC_STRUCTURAL { MAT_STEE_AISC_STRUCTURAL = 2052 }
      enum MAT_STEE_JIS_RF { MAT_STEE_JIS_RF = 2060 }
      enum MAT_STEE_JIS_PRESTRESS { MAT_STEE_JIS_PRESTRESS = 2061 }
      enum MAT_STEE_JIS_STRUCTURAL { MAT_STEE_JIS_STRUCTURAL = 2062 }
      enum MAT_STEE_GBJ_RF { MAT_STEE_GBJ_RF = 2070 }
      enum MAT_STEE_GBJ_PRESTRESS { MAT_STEE_GBJ_PRESTRESS = 2071 }
      enum MAT_STEE_GBJ_STRUCTURAL { MAT_STEE_GBJ_STRUCTURAL = 2072 }
      enum MAT_STEE_IS_RF { MAT_STEE_IS_RF = 2080 }
      enum MAT_STEE_IS_PRESTRESS { MAT_STEE_IS_PRESTRESS = 2081 }
      enum MAT_STEE_IS_STRUCTURAL { MAT_STEE_IS_STRUCTURAL = 2082 }
      enum MAT_STEE_SP_RF { MAT_STEE_SP_RF = 2090 }
      enum MAT_STEE_SP_PRESTRESS { MAT_STEE_SP_PRESTRESS = 2091 }
      enum MAT_STEE_SP_STRUCTURAL { MAT_STEE_SP_STRUCTURAL = 2092 }
      enum MAT_STEE_BAEL_RF { MAT_STEE_BAEL_RF = 2130 }
      enum MAT_STEE_BPEL_PRESTRESS { MAT_STEE_BPEL_PRESTRESS = 2131 }
      enum MAT_STEE_EHE_RF { MAT_STEE_EHE_RF = 2140 }
      enum MAT_STEE_EHE_PRESTRESS { MAT_STEE_EHE_PRESTRESS = 2141 }
      enum MAT_STEE_EA_STRUCTURAL { MAT_STEE_EA_STRUCTURAL = 2142 }
      enum MAT_STEE_DS_RF { MAT_STEE_DS_RF = 2150 }
      enum MAT_STEE_DS_PRESTRESS { MAT_STEE_DS_PRESTRESS = 2151 }
      enum MAT_STEE_BBK_RF { MAT_STEE_BBK_RF = 2160 }
      enum MAT_STEE_BBK_PRESTRESS { MAT_STEE_BBK_PRESTRESS = 2161 }
      enum MAT_STEE_BSK_STRUCTURAL { MAT_STEE_BSK_STRUCTURAL = 2162 }
      enum MAT_STEE_BRO_STRUCTURAL { MAT_STEE_BRO_STRUCTURAL = 2164 }
      enum MAT_STEE_NS_RF { MAT_STEE_NS_RF = 2170 }
      enum MAT_STEE_NS_PRESTRESS { MAT_STEE_NS_PRESTRESS = 2171 }
      enum MAT_STEE_NS_STRUCTURAL { MAT_STEE_NS_STRUCTURAL = 2172 }
      enum MAT_STEE_FEB_RF { MAT_STEE_FEB_RF = 2190 }
      enum MAT_STEE_FEP_PRESTRESS { MAT_STEE_FEP_PRESTRESS = 2191 }
      enum MAT_STEE_FEI_STRUCTURAL { MAT_STEE_FEI_STRUCTURAL = 2192 }
      enum MAT_STEE_FEG_CAST_IRON { MAT_STEE_FEG_CAST_IRON = 2193 }
      enum MAT_STEE_MSZ_RF { MAT_STEE_MSZ_RF = 2330 }
      enum MAT_STEE_MSZ_PRESTRESS { MAT_STEE_MSZ_PRESTRESS = 2331 }
      enum MAT_STEE_MSZ_STRUCTURAL { MAT_STEE_MSZ_STRUCTURAL = 2332 }
      enum MAT_STEE_NBR_RF { MAT_STEE_NBR_RF = 2550 }
      enum MAT_STEE_NBR_PRESTRESS { MAT_STEE_NBR_PRESTRESS = 2551 }
      enum MAT_STEE_NBR_STRUCTURAL { MAT_STEE_NBR_STRUCTURAL = 2552 }
      enum MAT_STEE_AS_RF { MAT_STEE_AS_RF = 2610 }
      enum MAT_STEE_AS_PRESTRESS { MAT_STEE_AS_PRESTRESS = 2611 }
      enum MAT_STEE_AS_STRUCTURAL { MAT_STEE_AS_STRUCTURAL = 2612 }
      enum MAT_STEE_NZS_RF { MAT_STEE_NZS_RF = 2640 }
      enum MAT_STEE_NZS_PRESTRESS { MAT_STEE_NZS_PRESTRESS = 2641 }
      enum MAT_STEE_NZS_STRUCTURAL { MAT_STEE_NZS_STRUCTURAL = 2642 }
      ...
      enum MAT_TIMB_DIN_NA_SOLID_SOFT_WOOD { MAT_TIMB_DIN_NA_SOLID_SOFT_WOOD = 3010 }
      enum MAT_TIMB_DIN_BS_GLUED_LAMINATED_TIMBER { MAT_TIMB_DIN_BS_GLUED_LAMINATED_TIMBER = 3011 }
      enum MAT_TIMB_DIN_LA_SOLID_HARD_WOOD_A { MAT_TIMB_DIN_LA_SOLID_HARD_WOOD_A = 3012 }
      enum MAT_TIMB_DIN_LB_SOLID_HARD_WOOD_B { MAT_TIMB_DIN_LB_SOLID_HARD_WOOD_B = 3013 }
      enum MAT_TIMB_DIN_LC_SOLID_HARD_WOOD_C { MAT_TIMB_DIN_LC_SOLID_HARD_WOOD_C = 3014 }
      enum MAT_TIMB_DIN_S_SOLID_WOOD_STANDARD_SORTED { MAT_TIMB_DIN_S_SOLID_WOOD_STANDARD_SORTED = 3015 }
      enum MAT_TIMB_DIN_MS_SOLID_WOOD_MASCHINE_SORTED { MAT_TIMB_DIN_MS_SOLID_WOOD_MASCHINE_SORTED = 3016 }
      enum MAT_TIMB_GFK_FIBERGLASS_PLASTICS { MAT_TIMB_GFK_FIBERGLASS_PLASTICS = 3017 }
      enum MAT_TIMB_CFK_CARBON_FIBER_PLASTICS { MAT_TIMB_CFK_CARBON_FIBER_PLASTICS = 3018 }
      enum MAT_TIMB_SFK_SYNTHETIC_FIBER_PLASTICS { MAT_TIMB_SFK_SYNTHETIC_FIBER_PLASTICS = 3019 }
      enum MAT_TIMB_OEN_FTK_SPRUCE_FIR_JAW { MAT_TIMB_OEN_FTK_SPRUCE_FIR_JAW = 3020 }
      enum MAT_TIMB_OEN_L_LARCH { MAT_TIMB_OEN_L_LARCH = 3021 }
      enum MAT_TIMB_OEN_BE_BEECH_OAK { MAT_TIMB_OEN_BE_BEECH_OAK = 3022 }
      enum MAT_TIMB_EC5_C_SOLID_SOFT_WOOD { MAT_TIMB_EC5_C_SOLID_SOFT_WOOD = 3700 }
      enum MAT_TIMB_EC5_GL_GLUED_LAMINATED_TIMBER { MAT_TIMB_EC5_GL_GLUED_LAMINATED_TIMBER = 3701 }
      enum MAT_TIMB_EC5_D_SOLID_HARD_WOOD { MAT_TIMB_EC5_D_SOLID_HARD_WOOD = 3702 }
      enum MAT_TIMB_EC5_PLY_PLYWOOD { MAT_TIMB_EC5_PLY_PLYWOOD = 3703 }
      enum MAT_TIMB_EC5_OSB_BOARDS { MAT_TIMB_EC5_OSB_BOARDS = 3304 }
      enum MAT_TIMB_EC5_PART_PARTICLEBOARD { MAT_TIMB_EC5_PART_PARTICLEBOARD = 3705 }
      enum MAT_TIMB_EC5_FIB_FIBRE_BOARD { MAT_TIMB_EC5_FIB_FIBRE_BOARD = 3306 }
      enum MAT_TIMB_DIN_C_SOLID_SOFT_WOOD { MAT_TIMB_DIN_C_SOLID_SOFT_WOOD = 3710 }
      enum MAT_TIMB_DIN_GL_GLUED_LAMINATED_TIMBER { MAT_TIMB_DIN_GL_GLUED_LAMINATED_TIMBER = 3711 }
      enum MAT_TIMB_DIN_D_SOLID_HARD_WOOD { MAT_TIMB_DIN_D_SOLID_HARD_WOOD = 3712 }
      enum MAT_TIMB_DIN_PLY_PLYWOOD { MAT_TIMB_DIN_PLY_PLYWOOD = 3713 }
      enum MAT_TIMB_DIN_OSB_OSB_BOARDS { MAT_TIMB_DIN_OSB_OSB_BOARDS = 3314 }
      enum MAT_TIMB_DIN_PART_PARTICLEBOARD_12 { MAT_TIMB_DIN_PART_PARTICLEBOARD_12 = 3315 }
      enum MAT_TIMB_DIN_PART_PARTICLEBOARD_123 { MAT_TIMB_DIN_PART_PARTICLEBOARD_123 = 3715 }
      enum MAT_TIMB_DIN_FIB_FIBRE_BOARD { MAT_TIMB_DIN_FIB_FIBRE_BOARD = 3316 }
      enum MAT_TIMB_SIA_C_SOLID_SOFT_WOOD { MAT_TIMB_SIA_C_SOLID_SOFT_WOOD = 3730 }
      enum MAT_TIMB_SIA_GL_GLUED_LAMINATED_TIMBER { MAT_TIMB_SIA_GL_GLUED_LAMINATED_TIMBER = 3731 }
      enum MAT_TIMB_SIA_D_SOLID_HARD_WOOD { MAT_TIMB_SIA_D_SOLID_HARD_WOOD = 3732 }
      ...
      public unsafe struct cs_axis                      //        3/ID:0  Geometric Axis
      {
            ...
            public int  m_id3;                          //        AXIS_SUBTYPE_POST: >0 = explicit material to cut , <=0 = all ma
      ...
      public unsafe struct cs_tend_1                    //        4/ID:1  Tendon of Prestressing Schemes
      {
            ...
            public int  m_id2;                          //        Type of input: 0 SYSP: post-tensioning
      ...
      public unsafe struct cs_sect_cab                  //        9/NR:11  SectiontypeCable (CABL)
      {
            ...
            public float  m_gammar;                     //        partial factor minimise bending stresses (EN 1993-1-11, table 6
      } // cs_sectiontypecable (cabl)

      enum PROF_MNO_IMBEDDED_MAT { PROF_MNO_IMBEDDED_MAT = 1000 }
      ...
      enum TXT_TXT_INTLEN_TEXT { TXT_TXT_INTLEN_TEXT = 17 }
      enum TXT_TXT_INTLEN_CDB { TXT_TXT_INTLEN_CDB = 128 }
      ...
      enum USR_PROG_AQUA { USR_PROG_AQUA = 1096110401 }
      enum USR_PROG_CSE { USR_PROG_CSE = 1414087749 }
      enum USR_PROG_FEAX { USR_PROG_FEAX = 1480672582 }
      ...
      public unsafe struct cs_sect_ptc                  //        9/NR:310  PartialIntegrationPoint of shear cut
      {
            public int  m_id;                           //        Identification 100/101
            public int  m_mno;                          //        Material number
            public int  m_idp;                          //        Number*256 + Bitpattern
            ...
            public float  m_temp;                       // [1215] Temperature
            public float  m_temp1;                      // [1215] maximum temperature in history (for damage)
      } // cs_partialintegrationpoint of shear cut
      ...
      public unsafe struct cs_sect_ncp                  //        9/NR:312  Partial non effective polygons for partial cut polygon
      {
            public int  m_id;                           //        Identification 191
            public int  m_mno;                          //        Materialnumber
            public int  m_idp;                          //        Noneffective for (see :190)
            public int  m_tnr;                          //        Ident from 190 / Cut identifier for :312 elements
            public fixed float  m_yz[511*2];            // [1011] yz(2,*) = vertices (old format is blocked with 7 points
      } // cs_partial non effective polygons for partial cut polygon
      ...
      public unsafe struct cs_sect_pcp                  //        9/NR:320  SectionPointReinforcement for partial cut polygon
      {
            public int  m_id;                           //        Identification 200
            public int  m_mno;                          //        Material number
            public int  m_ir;                           //        Layer number
            ...
            public float  m_aref;                       // [1012] Reference area
            public float  m_a;                          // [1011] distance of bars
      } // cs_sectionpointreinforcement for partial cut polygon
      ...
      public unsafe struct cs_sect_lcp                  //        9/NR:321  SectionLineReinforcement for partial cut polygon
      {
            public int  m_id;                           //        Identification 201/211/221 or 321
            public int  m_mno;                          //        Material number
            public int  m_ir;                           //        Layer number
            ...
            public float  m_phia;                       // [   5] start angle for generated points
            public float  m_phie;                       // [   5] end   angle for generated points
      } // cs_sectionlinereinforcement for partial cut polygon
      ...
      enum CPT_MNO_MATERIAL { CPT_MNO_MATERIAL = 1000 }
      ...
      enum CPT_BIT_NO_Y_STRESS { CPT_BIT_NO_Y_STRESS = 8 }
      enum CPT_BIT_TORSION_UNFAVOURABLE { CPT_BIT_TORSION_UNFAVOURABLE = 16 }
      enum CPT_BIT_SHEAR_UNFAVOURABLE { CPT_BIT_SHEAR_UNFAVOURABLE = 32 }
      enum CPT_BIT_ABSOLUT { CPT_BIT_ABSOLUT = 64 }
      ...
      enum CUT_MNO_MATERIAL { CUT_MNO_MATERIAL = 1000 }
      ...
      enum CUT_IDP_WIDTH_OF_LEON { CUT_IDP_WIDTH_OF_LEON = 1048576 }
      ...
      enum SYST_IACHS_UNDEFINED { SYST_IACHS_UNDEFINED = 0 }
      enum SYST_IACHS_NEGATIVE_X { SYST_IACHS_NEGATIVE_X = -1 }
      enum SYST_IACHS_NEGATIVE_Y { SYST_IACHS_NEGATIVE_Y = -2 }
      enum SYST_IACHS_NEGATIVE_Z { SYST_IACHS_NEGATIVE_Z = -3 }
      enum SYST_IACHS_POSITIVE_X { SYST_IACHS_POSITIVE_X = +1 }
      enum SYST_IACHS_POSITIVE_Y { SYST_IACHS_POSITIVE_Y = +2 }
      enum SYST_IACHS_POSITIVE_Z { SYST_IACHS_POSITIVE_Z = +3 }
      ...
      enum LC_CTRL_ITYP_X { LC_CTRL_ITYP_X = 1 }
      enum LC_CTRL_ITYP_G { LC_CTRL_ITYP_G = 2 }
      enum LC_CTRL_ITYP_G1 { LC_CTRL_ITYP_G1 = 3 }
      enum LC_CTRL_ITYP_G2 { LC_CTRL_ITYP_G2 = 4 }
      enum LC_CTRL_ITYP_P { LC_CTRL_ITYP_P = 5 }
      enum LC_CTRL_ITYP_C { LC_CTRL_ITYP_C = 6 }
      enum LC_CTRL_ITYP_Q { LC_CTRL_ITYP_Q = 7 }
      enum LC_CTRL_ITYP_L { LC_CTRL_ITYP_L = 8 }
      enum LC_CTRL_ITYP_W { LC_CTRL_ITYP_W = 9 }
      enum LC_CTRL_ITYP_S { LC_CTRL_ITYP_S = 10 }
      enum LC_CTRL_ITYP_R { LC_CTRL_ITYP_R = 11 }
      enum LC_CTRL_ITYP_F { LC_CTRL_ITYP_F = 12 }
      enum LC_CTRL_ITYP_T { LC_CTRL_ITYP_T = 13 }
      enum LC_CTRL_ITYP_A { LC_CTRL_ITYP_A = 14 }
      enum LC_CTRL_ITYP_B { LC_CTRL_ITYP_B = 15 }
      enum LC_CTRL_ITYP_E { LC_CTRL_ITYP_E = 16 }
      enum LC_CTRL_ITYP_ZX { LC_CTRL_ITYP_ZX = 17 }
      enum LC_CTRL_ITYP_ZG { LC_CTRL_ITYP_ZG = 18 }
      enum LC_CTRL_ITYP_Z1 { LC_CTRL_ITYP_Z1 = 19 }
      enum LC_CTRL_ITYP_Z2 { LC_CTRL_ITYP_Z2 = 20 }
      enum LC_CTRL_ITYP_ZP { LC_CTRL_ITYP_ZP = 21 }
      enum LC_CTRL_ITYP_ZC { LC_CTRL_ITYP_ZC = 22 }
      enum LC_CTRL_ITYP_ZQ { LC_CTRL_ITYP_ZQ = 23 }
      enum LC_CTRL_ITYP_ZL { LC_CTRL_ITYP_ZL = 24 }
      enum LC_CTRL_ITYP_ZW { LC_CTRL_ITYP_ZW = 25 }
      enum LC_CTRL_ITYP_ZS { LC_CTRL_ITYP_ZS = 26 }
      enum LC_CTRL_ITYP_ZR { LC_CTRL_ITYP_ZR = 27 }
      enum LC_CTRL_ITYP_ZF { LC_CTRL_ITYP_ZF = 28 }
      enum LC_CTRL_ITYP_ZT { LC_CTRL_ITYP_ZT = 29 }
      enum LC_CTRL_ITYP_ZA { LC_CTRL_ITYP_ZA = 30 }
      enum LC_CTRL_ITYP_ZB { LC_CTRL_ITYP_ZB = 31 }
      enum LC_CTRL_ITYP_ZE { LC_CTRL_ITYP_ZE = 32 }
      enum LC_CTRL_ITYP_SX { LC_CTRL_ITYP_SX = 33 }
      enum LC_CTRL_ITYP_SG { LC_CTRL_ITYP_SG = 34 }
      enum LC_CTRL_ITYP_S1 { LC_CTRL_ITYP_S1 = 35 }
      enum LC_CTRL_ITYP_S2 { LC_CTRL_ITYP_S2 = 36 }
      enum LC_CTRL_ITYP_SP { LC_CTRL_ITYP_SP = 37 }
      enum LC_CTRL_ITYP_SC { LC_CTRL_ITYP_SC = 38 }
      enum LC_CTRL_ITYP_SQ { LC_CTRL_ITYP_SQ = 39 }
      enum LC_CTRL_ITYP_SL { LC_CTRL_ITYP_SL = 40 }
      enum LC_CTRL_ITYP_SW { LC_CTRL_ITYP_SW = 41 }
      enum LC_CTRL_ITYP_SS { LC_CTRL_ITYP_SS = 42 }
      enum LC_CTRL_ITYP_SR { LC_CTRL_ITYP_SR = 43 }
      enum LC_CTRL_ITYP_SF { LC_CTRL_ITYP_SF = 44 }
      enum LC_CTRL_ITYP_ST { LC_CTRL_ITYP_ST = 45 }
      enum LC_CTRL_ITYP_SA { LC_CTRL_ITYP_SA = 46 }
      enum LC_CTRL_ITYP_SB { LC_CTRL_ITYP_SB = 47 }
      enum LC_CTRL_ITYP_SE { LC_CTRL_ITYP_SE = 48 }
      enum LC_CTRL_ITYP_GA { LC_CTRL_ITYP_GA = 49 }
      enum LC_CTRL_ITYP_Q_A { LC_CTRL_ITYP_Q_A = 50 }
      enum LC_CTRL_ITYP_Q_B { LC_CTRL_ITYP_Q_B = 51 }
      enum LC_CTRL_ITYP_Q_C { LC_CTRL_ITYP_Q_C = 52 }
      enum LC_CTRL_ITYP_Q_D { LC_CTRL_ITYP_Q_D = 53 }
      enum LC_CTRL_ITYP_Q_E { LC_CTRL_ITYP_Q_E = 54 }
      enum LC_CTRL_ITYP_Q_F { LC_CTRL_ITYP_Q_F = 55 }
      enum LC_CTRL_ITYP_Q_G { LC_CTRL_ITYP_Q_G = 56 }
      enum LC_CTRL_ITYP_Q_H { LC_CTRL_ITYP_Q_H = 57 }
      enum LC_CTRL_ITYP_S_L { LC_CTRL_ITYP_S_L = 58 }
      enum LC_CTRL_ITYP_S_H { LC_CTRL_ITYP_S_H = 59 }
      enum LC_CTRL_ITYP_L_A { LC_CTRL_ITYP_L_A = 60 }
      enum LC_CTRL_ITYP_L_B { LC_CTRL_ITYP_L_B = 61 }
      enum LC_CTRL_ITYP_L_C { LC_CTRL_ITYP_L_C = 62 }
      enum LC_CTRL_ITYP_L_D { LC_CTRL_ITYP_L_D = 63 }
      enum LC_CTRL_ITYP_L_E { LC_CTRL_ITYP_L_E = 64 }
      enum LC_CTRL_ITYP_Q_J { LC_CTRL_ITYP_Q_J = 65 }
      enum LC_CTRL_ITYP_Q_K { LC_CTRL_ITYP_Q_K = 66 }
      enum LC_CTRL_ITYP_Q_T { LC_CTRL_ITYP_Q_T = 67 }
      enum LC_CTRL_ITYP_Q_Z { LC_CTRL_ITYP_Q_Z = 68 }
      enum LC_CTRL_ITYP_IMP { LC_CTRL_ITYP_IMP = 70 }
      enum LC_CTRL_ITYP_V { LC_CTRL_ITYP_V = 71 }
      enum LC_CTRL_ITYP_K { LC_CTRL_ITYP_K = 72 }
      enum LC_CTRL_ITYP_L_T { LC_CTRL_ITYP_L_T = 73 }
      enum LC_CTRL_ITYP_L_U { LC_CTRL_ITYP_L_U = 74 }
      ...
      public unsafe struct cs_lc_lpo1                   //        12/LC:91  Individual position of Point load
      {
            ...
            public fixed float  m_pval[4];              //        Load values in PV,PVM,PY,PX
      ...
      public unsafe struct cs_lc_lpox                   //        12/LC:99  Spandefinitions from ELLA
      {
            ...
            public float  m_xa;                         // [1001] Limits of a span start
            public float  m_xe;                         // [1001] Limits of a span end
            public float  m_v;                          // [1203] velocity of load train
            public float  m_phi;                        //        impact factor
            public float  m_yex;                        // [1001] mean value of eccentricity of primary loadtrain
            public fixed float  m_pzero[2];             // [1001] Position of zero influence values at start and end
            public float  m_psign;                      //        estimate if unfavourable is on left(-) or right(+) of zero line
      ...
      public unsafe struct cs_lc_poin                   //        12/LC:10?  Free point loads
      {
            ...
            public fixed int  m_tref[3];                //        Reference text for eccentricities in sections (12 characters)
            public int  m_typ;                          //        type of load
            public fixed int  m_txt[3];                 //        Identifiying User Text (12 characters)
      ...
      public unsafe struct cs_lc_area                   //        12/LC:12?  Free area loads
      {
            public int  m_kref;                         //        Reference type
            public int  m_nref;                         //        Reference number
            public fixed int  m_tref[3];                //        Reference text (not used) (12 characters)
            public int  m_typ;                          //        type of load
      ...
      public unsafe struct cs_lc_trai                   //        12/LC:300  Train loading
      {
            ...
            public float  m_yex;                        // [1001] Range of eccentricity of loading in lane
      ...
      public unsafe struct cs_lc_tral                   //        12/LC:301  Individual loads of Train loading
      {
            ...
            public float  m_ymin;                       // [1001] eccentricity in y direction
            public float  m_ymax;                       // [1001] deprecated: max eccentricity in y direction
            ...
            public float  m_pv;                         //        Mass value for centrifugal force
            public float  m_zpv;                        // [1001] Height for centrifugal force resultant
            ...
            public float  m_width;                      // [1001] obsoleted: Width of train
            public float  m_dwheel;                     // [1001] Distance of wheels
      ...
      public unsafe struct cs_sgr2_def                  //        39/NR:910  Secondary Group Definition
      {
            public int  m_id;                           //        Identifier = 910
            public int  m_idg;                          //        Identifier of secondary group
            public int  m_r0;                           //        reserved
            public int  m_r1;                           //        reserved
            public int  m_ibb;                          //        Construction stage no. BIRTH (0 = instant activation)
            public int  m_ibd;                          //        Construction stage no. DEATH (0 = infinite lifetime)
            public fixed int m_text[17];                //        Designation of secondary group
      } // cs_secondary group definition

      public unsafe struct cs_sgr2_sid                  //        39/NR:911  Secondary Group by ID
      {
            public int  m_id;                           //        Identifier = 911
            public int  m_typ;                          //        Type of referenced member
            public fixed int  m_no[255];                //        List of structural element IDs
      } // cs_secondary group by id

      public unsafe struct cs_sgr2_uid                  //        39/NR:912  Secondary Group by GUID
      {
            public int  m_id;                           //        Identifier = 912
            public int  m_r0;                           //        reserved
            public fixed int  m_guid[36];               //        Unique identifier of the structural element
      } // cs_secondary group by guid

      public unsafe struct cs_sgr2_box                  //        39/NR:913  Secondary Group by Bounding-Box
      {
            public int  m_id;                           //        Identifier = 913
            public int  m_r0;                           //        reserved
            public fixed float  m_xmin[3];              // [1001] Min coordinates of Box
            public fixed float  m_xmax[3];              // [1001] Max coordinates of Box
      } // cs_secondary group by bounding-box
      ...
      public unsafe struct cs_gar_boun                  //        32/NR:1  Outer Boundary of Area
      {
            ...
            public float  m_t;                          // [1010] Plate thickness along the edge
            public float  m_dfix;                       // [1001] Distance (offset) of region to edge
            public float  m_ca;                         // [1096] axial     bedding
            public float  m_cq;                         // [1096] lateral   bedding
            public float  m_cm;                         // [1099] torsional bedding
            public int  m_vaxi;                         //        ID of axis where a variable along the edge          :V202203
            public fixed int  m_vt[4];                  //        Name of a variable on VAXI describing a variable    :V202203
      ...
      public unsafe struct cs_sar_hole                  //        39/NR:202  Inner Boundary of Area
      {
            public int  m_id;                           //        identification
            public int  m_ng;                           //        edgeno     (31/NG)
            public int  m_na;                           //        startpoint (30/NA)
      ...
      public unsafe struct cs_dsln_def                  //        35/ID:0  Design Element Definition
      {
            ...
            public int  m_ctrl;                         //        DSLN specific general settings, Bits
      ...
      public unsafe struct cs_dgeo_def                  //        35/ID:1  Design Element Geometry
      {
            ...
            public fixed int  m_ids[9999];              //        IDs of structural lines or beams
      } // cs_dgeo_def
      ...
      public unsafe struct cs_dsel_ids                  //        35/ID:3  Selection of finite elements
      {
            public int  m_id;                           //        identification of data (3)
            public int  m_typ;                          //        Type of selection in Bits
            public fixed int  m_ids[1024];              //        IDs used in selection with Typ &4 or &8
      } // cs_selection of finite elements
      ...
      public unsafe struct cs_dsln_grp                  //        35/ID:5  Secondary groups of design element
      {
            public int  m_id;                           //        identification of data (5)
            public fixed int  m_groups[9999];           //        groups assigned to design element
      } // cs_secondary groups of design element
      ...
      public unsafe struct cs_tendaxis                  //        40/NR:0  Reference axis
      {
            public int  m_id0;                          //        identifier 0
      ...
      public unsafe struct cs_tendax_1                  //        40/NR:1  Reference axis stations
      {
            public int  m_id0;                          //        identifier 1
            public int  m_igbit;                        //        station parameter
            public int  m_nrstab;                       //        internal beam number
            public int  m_extid;                        //        external beam number (Quad: 0)
      ...
      } // cs_reference axis stations

      public unsafe struct cs_tndaxdef                  //        40/NR:5  Reference axis definition
      {
            public int  m_id0;                          //        identifier 5
            public int  m_noh;                          //        Number of the reference axis
            public int  m_typ;                          //        Type of definition: 1 Beam, 2 Node, 3 ..., 4 Auto, 5 Poly, 6 Re
            public float  m_val1;                       //        Values according to type *)
            public float  m_val2;                       //        "
            public float  m_val3;                       //        "
            public float  m_s;                          //        Station at the begin of the reference axis
            public int  m_setbit;                       //        Bitfield indicating what was set: 1:val1 & 2:val2 & 4:val3 & 8:
            public int  m_refid;                        //        In the case of Typ=Refx/Sln: Id of the reference axis
            public int  m_srefid;                       //        In the case of Typ=Refx:     Id of the secondary reference axis
            public int  m_art;                          //        Intersections with: 1 Beams, 2 Quads, 3 Brics (reserved), 4 ...
            public fixed int m_titl[17];                //        Title of the reference axis
      } // cs_reference axis definition

      public unsafe struct cs_tendspli                  //        41/NR:0  Duct curves
      {
            public int  m_id0;                          //        identifier 0
            public int  m_nrspur;                       //        Id reference axis
            public int  m_nrsv;                         //        Id prestressing system
            public int  m_igsys;                        //        prestress for:
      ...
      public unsafe struct cs_tendints                  //        41/NR:110  Duct curve intersections
      {
            public int  m_id0;                          //        Identifier 110
            public int  m_elmid;                        //        Intersected element id
            public int  m_elmtyp;                       //        Type of the intersected element: 1 Beam, 2 Quad, (3 Brics - res
            public fixed float  m_param[2];             //        Entry and exit intersection parameter of the duct curve
            public fixed float  m_nrmdst[2];            // [1001] Entry and exit normal distance to element's boundary. Inside < 
            public fixed float  m_inpdst[2];            // [1001] Entry and exit inplane/ distance to element's boundary. Inside 
            public fixed int  m_intloc[2];              //        Entry and exit intersection location. With element parameters b
      } // cs_duct curve intersections

      public unsafe struct cs_ductgrps                  //        41/NR:112  Element groups for duct intersections
      {
            public int  m_id0;                          //        Identifier 112
            public int  m_cmd;                          //        2 (see remark), [legacy: 0 activated, 1 deactivated]
            public fixed int  m_grpid[9999];            //        Alternating groupId and command (0:activate, 1:deactivate).
      } // cs_element groups for duct intersections

      public unsafe struct cs_tgeoguid                  //        41/NR:999  Unique identifier of TGEO (aka tendon spline or duct curve)
      {
            public int  m_id0;                          //        identifier 999
            public fixed int  m_guid[36];               //        1152 Bit GUId Identifier of following element in the BIM/CAD sy
      } // cs_unique identifier of tgeo (aka tendon spline or duct curve)
      ...
      {
            public int  m_id0;                          //        identifier 0
            public int  m_nrspur;                       //        Reference axis
            public int  m_nrspli;                       //        Duct curve
      ...
      public unsafe struct cs_tenddef1                  //        44/NR:5  Tendon definition for tendon 2.0
      {
            public int  m_id0;                          //        Identifier 5
            public int  m_tendid;                       //        (Own) tendon id
            public int  m_reftnd;                       //        Id reference axis in tendon   record  (record: 40/reftnd)
            public int  m_refgeo;                       //        Id reference axis in geometry record  (record:  3/refgeo)
            public int  m_ductnd;                       //        Id duct curve     in tendon   record  (record: 41/ductnd)
            public int  m_ducgeo;                       //        Id duct curve     in geometry record  (record:  3/ducgeo)
            public int  m_sysp;                         //        Id prestressing system                (record:  4/sysp  )
            public int  m_mat;                          //        Id material of the prestressing steel (record:  1/mat   )
            public int  m_nten;                         //        Number of individual tendons (Attention: NOT wires inside a ten
            public int  m_tndtyp;                       //        Type of reference: 1 node, 2 beam, 3 field, 4 reference axis
            public fixed float  m_fromto[2];            //        Starting/ending station (parameters on the reference axis)  FRO
            public fixed float  m_sfroto[2];            // [1001] Distances to starting/ending station.                       SFR
            public fixed float  m_efroto[2];            // [1001] Distances for effective prestressing.                       EFR
            public int  m_froset;                       //        Bit field to check, if FROM and/or TO was set: 1 FROM, 2 TO (on
            public int  m_lc;                           //        Load case id for loads from prestressing                    (re
            public int  m_lc0;                          //        Load case id for unconstraint cutting forces (only beams)   (re
            public fixed int m_tndtit[17];              //        Tendon title
            public fixed int  m_cs[3];                  //        Construction stages (installation/grouting/removal)
            public fixed int m_cstitl[17];              //        Construction stages title
            public int  m_loadme;                       //        Loading method:             1 pfac, 2 pdef, 3 psig, 4 paas (use
            public int  m_side;                         //        Prestressing side:          1 LE, 2 RI, 3 LERI, 4 RILE
            public fixed int  m_jacprc[2];              //        Jacking procedure bit:      1 stress, 2 release, 4 restress, 8 
            public fixed float  m_pdef[8];              //        Preset forces for pdef:     STL, REL, RSL, SLL, STR, RER, RSR, 
            public fixed float  m_pfac[10];             //        Limit factors for pfac:     [0-4] left, [5-9] right: FAC, FACA,
            public float  m_kappa;                      //        Friction safety factor to prevent overstress
            public int  m_kaplen;                       //        Length for kappa reduction: 1 symmetric, 2 optimized
            public fixed float  m_kvals[10];            //        K-values of Psig:           K1-K10
            public int  m_pdtset;                       //        PDAT input was given: 0 no, 1 yes
            public float  m_ftrlen;                     //        Force transition length
            public int  m_ftrtyp;                       //        Force transition type:     1 Line, 2 Para, 3 Llin, 4 Rlin, 5 LP
            public int  m_conmat;                       //        Id material of reductional area
            public float  m_ar;                         // [1012] Reference area for crack width       [m2]
            public float  m_uz;                         // [1026] Perimeter for crack width            [mm]
            public float  m_dz;                         // [1026] Effective diameter                   [mm]
            public int  m_numwir;                       //        (Number of wires           - not yet active!)
            public int  m_redwir;                       //        (Reduced number of wires   - not yet active!)
            public float  m_partpr;                     //        (Partial prestressing in % - not yet active!)
            public int  m_frcset;                       //        FRIC input was given: 0 no, 1 yes
            public fixed float  m_frcbet[2];            // [1009] Additional friction wobble factors at start and end   in [1/m]
            public fixed float  m_frclim[2];            //        Additional friction limits: start and end station (parameters o
            public int  m_frctyp;                       //        How is additional friction added: 1 add, 2 vect
      } // cs_tendon definition for tendon 2.0

      public unsafe struct cs_tendres1                  //        44/NR:7  Tendon result 1
      {
            public int  m_id0;                          //        identifier 7
            public int  m_tndgeo;                       //        Id eccentric/tendon curve geometry            (record:  3/tndge
            public fixed float  m_crvlim[8];            //        Curve limits of the eccentric tendon curve    (Teddy-Tend: SFRO
            public fixed int  m_preord[10];             //        Order of the prestressing                     (1)
            public fixed float  m_jckfac[10];           //        Acting forces factors at the jack             (1)
            public fixed float  m_elolen[10];           // [1032] Elongation lengths (equivalent to forces)     (1),(3) [mm]
            public fixed int  m_dfllog[10];             //        If a deflection point was found 1, else 0.    (1)
            public fixed float  m_dflpar[10];           //        Parameters at the deflection points           (1)
            public fixed float  m_dflfac[10];           //        Force factors at the deflection points        (1)
            public float  m_aplkap;                     //        Applied friction safety factor for overstress (2)
            public fixed float  m_aplfac[10];           //        Applied prestressing limit factors            (2)
            public fixed float  m_unrfac[10];           //        Unreduced prestressing limit factors          (2)
            public fixed float  m_kapred[2];            //        Reduction factors for the left and right jacking forces, if kap
      } // cs_tendon result 1

      public unsafe struct cs_tendres2                  //        44/NR:8  Tendon result 2
      {
            public int  m_id0;                          //        identifier 8
            public float  m_param;                      //        Parameter on the eccentric/tendon curve
            public float  m_actfac;                     //        Active factors for prestressing
            public fixed float  m_facts[10];            //        Force factors during prestressing]: [0-4] left, [5-9] right: St
      } // cs_tendon result 2

      public unsafe struct cs_tendguid                  //        44/NR:999  Unique identifier of the tendon
      {
            public int  m_id0;                          //        identifier 999
            public fixed int  m_guid[36];               //        1152 Bit GUId Identifier of following element in the BIM/CAD sy
      } // cs_unique identifier of the tendon
      ...
      enum BEAM_SCT_IHINGE_MLP { BEAM_SCT_IHINGE_MLP = 65536 }
      ...
      public unsafe struct cs_beam_tnd                  //        100/05  tendons of beams
      {
            ...
            public float  m_d;                          // [1023] effect. diameter for crack width
            ...
            public float  m_temp;                       // [1215] Temperature
            public float  m_redfak;                     // [1299] Reduction factor within transmission length
            public float  m_xsi;                        // [1299] Relative parameter [0, 1] on the reference axis (Record: 40/...
      } // cs_tendons of beams
      ...
      public unsafe struct cs_beam_dl                   //        101/LC:*  distributed beam loading on reference
      {
            ...
            public int  m_origid;                       //        Identifier of the load origin (e.g., tendon id)
      ...
      public unsafe struct cs_beam_crt                  //        104/LC:+  changes of tendon force
      {
            public int  m_nr;                           //        beamnumber
      ...
      } // cs_changes of tendon force

      public unsafe struct cs_dsln_crt                  //        124/LC:+  changes of tendon force
      {
            public int  m_nr;                           //        beamnumber
            public int  m_nrs;                          //        neg. tendonnumber
            public float  m_x;                          // [1001] distance from start
      ...
      public unsafe struct cs_bsct_crt                  //        144/LC:+  changes of tendon force
      {
            public int  m_nr;                           //        beamnumber
            public int  m_nrs;                          //        neg. tendonnumber
            public float  m_x;                          // [1001] distance from start
      ...
      public unsafe struct cs_beam_stt                  //        105/LC:+  stresses in tendons
      {
            public int  m_nr;                           //        beamnumber
            public int  m_nrs;                          //        neg. tendonnumber
            public float  m_x;                          // [1001] distance from start
            public float  m_sig;                        // [1092] stress in tendon
            public float  m_dsig;                       // [1092] sway stress in tendon
      } // cs_stresses in tendons

      public unsafe struct cs_dsln_stt                  //        125/LC:+  stresses in tendons
      {
            public int  m_nr;                           //        beamnumber
            public int  m_nrs;                          //        neg. tendonnumber
            public float  m_x;                          // [1001] distance from start
      ...
      public unsafe struct cs_bsct_stt                  //        145/LC:+  stresses in tendons
      {
            public int  m_nr;                           //        beamnumber
            public int  m_nrs;                          //        neg. tendonnumber
            public float  m_x;                          // [1001] distance from start
      ...
      public unsafe struct cs_spri_wl0                  //        173/NR:0  (Nonlinear) Material for Link elements, Spring elements and Bea
      {
            public int  m_id;                           //        Identification = 0
            ...
            public int  m_ihbit;                        //        Bitpattern of defined degrees of freedom (implicit hinge & PMM-
      ...
      public unsafe struct cs_spri_wl                   //        173/NR:+  Force-Displacement / Moment-Rotation Worklaw
      {
            public int  m_id;                           //        Identification
            public int  m_ntyp;                         //        Type of law
      ...
      public unsafe struct cs_quad_ten                  //        200/5  tendons of Quad-elements
      {
            ...
            public fixed float  m_xsi[2];               // [1299] Relative entry and exit parameters [0, 1] on the reference axis
      ...
      public unsafe struct cs_quad_rnd                  //        271/0:0  Evaluated Reinforcement Definitions of Nodes
      {
            public int  m_id;                           //        identifier (0 = Headder of a definition)
            public int  m_nrg;                          //        group number
            public int  m_nr;                           //        selector or element number
            ...
            public int  m_expp;                         //        Exposition class at positive face
            public int  m_expn;                         //        Exposition class at negative face
      } // cs_evaluated reinforcement definitions of nodes
      ...
      public unsafe struct cs_quad_rnl                  //        271/0:+  Evaluated Reinforcement Definitions of Nodes
      {
            public int  m_id;                           //        reference for this layer
            public int  m_dir;                          //        Type of local x-direction
            public float  m_rot;                        // [   5] Angle with reference to the local x-direction
      ...
      public unsafe struct cs_quad_nrp                  //        262/DC:+  punching reinforcement in nodes
      {
            ...
            public float  m_asl;                        // [1021] required longitudinal reinforcement
            public float  m_asv1;                       // [1020] shear reinforcement within 1st perimeter
            public float  m_asv2;                       // [1020] shear reinforcement within 2nd perimeter
            public float  m_asv3;                       // [1020] shear reinforcement within 3rd perimeter
            public float  m_asv4;                       // [1020] shear reinforcement within 4th perimeter
      ...
      public unsafe struct cs_quad_rnm                  //        271/DC:0  maximum reinforcement results in  Nodes
      {
            public int  m_ng;                           //        ident 0
            public int  m_nr;                           //        ident 0
            public int  m_id;                           //        +1 identifier for reincorcement
            ...
            public float  m_bmom;                       // [1114] Design bending moment in direction of reinforcement
            public float  m_wk;                         // [1026] crack width
      } // cs_maximum reinforcement results in  nodes
      ...
      public unsafe struct cs_quad_rna                  //        271/DC:Z+  General Concrete Design Results in Nodes
      {
            public int  m_ng;                           //        group number (for nodal results)
            public int  m_nr;                           //        element number
            public int  m_id;                           //        ident 0 : concrete results
            ...
            public float  m_vm;                         // [1001] shift rule
            public float  m_utilc;                      //        max. utilization fatigue check concrete
      } // cs_general concrete design results in nodes
      ...
      public unsafe struct cs_quad_rnr                  //        271/DC:Z+  Reinforcement Layer Design Results in Nodes
      {
            public int  m_ng;                           //        group number (for nodal results)
            public int  m_nr;                           //        element number
            public int  m_id;                           //        identifier of reincorcement layer
            ...
            public float  m_bmom;                       // [1114] Design bending moment in direction of reinforcement
            public float  m_wk;                         // [1026] crack width
      } // cs_reinforcement layer design results in nodes
      ...
      public unsafe struct cs_bric_tcm                  //        319/LC  damage in Bric-elements LADE
      {
            public int  m_nr;                           //        elementnumber
            public int  m_ig;                           //        gauss point
            public float  m_dam1;                       //        damage value    1. crack direction
            public fixed float  m_dir1[3];              //        crack direction 1
            public float  m_dam2;                       //        damage value    2. crack direction
            public fixed float  m_dir2[3];              //        crack direction 2
            public float  m_dam3;                       //        damage value    3. crack direction
            public fixed float  m_dir3[3];              //        crack direction 3
      } // cs_damage in bric-elements lade

      public unsafe struct cs_bric_rec                  //        360/DC:0  maximum reinforcement in Bric-elements
      {
            public int  m_nr;                           //        ident 0 for maximum (first records)
            public fixed float  m_as[3];                // [1022] reinforcement 1-3
            public float  m_oal;                        //        Euler Angle I
            public float  m_oaf;                        //        Euler Angle II
            public fixed float  m_sd[3];                // [1092] stress range 1-3  (BEMESS design)
            ...
            public fixed float  m_signon[3];            // [1092] steel stress reinforcement 1-3 (nonlinear ASE)
            public float  m_sigbma;                     // [1092] maximum concrete tensile stress (nonlinear ASE)
            public float  m_sigbmi;                     // [1092] maximum concrete compression stress (nonlinear ASE)
            public fixed float  m_epss[3];              // [1081] average reinforcement strain 1-3 (nonlinear ASE)
            public fixed float  m_crac[3];              // [1081] crack strain (uncracked: 0) in crack direction 1-3
            public fixed float  m_cd1[3];               //        crack direction 1 normalvector
            public fixed float  m_cd2[3];               //        crack direction 2 normalvector
            public fixed float  m_cd3[3];               //        crack direction 3 normalvector
      } // cs_maximum reinforcement in bric-elements
      ...
      public unsafe struct cs_bric_nrc                  //        361/DC:0  maximum reinforcement in Bric-nodes
      {
            public int  m_ng;                           //        ident 0 for maximum (first records)
            public int  m_nr;                           //        ident 0 for maximum (first records)
            public fixed float  m_as[3];                // [1022] reinforcement 1-3
            ...
            public fixed float  m_cd2[3];               //        crack direction 2 normalvector
            public fixed float  m_cd3[3];               //        crack direction 3 normalvector
      } // cs_maximum reinforcement in bric-nodes
      ...
      public unsafe struct cs_il_ctrl1                  //        -1/NS:1  Headder of a bending result
      {
            public int  m_idi;                          //        Type of result (to select the impact factor)
      ...
      } // cs_headder of a bending result

      public unsafe struct cs_il_ctrl2                  //        -1/NS:2  Headder of a shear result
      {
            public int  m_idi;                          //        Type of result (to select the impact factor)
            public int  m_ierg;                         //        index of this item + 1000*IMUNIT
            public int  m_lfmax;                        //        Offset for load case number of results for maximum
            ...
            public float  m_lphi;                       // [1001] characteristic lenght for dynamic impact factor
            public fixed int m_txt[17];                 //        Name of item
      } // cs_headder of a shear result

      public unsafe struct cs_il_ctrlx                  //        -1/NS:?  Headder of transverse evaluation data
      {
            public int  m_idi;                          //        number of data points from LSEL INT (3
            public int  m_ierg;                         //        index of this item + 1000*IMUNIT
            public int  m_lfmax;                        //        Offset for load case number of results for maximum
            public int  m_lfmin;                        //        Offset for load case number of results for minimum
            public fixed float  m_bwidth[60];           // [1001] linked list of wheels whith variable length
      } // cs_headder of transverse evaluation data

      public unsafe struct cs_il_data1                  //        -1/NS:1????  Influence values for INT 0,1,2
      {
            public int  m_idi;                          //        Type of derivatives defined
            public float  m_x;                          // [1001] abszissae along lane
            public fixed float  m_pv[2];                //        value for vertical loading (z) + Derivative (if IDI&1000)
            public fixed float  m_mt[2];                //        value for torsional loading (x-x) + Derivative of MT/dx (if IDI
            public fixed float  m_pt[2];                //        value for transverse loading (y) + Derivative of PT/dx (if IDI&
            public fixed float  m_pl[2];                //        value for longitudinal loading (x) + Derivative of PL/dx (if ID
      } // cs_influence values for int 0,1,2

      public unsafe struct cs_il_data2                  //        -1/NS:1??????  Influence values for INT > 2
      {
            public int  m_idi;                          //        Type of derivatives defined
            public float  m_x;                          // [1001] abszissae along lane
            public fixed float  m_pv[2];                //        value for vertical loading (z) + Derivative (if IDI&1000)
            ...
            public fixed float  m_pt[2];                //        value for transverse loading (y) + Derivative of PT/dx (if IDI&
            public fixed float  m_pl[2];                //        value for longitudinal loading (x) + Derivative of PL/dx (if ID
            public fixed float  m_ppos[2];              //        value for vertical distributed loading + Derivative
            public fixed float  m_pneg[2];              //        value for vertical distributed loading + Derivative
            public float  m_pzero;                      //        position of zero value of the transverse influence line
            public float  m_yex;                        //        excentric transverse position of primary load train
            public fixed float  m_rres[2];              //        values for right and left residual loading
            public fixed float  m_fax[8*2];             //        correction factors for different axle types
      } // cs_influence values for int > 2
